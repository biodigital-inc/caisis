<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PendingEFormsWidget.ascx.cs"
    Inherits="Caisis.UI.Core.Utilities.Widget.PendingEFormsWidget" %>
