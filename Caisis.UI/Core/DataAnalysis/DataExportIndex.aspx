<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DataExportIndex.aspx.cs" Inherits="Caisis.UI.Core.DataAnalysis.DataExportIndex" CodeFileBaseClass="Caisis.UI.Core.Classes.FramePage" %>
			...
			<tr>
				<td align="middle" valign="top">
					<table width="100%" height="95% cellpadding="0" cellspacing="0" bgcolor="#f8fafc">
						...
						<tr>
							<td align="middle" valign="top">
								<iframe id="DataExportContainer" name="DataExportContainer" src="Export/DataExport.aspx" width="950" height="550" scrolling="no" frameborder="0" runat="server">
								</iframe>
							</td>
						</tr>
					</table>
