<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Bone.Eforms.ComorbiditiesOsteo" CodeFile="ComorbiditiesOsteo.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="ComorbiditiesOsteo" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Comorbidities"></asp:Label><br/>
<table width="650" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="ComorbiditiesHtmlTable">
  ...
  <tr id="ComorbRow_1" runat="server"> 
    ...
    <td width="50%" class="ClinicalEformPopulatedColumn" ><euc:EformCheckbox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_Hypertension" Value="Hypertension" RecordId="1" /> Hypertension </td>
  ...
  <tr id="ComorbRow_2" runat="server"> 
    ...
    <td width="50%" class="ClinicalEformPopulatedColumn" ><euc:EformCheckbox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_Diabetestype2" Value="Diabetes type 2" RecordId="2" /> Diabetes type 2 </td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
    ...
    <td width="50%" class="ClinicalEformPopulatedColumn" ><euc:EformCheckbox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_CoronaryArteryDisease" Value="Coronary Artery Disease" RecordId="3" /> Coronary Artery Disease </td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
    ...
    <td width="50%" class="ClinicalEformPopulatedColumn" ><euc:EformCheckbox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_MyocardialInfarction" Value="Myocardial Infarction" RecordId="4" /> Myocardial Infarction </td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
  ...
  <tr id="ComorbRow_5" runat="server"> 
    ...
    <td width="50%" class="ClinicalEformPopulatedColumn" ><euc:EformCheckbox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_AtrialFibrillation" Value="Atrial Fibrillation" RecordId="5" /> Atrial Fibrillation </td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
  ...
  <tr id="ComorbRow_6" runat="server"> 
    ...
    <td width="50%" class="ClinicalEformPopulatedColumn" ><euc:EformCheckbox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_StrokeTransientIschemicAttack" Value="Stroke / Transient Ischemic Attack" RecordId="6" /> Stroke / Transient Ischemic Attack </td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
  ...
  <tr id="ComorbRow_7" runat="server"> 
    ...
    <td width="50%" class="ClinicalEformPopulatedColumn" ><euc:EformCheckbox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_ChronicKidneyDisease" Value="Chronic Kidney Disease" RecordId="7" /> Chronic Kidney Disease </td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
  ...
  <tr id="ComorbRow_8" runat="server"> 
    ...
    <td width="50%" class="ClinicalEformPopulatedColumn" style="white-space: nowrap;" ><euc:EformCheckbox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_DeepVeinThrombosisPulmonaryEmbolism" Value="Deep Vein Thrombosis / Pulmonary Embolism" RecordId="8" /> Deep Vein Thrombosis / Pulmonary Embolism </td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
    ...
    <td width="50%" class="ClinicalEformPopulatedColumn" ><euc:EformCheckbox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_Hypothyroidism" Value="Hypothyroidism" RecordId="9" /> Hypothyroidism </td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
  ...
  <tr id="ComorbRow_10" runat="server"> 
    ...
    <td width="50%" class="ClinicalEformPopulatedColumn" ><euc:EformCheckbox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_ChronicObstructivePulmonaryDisease" Value="Chronic Obstructive Pulmonary Disease" RecordId="10" /> Chronic Obstructive Pulmonary Disease </td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
