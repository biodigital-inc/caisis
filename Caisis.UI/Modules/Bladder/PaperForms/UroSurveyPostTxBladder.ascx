<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Bladder.PaperForms.UroSurveyPostTxBladder" CodeFile="UroSurveyPostTxBladder.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BasePaperFormControl" %>
...
<div>
	<div class="VerticalBarCodeDiv">
	 ...
	 <img src="../../Images/FormImages/BarCodeLineStatement.gif" border="0" class="VerticalBarCodeStatementImage" ><br/>
		...
		<div  class="VerticalBarCodeDocType">*U44*</div>
  ...
  <td style="text-align:center;"><font size="-1">CONTAINS PROTECTED HEALTH INFORMATION - HANDLE ACCORDING TO <%= institutionShortName%> POLICY</font></td>
    ...
    <tr> 
      <td class="FormOuterTableTopRow">
          ...
          <tr> 
            <td width="50%" align="center" valign="middle" class="FormInnerRowRightBorder"><span class="blackBoldText"><img src="../../Images/FormImages/<%= institutionShortName%>_FormLogo.gif" width="90" alt="" border="0" align="left"><%= institutionName%><br/>Post-Treatment Survey: Bladder<br/></span></td>
    ...
    <tr> 
      <td valign="top" class="FormOuterTableRow"> 
		<table class="pageWidth" cellspacing="0" cellpadding="0">
          ...
          <tr valign="top"> 
            <td>&nbsp;</td>
            <td> <span class="SurveyTitle">POST-TREATMENT SURVEY: Post-Cystectomy Bladder </span><br>
            <br>
            <br>
			  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr valign="top"> 
                  <td width="20"><strong>1.</strong></td>
                  <td><strong>Since your bladder surgery or our last contact, has your cancer recurred?</strong><br>
                    <br />
                    <br />
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr valign="top">
                        ...
                        <td height="20">&nbsp;</td>
                        <td>&nbsp;</td>
                        <td>If Yes, please specify where. </td>
                      </tr>
                      <tr valign="top">
                        <td>&nbsp;</td>
                        <td height="20">&nbsp;</td>
                        <td>&nbsp;</td>
                        <td align="right"><table width="89%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="38" valign="bottom">Bladder</td>
                            <td valign="bottom">Kidney or Ureter </td>
                          </tr>
                          <tr>
                            <td height="38" valign="bottom">Pelvis</td>
                            <td valign="bottom">Urethra</td>
                          </tr>
                          <tr>
                            <td height="38" colspan="2" valign="bottom">Other organs (specify): _________________________ </td>
                            </tr>
                        </table></td>
                      </tr>
                    </table></td>
                ...
                <tr valign="top">
                  ...
                  <td><strong>Since your bladder removal or our last contact, have tumor cells been detected in your urine?</strong><br />
                      <br />
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr valign="top">
                          <td width="5%">&nbsp;</td>
                ...
                <tr valign="top">
                  ...
                  <td><strong>When was your last CT scan, MRI scan, X-Ray, or Bone scan?</strong><br />
                      <br />
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr valign="top">
                          ...
                          <td><table width="60%" border="0" cellspacing="0" cellpadding="2">
                              <tr>
                                <td width="33%" align="center" class="FormInsideTableTopLeftCell">Type of Scan </td>
                ...
                <tr valign="top">
                  ...
                  <td><strong>Since your bladder removal or our last contact, have you had any other treatment for your bladder 
	cancer, such as chemotherapy, radiation therapy, or surgery?  </strong><br />
        <br />
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr valign="top">
            <td width="5%">&nbsp;</td>
          ...
          <tr valign="top">
            ...
            <td height="20">&nbsp;</td>
            <td>&nbsp;</td>
            <td height="24" valign="bottom">Please list the doctor(s) who treated you: __________________________________</td>
          </tr>
      </table></td>
                </tr>
                <tr valign="top">
    ...
    <tr >
      <td height="14" align="center" valign="bottom" class="blackBoldText">GU39<img src="../../Images/shim.gif" border="0" width="55" height="1" />U44<img src="../../Images/shim.gif" border="0" width="55" height="1" />CMIC 
        Approval Date: 6/11/08<img src="../../Images/shim.gif" border="0" width="55" height="8" />Page <span id="PageNumber">1</span> of <span id="TotalPages">2</span><img src="../../Images/shim.gif" border="0" width="55" height="1" />B/02.070.<span class="blackBoldTextSmall">39</span></td>
    </tr>
  </table>
</div>
...
Please return in the enclosed, postage-paid envelope.</td>
    ...
    <tr >
      <td height="14" align="center" valign="bottom" class="blackBoldText">GU39<img src="../../Images/shim.gif" border="0" width="55" height="1" />U44<img src="../../Images/shim.gif" border="0" width="55" height="1" />CMIC 
        Approval Date: 6/11/08<img src="../../Images/shim.gif" border="0" width="55" height="8" />Page <span id="PageNumber">2</span> of <span id="TotalPages">2</span><img src="../../Images/shim.gif" border="0" width="55" height="1" />B/02.070.<span class="blackBoldTextSmall">39</span></td>
    </tr>
  </table>
</div>
