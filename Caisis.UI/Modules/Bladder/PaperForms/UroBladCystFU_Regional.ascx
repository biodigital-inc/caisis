<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Bladder.PaperForms.UroBladCystFU_Regional" CodeFile="UroBladCystFU_Regional.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BasePaperFormControl" %>
...
-->        </table>
    ...
    <tr> 
      <td height="14" align="center" valign="bottom" class="blackBoldText">GU04<img src="../../Images/shim.gif" border="0" width="45" height="8">U08<img src="../../Images/shim.gif" border="0" width="45" height="1">CMIC 
        ...
        <span id="PageNumber">1</span> of <span id="TotalPages">6</span><img src="../../Images/shim.gif" border="0" width="45" height="1">B/02.070.<span class="blackBoldTextSmall">04</span></td>
    </tr>
  </table>
</div>
<div align="left"  style="page-break-after:always;">
...
<!-- <tr> 
    ...
    <tr> 
      <td height="14" align="center" valign="bottom" class="blackBoldText">GU04<img src="../../Images/shim.gif" border="0" width="45" height="8">U08<img src="../../Images/shim.gif" border="0" width="45" height="1">CMIC 
        Approval Date: 6/03<img src="../../Images/shim.gif" border="0" width="45" height="8">rev:09/08/06<img src="../../Images/shim.gif" border="0" width="45" height="1">Page 
        <span id="PageNumber">3</span> of <span id="TotalPages">6</span><img src="../../Images/shim.gif" border="0" width="45" height="1">B/02.070.<span class="blackBoldTextSmall">04</span></td>
    </tr>
  </table>
</div>
...
<div>
  ...
  <td style="text-align:center;"><font size="-1">CONTAINS PROTECTED HEALTH INFORMATION - HANDLE ACCORDING TO <%= institutionShortName%> POLICY</font></td>
    ...
    <tr> 
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="52%" valign="top" class="FormInnerRowRightBorder"> 
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td colspan="3"><span class="blackBoldText"><img src="../../Images/shim.gif" border="0" width="4" height="16"><span class="blackBoldText"></span>Medications</span> 
                    <img src="../../Images/shim.gif" border="0" width="50" height="1"> 
                    <input name="DateLastGnRH" type="checkbox" id="DateLastGnRH" value="yes">Unchanged Since Last Visit</td>
                </tr>
                <tr align="center"> 
                  <td width="58%" class="FormInsideTableTopCell">Agent</td>
                  <td width="18%" class="FormInsideTableTopCell">Dose</td>
                  <td width="24%" class="FormInsideTableTopCell">Schedule</td>
                </tr>
            ...
            <td width="48%" valign="top"> 
                ...
                <tr align="center"> 
                  <td width="48%" class="FormInsideTableRegCell">Allergen</td>
                  <td width="52%" class="FormInnerRowBottomBorder">Reaction</td>
                </tr>
...
Attending</span>
    ...
    <tr > 
      <td height="14" align="center" valign="bottom" class="blackBoldText">GU04<img src="../../Images/shim.gif" border="0" width="45" height="8">U08<img src="../../Images/shim.gif" border="0" width="45" height="1">CMIC 
        Approval Date: 6/03<img src="../../Images/shim.gif" border="0" width="45" height="8">rev:09/08/06<img src="../../Images/shim.gif" border="0" width="45" height="1">Page 
        <span id="PageNumber">4</span> of <span id="TotalPages">6</span><img src="../../Images/shim.gif" border="0" width="45" height="1">B/02.070.<span class="blackBoldTextSmall">04</span></td>
    </tr>
  </table>
</div>
<div align="left"  style="page-break-after:always;">
...
<div>
  ...
  <td style="text-align:center;"><font size="-1">CONTAINS PROTECTED HEALTH INFORMATION - HANDLE ACCORDING TO <%= institutionShortName%> POLICY</font></td>
      ...
      <td class="FormOuterTableRow"><img src="../../Images/shim.gif" border="0" width="4" height="15"><span class="blackBoldText">Exam</span><span class="smallGrayText">&nbsp;&nbsp;&nbsp; 
        ...
        <table align="center" border="0" width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr> 
            <td rowspan="2" align="left" valign="top" class="FormInsideTableLeftCell">CV</td>
            <td align="left" class="FormInnerRowBottomBorder"><span class="smallGrayText"> 
              </span>Regular Rate and Rythym</td>
            <td align="center" class="FormInsideTableRegCell"><img src="../../Images/FormImages/WinCheckbox.gif" width="13" height="13" vspace="1"></td>
            <td align="center" class="FormInsideTableRegCell"><img src="../../Images/FormImages/WinCheckbox.gif" width="13" height="13"></td>
            <td align="center" class="FormInsideTableRegCell"><img src="../../Images/FormImages/WinCheckbox.gif" width="13" height="13"></td>
            <td rowspan="2" class="FormInsideTableRegCell">&nbsp;</td>
    ...
    <tr > 
      <td height="14" align="center" valign="bottom" class="blackBoldText">GU04<img src="../../Images/shim.gif" border="0" width="45" height="8">U08<img src="../../Images/shim.gif" border="0" width="45" height="1">CMIC 
        Approval Date: 6/03<img src="../../Images/shim.gif" border="0" width="45" height="8">rev:09/08/06<img src="../../Images/shim.gif" border="0" width="45" height="1">Page 
        <span id="PageNumber">5</span> of <span id="TotalPages">6</span><img src="../../Images/shim.gif" border="0" width="45" height="1">B/02.070.<span class="blackBoldTextSmall">04</span></td>
    </tr>
  </table>
</div>
...
<div>
  ...
  <td style="text-align:center;"><font size="-1">CONTAINS PROTECTED HEALTH INFORMATION - HANDLE ACCORDING TO <%= institutionShortName%> POLICY</font></td>
    ...
    <tr > 
      <td height="14" align="center" valign="bottom" class="blackBoldText">GU04<img src="../../Images/shim.gif" border="0" width="45" height="8">U08<img src="../../Images/shim.gif" border="0" width="45" height="1">CMIC 
        Approval Date: 6/03<img src="../../Images/shim.gif" border="0" width="45" height="8">rev:09/08/06<img src="../../Images/shim.gif" border="0" width="45" height="1">Page 
        <span id="PageNumber">6</span> of <span id="TotalPages">6</span><img src="../../Images/shim.gif" border="0" width="45" height="1">B/02.070.<span class="blackBoldTextSmall">04</span></td>
    </tr>
  </table>
</div>
