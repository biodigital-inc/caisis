<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.Disposition_Endo" CodeFile="Disposition_Endo.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>
<link href="../../../StyleSheets/EformStyles.css" rel="stylesheet" type="text/css">
<a name="Disposition_Endo" /><span class="controlBoxTitle">Disposition</span><br>
...
<table width="650" border="0" cellspacing="0" cellpadding="5" style="border: solid 1px #cccccc;">
  ...
  <tr>
    ...
    <td valign="top">		<strong>Describe Counseling or Dictate Note:</strong><br/>
		<euc:EformTextArea TextMode="MultiLine" TABLE="NoTable" FIELD="CounselingDescription" Rows="7" Cols="30" Runat="server" ID="CounselingDescription"/></td>
  </tr>
</table>	</td>
  </tr>
  <tr>
