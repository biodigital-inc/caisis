namespace Caisis.UI.Modules.Bladder.Eforms
{
	...
	/// </summary>
    public partial class UrinaryDiversionDetails : BaseEFormControl
	{
        override protected void Page_Load(object sender, System.EventArgs e)
        {
            ...
            //           ShowCorrectUrinDiversionDiv.Text = "<script showUrinaryDiversionType(document.getElemendById('" + ProcName.ClientID + "'))";
