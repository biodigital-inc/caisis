namespace Caisis.UI.Modules.Bladder.Eforms
{
    ...
    /// </summary>
    public partial class CystectomyAndAncillaryProcs : BaseEFormControl
	{
		...
		protected void BuildJSArray()
		{
			...
			ProcedureSurgeonsJSArray.Text += "procedureSurgeonsArray[1] = ['" + OpName_7.ClientID + "', '" + OpSurgeon_7.ClientID + "', '" + OpSurgeonType_7.ClientID  + "', '" + OpAssistant_7.ClientID  + "', '" + OpAssistantType_7.ClientID +"'];";
			ProcedureSurgeonsJSArray.Text += "procedureSurgeonsArray[2] = ['" + OpName_8.ClientID + "', '" + OpSurgeon_8.ClientID + "', '" + OpSurgeonType_8.ClientID  + "', '" + OpAssistant_8.ClientID  + "', '" + OpAssistantType_8.ClientID +"'];";
            ProcedureSurgeonsJSArray.Text += "procedureSurgeonsArray[3] = ['" + OpName_9.ClientID + "', '" + OpSurgeon_9.ClientID + "', '" + OpSurgeonType_9.ClientID  + "', '" + OpAssistant_9.ClientID  + "', '" + OpAssistantType_9.ClientID +"'];";
            ProcedureSurgeonsJSArray.Text += "procedureSurgeonsArray[4] = ['" + OpName_10.ClientID + "', '" + OpSurgeon_10.ClientID + "', '" + OpSurgeonType_10.ClientID + "', '" + OpAssistant_10.ClientID + "', '" + OpAssistantType_10.ClientID + "'];";
        }
