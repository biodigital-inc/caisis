<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BreastSurvey.ascx.cs" Inherits="Caisis.UI.Modules.Breast.PaperForms.BreastSurvey" %>
	...
	<tr> 
      <td class="FormOuterTableRow" style="border-bottom: none;">
          <table id="ProcedureDetails" width="100%" style="width: 100%;">
              <tr>
                  <td colspan="1">
                      <strong style="white-space: nowrap;">Plastics Procedures:</strong>
                  </td>
                  <td colspan="2">
                          ...
                          <chart:CaisisChart  runat="server" ID="BreastQChart" Width="370" Height="400" CssClass="breastQChart" RenderBase64="true">
                              ...
                              <ChartAreas>
                                  <asp:ChartArea Name="MainArea">
                                      ...
                                      <AxisY Title="Total BQ Score" TitleFont="8pt Arial Bold" IsStartedFromZero="true"
