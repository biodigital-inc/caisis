<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Breast.Eforms.ClinStageBreastAJCC09" CodeFile="ClinStageBreastAJCC09.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="ClinStageBreastAJCC09" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Clinical Stage (Breast, AJCC_09)"></asp:Label><br/>
<table cellpadding="5" cellspacing="0" class="ClinicalEformTable" style="width: 500px;">
          ...
          <tr>
				...
				<td style="white-space: nowrap;">				
 				...
 				<td style="white-space: nowrap;">
					<euc:EformComboBox style="width:50px"  LookupCode="StageClin_Breast_09_T" TABLE="ClinicalStages" FIELD="ClinStageT" Runat="server" ID="ClinStageT" RecordId="1" DropDownWidth="600" EnableHiddenOnUIEvent="ClinStageDisease,ClinStageSystem"/></td>
				<td style="white-space: nowrap;">
					<euc:EformComboBox style="width:50px"  LookupCode="StageClin_Breast_09_N" TABLE="ClinicalStages" FIELD="ClinStageN" Runat="server" ID="ClinStageN" RecordId="1" DropDownWidth="510" EnableHiddenOnUIEvent="ClinStageDisease,ClinStageSystem"/></td>
				<td style="white-space: nowrap;">
					<euc:EformComboBox style="width:50px"  LookupCode="StageClin_Breast_09_M" TABLE="ClinicalStages" FIELD="ClinStageM" Runat="server" ID="ClinStageM" RecordId="1" DropDownWidth="400" DropDownHeight="auto" EnableHiddenOnUIEvent="ClinStageDisease,ClinStageSystem"/>
					
				    <euc:EformHidden TABLE="ClinicalStages" FIELD="ClinStageDisease" Runat="server" ID="ClinStageDisease" RecordId="1" Value="Breast"  />
				    <euc:EformHidden TABLE="ClinicalStages" FIELD="ClinStageSystem" Runat="server" ID="ClinStageSystem" RecordId="1" Value="AJCC_09"  />
...
function SetHiddenFields(clinStageDateTextID,clinStageTID,clinStateNID,clinStageMID,clinStageDiseaseID,clinStageSystemID,clinStageQualityID)
{
    ...
    if (clinStageDateTextID.value != '' || clinStageTID.value != '' || clinStateNID.value != '' || clinStageMID.value != '')
    {
        ...
        clinStageSystemID.value = 'AJCC_09';
