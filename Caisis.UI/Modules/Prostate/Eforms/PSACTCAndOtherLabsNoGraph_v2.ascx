<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Prostate.Eforms.PSACTCAndOtherLabsNoGraph_v2" CodeFile="PSACTCAndOtherLabsNoGraph_v2.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="PSACTCAndOtherLabsNoGraph_v2" />


<asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Lab Tests"></asp:Label>

<span style="margin-left: 40px; font-size: 13px; font-weight: bold;">View:</span>
<div id="GULabViewSelector">
    <a onclick="SetGULabView('TrendView',this);" class="selected" >Trend View</a>
    <a onclick="SetGULabView('fishbones',this);" >Fishbones</a>
...
<span id="TrendViewLastTenToggleContainer" style="font-size: 11px; font-weight: bold; display: none;"><input type="checkbox" checked="checked" value="1" id="TrendViewLastTenToggle" onclick="toggleTrendViewLastTen(this);" />Only show last ten lab test dates</span>
...
<div id="fishbones"  style="display: none;">
