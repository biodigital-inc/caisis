<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Prostate.Eforms.SurgicalHistory_ProstateNP" CodeFile="SurgicalHistory_ProstateNP.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>
<script language="javascript">
	tableArray.ProceduresHtmlTable = "ProceduresHtmlTable";
</script>

<a name="SurgicalHistory_ProstateNP" /><span class="controlBoxTitle">Surgical History </span><br>
...
<table width="650" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="ProceduresHtmlTable">
  ...
  <tr> 
	...
	<euc:EformComboBox   LookupCode="ProcName,EForm_Prostate,True"   style="width:150px;" Field="ProcName" RecordId="1" Table="Procedures" Runat="server" id="ProcName_1"  />	</td>
  ...
  <tr> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="400"    LookupCode="ProcName,EForm_Prostate,True"   style="width:150px;" Field="ProcName" RecordId="2" Table="Procedures" MaxLength="50"  Runat="server" id="ProcName_2"  />	</td>
  ...
  <tr > 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="400"    LookupCode="ProcName,EForm_Prostate,True"   style="width:150px;" Field="ProcName" RecordId="3" Table="Procedures" MaxLength="50"  Runat="server" id="ProcName_3"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="400"    LookupCode="ProcName,EForm_Prostate,True"   style="width:150px;" Field="ProcName" RecordId="4" Table="Procedures" MaxLength="50"  Runat="server" id="ProcName_4"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="400"    LookupCode="ProcName,EForm_Prostate,True"   style="width:150px;" Field="ProcName" RecordId="5" Table="Procedures" MaxLength="50" Runat="server" id="ProcName_5"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="400"    LookupCode="ProcName,EForm_Prostate,True"   style="width:150px;" Field="ProcName" RecordId="6" Table="Procedures" MaxLength="50" Runat="server" id="ProcName_6"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="400"    LookupCode="ProcName,EForm_Prostate,True"   style="width:150px;" Field="ProcName" RecordId="7" Table="Procedures" MaxLength="50" Runat="server" id="ProcName_7"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="400"    LookupCode="ProcName,EForm_Prostate,True"   style="width:150px;" Field="ProcName" RecordId="8" Table="Procedures" MaxLength="50" Runat="server" id="ProcName_8"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="400"    LookupCode="ProcName,EForm_Prostate,True"   style="width:150px;" Field="ProcName" RecordId="9" Table="Procedures" MaxLength="50" Runat="server" id="ProcName_9"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="400"    LookupCode="ProcName,EForm_Prostate,True"   style="width:150px;" Field="ProcName" RecordId="10" Table="Procedures" MaxLength="50" Runat="server" id="ProcName_10"  />	</td>
   ...
   <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="400"    LookupCode="ProcName,EForm_Prostate,True"   style="width:150px;" Field="ProcName" RecordId="11" Table="Procedures" MaxLength="50" Runat="server" id="ProcName_11"  />	</td>
