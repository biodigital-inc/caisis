<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Prostate.Eforms.ReviewOfSystems_FU" CodeFile="ReviewOfSystems_FU.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>
<link href="../../../StyleSheets/EformStyles.css" rel="stylesheet" type="text/css">
<a name="ReviewOfSystems_FU" /><span class="controlBoxTitle">Review of Systems</span><br />
<br />
...
<table width="650" border="0" cellspacing="0" cellpadding="3" style="border: solid 1px #cccccc;" id="ReviewOfSystemsHtmlTable">
  ...
  <tr>
    ...
    <td class="ControlBoxLinedRows" align="center"><euc:EformRadioButton ExpandClickableArea="false" Id="FeverNotDone" Value="Not Done" runat="server"/>
		</euc:EformRadioButtonGroup>		</td>
  ...
  <tr>
    ...
    <td valign="top" class="ControlBoxLinedRowsShaded">Wounds</td>
  ...
  <tr>
    <td valign="top" class="ControlBoxLinedRowsShaded">Dyspnea
  ...
  <tr>
    ...
    <td valign="top" class="ControlBoxLinedRowsShaded">Edema
  ...
  <tr>
    <td valign="top" class="ControlBoxLinedRowsShaded">Chest Pain</td>
  ...
  <tr>
    ...
    <td valign="top" class="ControlBoxLinedRowsShaded">Dyspepsia</td>
  ...
  <tr>
    <td height="30" valign="top" class="ControlBoxLinedRowsShaded">Diarrhea</td>
  ...
  <tr>
    ...
    <td valign="top" class="ControlBoxLinedRowsShaded">Obstruction</td>
  ...
  <tr>
    <td valign="top" class="ControlBoxLinedRowsShaded">Hematuria</td>
  ...
  <tr>
    <td valign="top" class="ControlBoxLinedRowsShaded">Penile Pain / Curvature / Length</td>
  ...
  <tr>
    ...
    <td valign="top" class="ControlBoxLinedRowsShaded">Numbness / Tingling</td>
    <td class="ControlBoxLinedRows" align="center"><euc:EformRadioButtonGroup Table="EncReviewOfSystems" Field="ROS_Result" id="ROS_Result_NumbnessTingling" RecordId="17" GroupName="NumbnessTingling" runat="server"
  ...
  <tr>
    ...
    <td class="ControlBoxLinedRows" align="center"><euc:EformRadioButtonGroup Table="EncReviewOfSystems" Field="ROS_Result" id="ROS_Result_Headaches" RecordId="18" GroupName="Headaches" runat="server"
			Field1="ROS_System" Value1="Neurology"
