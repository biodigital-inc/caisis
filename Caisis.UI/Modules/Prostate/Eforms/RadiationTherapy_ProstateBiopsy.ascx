<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.RadiationTherapy_ProstateBiopsy" CodeFile="RadiationTherapy_ProstateBiopsy.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="RadiationTherapy_ProstateBiopsy" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Radiation Therapy"></asp:Label><br/>
<table width="700" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="RadiationTherapyHtmlTable">
  ...
  <tr >
    ...
    <td><euc:EformSelect RecordId="1" LookupCode="RadTxType,EForm_ProstateTRUS,true" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_1"/></td>
    <td><euc:EformComboBox  LookupCode="RadTxTarget,EForm_ProstateTRUS,true"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="1" Table="RadiationTherapy" Runat="server" id="RadTxTarget_1"  /></td>
    ...
    <td><euc:EformSelect RecordId="2" LookupCode="RadTxType,EForm_ProstateTRUS,true" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_2"/></td>
    <td><euc:EformComboBox  LookupCode="RadTxTarget,EForm_ProstateTRUS,true"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="2" Table="RadiationTherapy" Runat="server" id="RadTxTarget_2"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="3" LookupCode="RadTxType,EForm_ProstateTRUS,true" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_3"/></td>
    <td><euc:EformComboBox  LookupCode="RadTxTarget,EForm_ProstateTRUS,true"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="3" Table="RadiationTherapy" Runat="server" id="RadTxTarget_3"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="4" LookupCode="RadTxType,EForm_ProstateTRUS,true" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_4"/></td>
    <td><euc:EformComboBox  LookupCode="RadTxTarget,EForm_ProstateTRUS,true"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="4" Table="RadiationTherapy" Runat="server" id="RadTxTarget_4"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="5" LookupCode="RadTxType,EForm_ProstateTRUS,true" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_5"/></td>
    <td><euc:EformComboBox  LookupCode="RadTxTarget,EForm_ProstateTRUS,true"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="5" Table="RadiationTherapy" Runat="server" id="RadTxTarget_5"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="6" LookupCode="RadTxType,EForm_ProstateTRUS,true" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_6"/></td>
    <td><euc:EformComboBox  LookupCode="RadTxTarget,EForm_ProstateTRUS,true"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="6" Table="RadiationTherapy" Runat="server" id="RadTxTarget_6"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="7" LookupCode="RadTxType,EForm_ProstateTRUS,true" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_7"/></td>
    <td><euc:EformComboBox  LookupCode="RadTxTarget,EForm_ProstateTRUS,true"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="7" Table="RadiationTherapy" Runat="server" id="RadTxTarget_7"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="8" LookupCode="RadTxType,EForm_ProstateTRUS,true" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_8"/></td>
    <td><euc:EformComboBox  LookupCode="RadTxTarget,EForm_ProstateTRUS,true"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="8" Table="RadiationTherapy" Runat="server" id="RadTxTarget_8"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="9" LookupCode="RadTxType,EForm_ProstateTRUS,true" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_9"/></td>
    <td><euc:EformComboBox  LookupCode="RadTxTarget,EForm_ProstateTRUS,true"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="9" Table="RadiationTherapy" Runat="server" id="RadTxTarget_9"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="10" LookupCode="RadTxType,EForm_ProstateTRUS,true" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_10"/></td>
    <td><euc:EformComboBox  LookupCode="RadTxTarget,EForm_ProstateTRUS,true"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="10" Table="RadiationTherapy" Runat="server" id="RadTxTarget_10"  /></td>
