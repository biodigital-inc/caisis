<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Prostate.Eforms.BiopsiesProstate2" CodeFile="BiopsiesProstate2.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="BiopsiesProstate2" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Biopsies"></asp:Label><br/>
