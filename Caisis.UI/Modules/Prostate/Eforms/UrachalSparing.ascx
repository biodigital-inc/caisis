<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Prostate.Eforms.UrachalSparing" CodeFile="UrachalSparing.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>



<!-- BEGIN Urachael Sparing -->
<a name="UrachaelSparing" />
<table width="520" border="0" cellpadding="0" cellspacing="0" class="controlBox">
    ...
    <tr> 
      ...
      <td><table width="516" border="0" cellspacing="0" cellpadding="4">
          ...
          <tr> 
            <td width="150" height="18" align="right" class="controlBoxFieldTitle">Urachal Sparing &nbsp; </td>
            <td class="controlBoxFieldOption"> 
              
              	<euc:EformRadioButtonList RepeatLayout="Flow" RepeatDirection="Horizontal" TABLE="ProstatectomyProc" FIELD="ProcUrachalSparing" LookupCode="YesNoUnknown" id="ProcUrachalSparing" runat="server">
