namespace Caisis.UI.Modules.Prostate.Eforms
{
	...
	/// <summary>
    ///		Summary description for PSACTCAndOtherLabsNoGraph.
	/// </summary>
    public partial class PSACTCAndOtherLabsNoGraph_v2 : BaseEFormControl
	{
        ...
        private void BuildTrendView(DataSet ds)
        {
            ...
            {
                try // don't need this try/catch in dev, why? - jf
                {
