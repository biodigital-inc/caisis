<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Prostate.Eforms.ReviewOfSystems_GUFU" CodeFile="ReviewOfSystems_GUFU.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="ReviewOfSystems_GUFU" /><span class="controlBoxTitle">Review of Systems&nbsp;&nbsp;<span style="font-weight: normal;">(CTC/AE 4.0)</span></span>
...
<table width="650" border="0" cellspacing="0" cellpadding="0" style="border: solid 1px #cccccc; border-collapse: collapse;" id="ReviewOfSystemsHtmlTable">
  <asp:Repeater ID="PriorToxicities" runat="server" OnItemDataBound="ShowROSComments"> 
       ...
       <ItemTemplate> 
          <tr class="priorToxRow" onclick="LoadDataEntryForm('Toxicities', <%# DataBinder.Eval(Container.DataItem, "ToxicityId") %>, 'ToxCategory,ToxName,ToxGrade,ToxDateText,ToxDate,ToxStopDateText,ToxStopDate,ToxProbability,ToxIntervention,ToxNotes', 'ReviewOfSystems_GUFU');">
            <td style="font-size: 10px; font-weight: bold;" ><%# DataBinder.Eval(Container.DataItem, "ToxCategory") %>&nbsp;</td>
  ...
  <tr>
    ...
    <td class="ControlBoxLinedRows"><euc:EformTextBox RecordId="1" LookupCode="ToxProbability" DropDownWidth="280" TABLE="Toxicities" FIELD="ToxProbability" Runat="server" ID="ToxProbability_Fatigue" style="width: 52px;"/><euc:EformRelatedRecordWidget runat="server" RelatedTable="Toxicities" RelatedTableRecordId="1" RelatedFieldId="ToxProbability_Fatigue" RelatableTables="MedicalTherapy,RadiationTherapy,BrachyTherapy,Procedures,Comorbidities,Allergies" DefaultTable="MedicalTherapy" DefaultTitle="Fatigue" ></euc:EformRelatedRecordWidget>
    </td>
...
-->    <td class="ControlBoxLinedRows"><euc:EformComboBox RecordId="19" LookupCode="ToxIntervention" RefBy="ToxIntervention" TABLE="Toxicities" FIELD="ToxIntervention" Runat="server" ID="ToxIntervention_Potency" style="width: 70px;"/></td>
  ...
  <tr>
    <td colspan="2" valign="top" class="ControlBoxLinedRowsShaded" style="border-top: solid 1px #333333; border-bottom: none;"><strong>Pain</strong></td>
    ...
    <td class="ControlBoxLinedRows" align="center" style="border-top: solid 1px #333333;"><euc:EformRadioButtonGroup Table="Toxicities" Field="ToxGrade" id="ToxGrade_Pain" RecordId="20" GroupName="Pain" runat="server"
        ...
        <euc:EformRadioButton Id="Pain0" Value="0" runat="server" ExpandClickableArea="False"/>    </td>
    <td class="ControlBoxLinedRows" align="center" style="border-top: solid 1px #333333;"><euc:EformRadioButton Id="Pain1" Value="1" runat="server" ExpandClickableArea="False"/></td>
    <td class="ControlBoxLinedRows" align="center" style="border-top: solid 1px #333333;"><euc:EformRadioButton Id="Pain2" Value="2" runat="server" ExpandClickableArea="False"/></td>
    <td class="ControlBoxLinedRows" align="center" style="border-top: solid 1px #333333;"><euc:EformRadioButton Id="Pain3" Value="3" runat="server" ExpandClickableArea="False"/></td>
    <td class="ControlBoxLinedRows" align="center" style="border-top: solid 1px #333333;"><euc:EformRadioButton Id="Pain4" Value="4" runat="server" ExpandClickableArea="False"/>
        </euc:EformRadioButtonGroup></td>
...
-->    <td class="ControlBoxLinedRows" style="border-top: solid 1px #333333;"><euc:EformComboBox RecordId="20" LookupCode="ToxIntervention" RefBy="ToxIntervention" TABLE="Toxicities" FIELD="ToxIntervention" Runat="server" ID="ToxIntervention_Pain" style="width: 70px;"/></td>
  ...
  <tr>
    ...
    <td class="ControlBoxLinedRows" align="center" style="border-top: solid 1px #333333;"><euc:EformRadioButtonGroup Table="Toxicities" Field="ToxGrade" id="ToxGrade_Pain2" RecordId="21" GroupName="Pain" runat="server"
			Field1="ToxCategory" Value1="General disorders and administration site conditions"
			Field2="ToxName" Value2="Pain" Field3="ToxScale" Value3="CTC/AE 4.0">
        <euc:EformRadioButton Id="Pain0_2" Value="0" runat="server" ExpandClickableArea="False"/>    </td>
    <td class="ControlBoxLinedRows" align="center" style="border-top: solid 1px #333333;"><euc:EformRadioButton Id="Pain1_2" Value="1" runat="server" ExpandClickableArea="False"/></td>
    <td class="ControlBoxLinedRows" align="center" style="border-top: solid 1px #333333;"><euc:EformRadioButton Id="Pain2_2" Value="2" runat="server" ExpandClickableArea="False"/></td>
    <td class="ControlBoxLinedRows" align="center" style="border-top: solid 1px #333333;"><euc:EformRadioButton Id="Pain3_2" Value="3" runat="server" ExpandClickableArea="False"/></td>
    <td class="ControlBoxLinedRows" align="center" style="border-top: solid 1px #333333;"><euc:EformRadioButton Id="Pain4_2" Value="4" runat="server" ExpandClickableArea="False"/>
        </euc:EformRadioButtonGroup></td>
...
-->    <td class="ControlBoxLinedRows" style="border-top: solid 1px #333333;"><euc:EformComboBox RecordId="21" LookupCode="ToxIntervention" RefBy="ToxIntervention" TABLE="Toxicities" FIELD="ToxIntervention" Runat="server" ID="ToxIntervention_Pain2" style="width: 70px;"/></td>
  ...
  <tr>
    <td valign="top" colspan="2" class="ControlBoxLinedRowsShaded" style="border-bottom: none; border-top: solid 1px;" ><strong>Other:</strong></td>
