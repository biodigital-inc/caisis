<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Prostate.Eforms.BiopsiesProstateWithCores" CodeFile="BiopsiesProstateWithCores.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="BiopsiesProstateWithCores" />

<asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Biopsies" ></asp:Label>
