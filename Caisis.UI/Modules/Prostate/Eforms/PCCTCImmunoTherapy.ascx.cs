namespace Caisis.UI.Modules.Prostate.Eforms
{
	...
	/// <summary>
    ///		Summary description for PCCTCImmunoTherapy.
	/// </summary>
    public partial class PCCTCImmunoTherapy : BaseEFormControl
	{

        protected bool PriorImmunoTxExist = false;

		override protected void Page_Load(object sender, System.EventArgs e)
		{
			base.Page_Load(sender, e);
            //BuildMedTx(this._patientId, this._eformName, "Dynamic", "");
            BuildImmunoMedTx(this._patientId, this._eformName, "Dynamic");
