<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Prostate.Eforms.UrinaryAndSexualFunctionSurvivorship" CodeFile="UrinaryAndSexualFunctionSurvivorship.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="UrinaryAndSexualFunctionSurvivorship" /><span class="controlBoxTitle">Urinary Function  </span><br/>
...
<table width="650" border="0" cellspacing="0" cellpadding="5" style="border: solid 1px #cccccc;">
  ...
  <tr>
	...
	<euc:EformComboBox LookupCode="QOL_Therapy_Incontinence"   style="width:100px;" Field="QOL_Therapy" Table="QOL_Therapy" RecordId="3" Runat="server" id="IncontinenceTX"  />
  ...
  <tr>
	...
	<euc:EformComboBox  LookupCode="QOL_Therapy_Stricture"    style="width:100px;" Field="QOL_Therapy" Table="QOL_Therapy"    RecordId="4" Runat="server" id="StrictureTX"/></td>
