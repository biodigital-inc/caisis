<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Prostate.Eforms.Exam_AS" CodeFile="Exam_AS.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<table width="700" border="0" cellspacing="0" cellpadding="1" style="border: solid 1px #cccccc; border-collapse: collapse;" id="ExamsHtmlTable">
  ...
  <tr class="Exam_DefaultDataEntryRow">
    ...
    <td class="ControlBoxLinedRows" align="center">
	Circumcised: <euc:EformRadioButtonList id="ExamNotes_32" Runat="server" TABLE="EncExams" FIELD="ExamNotes" RecordId="32" Uncheckable="true" RepeatDirection="Horizontal" RepeatLayout="Flow" >
  ...
  <tr class="Exam_DefaultDataEntryRow">
    ...
    <td class="ControlBoxLinedRows" align="center">
	Lesions: <euc:EformRadioButtonList id="ExamNotes_33" Runat="server" TABLE="EncExams" RecordId="33" FIELD="ExamNotes" Uncheckable="true" RepeatDirection="Horizontal" RepeatLayout="Flow" >
  ...
  <tr class="Exam_DefaultDataEntryRow">
	...
	<euc:EformRadioButtonGroup Table="EncExams" Field="ExamResult" id="ExamResult_34" RecordId="34" GroupName="ExamResultGroup_34" runat="server">
		<td class="ControlBoxLinedRowsShaded" align="center"><span><span><euc:EformRadioButton Id="ExamResultNormal_34" Value="Normal" runat="server"/></td>
  ...
  <tr>
    <td valign="top" class="ControlBoxLinedRowsShaded"><euc:EformSelect RecordId="35" LookupCode="BodySystem" TABLE="EncExams" FIELD="ExamSystem" Runat="server" ID="ExamSystem_35" style="width: 35px;"/></td>
    <td valign="top" class="ControlBoxLinedRowsShaded" style="border-right: none;"><euc:EformSelect RecordId="35" LookupCode="Exam" TABLE="EncExams" FIELD="Exam" Runat="server" ID="Exam_35" style="width: 100px;"/></td>
    ...
    <td class="ControlBoxLinedRows" align="center">PVR:<euc:EformTextBox RecordId="35" ShowCalendar="False" CalcDate="False" style="width:168px;" TABLE="EncExams" FIELD="ExamNotes" ShowTextEditor="true" Runat="server" ID="ExamNotes_35"/></td>
    <td class="ControlBoxLinedRows" align="center"><euc:EformDeleteIcon runat="server" ID="ExamDeleteIcon_35"/></td>
  </tr>
  <tr>
    <td valign="top" class="ControlBoxLinedRowsShaded"><euc:EformSelect RecordId="36" LookupCode="BodySystem" TABLE="EncExams" FIELD="ExamSystem" Runat="server" ID="ExamSystem_36" style="width: 35px;"/></td>
    <td valign="top" class="ControlBoxLinedRowsShaded" style="border-right: none;"><euc:EformSelect RecordId="36" LookupCode="Exam" TABLE="EncExams" FIELD="Exam" Runat="server" ID="Exam_36" style="width: 100px;"/></td>
