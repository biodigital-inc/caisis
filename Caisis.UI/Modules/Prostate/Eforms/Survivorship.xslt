<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:param name="CombinedCytology" />
  ...
  <xsl:variable name="RevisedDate">03/03/15</xsl:variable>
...
<xsl:variable name="PageNumber">X of Y</xsl:variable>-->
  ...
  <xsl:template match="eform">
    ...
    <style type="text/css">
      ...
      table#NeobladderHTMLTable td
      {
      text-align: center;
      }

      table#ContinentCutaneousComplicationsTable td
      {
      text-align: center;
      }
      ...
      <table class="masterTable" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="14" align="center" valign="bottom" class="blackBoldText">
            ...
            Approval Date: 6/05<img src="../../Images/shim.gif" border="0" width="45" height="8" />rev:03/03/15<img src="../../Images/shim.gif" border="0" width="45" height="1" />Page <span id="PageNumber">1</span> of <span id="TotalPages">6</span><img src="../../Images/shim.gif" border="0" width="45" height="1" />ASMNTS
          </td>
        </tr>
      </table>
    </div>
    <div align="left"  style="page-break-after:always;">
      ...
      <table class="masterTable" border="0" cellspacing="0" cellpadding="0">
            ...
            <table border="0" width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td colspan="4" class="FormInnerRowBottomBorder">
                  <span class="blackBoldText">
                    <img src="../../Images/shim.gif" border="0" width="4" height="15" />Cytology
                  </span>&#160;&#160;&#160;&#160;
                  <input type="checkbox" name="Reviewed with Radiologist2" />Reviewed with Pathologist
                </td>
              </tr>
              <tr>
              ...
              <xsl:for-each select="$CombinedCytology/Pathology">
                <xsl:choose>
                  <xsl:when test="(@IsDB = 'true')">

                    <tr class="EFormTableRow clickable" onclick="LoadDataEntryForm('Pathology', {./PathologyId}, 'PathDateText,PathDate,PathSpecimenType,PathSite,PathSubsite,PathSide,PathResult,PathHistology,PathDisease')" >
                      <td class="FormInsideTableRegCell" style="padding: 8px 4px;">
                        <xsl:value-of select="PathDateText"  />&#160;
                      </td>
                      <td class="FormInsideTableRegCell" style="padding: 8px 4px;">
                        <xsl:value-of select="PathSite"  />&#160;
                      </td>
                      <td class="FormInsideTableRegCell" style="padding: 8px 4px;">
                        <xsl:value-of select="PathResult"  />&#160;<xsl:value-of select="PathHistology"  />
                      </td>
                      <td class="FormInnerRowBottomBorder"  style="padding: 8px 4px; background-color: transparent;">
                        <xsl:value-of select="PathDataSource"  />&#160;
                      </td>
                    </tr>
                  </xsl:when>
                  <xsl:when test="(@IsDB = 'false') and ((PathSite != '') or (PathResult != '') or (PathDateText != ''))">
                    <tr class="EFormTableRow clickable" onclick="LoadComponentByTable('Pathology','')" >
                      <td class="FormInsideTableRegCell" style="padding: 8px 4px;">
                        <xsl:value-of select="PathDateText"  />&#160;
                      </td>
                      <td class="FormInsideTableRegCell" style="padding: 8px 4px;">
              ...
              <tr class="EFormTableRow clickable" onclick="LoadComponentByTable('Pathology','')" >
                <td height="28" class="FormInsideTableRegCell" align="center">&#160;</td>
                <td  class="FormInsideTableRegCell">&#160;</td>
                <td class="FormInsideTableRegCell">
                  &#160;<strong> </strong>
                </td>
                <td class="FormInnerRowBottomBorder"  style="background-color: transparent;">&#160;</td>
              </tr>
        ...
        <tr>
          <td height="14" align="center" valign="bottom" class="blackBoldText">
            GU34<img src="../../Images/shim.gif" border="0" width="45" height="1" />U38<img src="../../Images/shim.gif" border="0" width="45" height="1" />CMIC
            Approval Date: 6/05<img src="../../Images/shim.gif" border="0" width="45" height="8" />rev:03/03/15<img src="../../Images/shim.gif" border="0" width="45" height="1" />Page <span id="PageNumber">2</span> of <span id="TotalPages">6</span><img src="../../Images/shim.gif" border="0" width="45" height="1" />ASMNTS
          </td>
        </tr>
      </table>
    </div>
    <div align="left"  style="page-break-after:always;">
      ...
      <table class="masterTable" border="0" cellspacing="0" cellpadding="0">
                ...
                <xsl:choose>
                  <xsl:when test="((ROS_System != '') or (ROS_Symptom != '') or (ROS_Result != '') or (ROS_RelatedTo != '') or (ROS_Notes != ''))">
                    <tr class="EFormTableRow" onmouseover="this.className='chronListHilighted';" onmouseout="this.className='EFormTableRow'" onclick="LoadComponentByTable('EncReviewOfSystems',{./@RecordId})">
                      ...
                      <td align="center" valign="middle" class="FormInsideTableRegCell" style="padding:5px 1px;">
        ...
        <tr>
          <td height="14" align="center" valign="bottom" class="blackBoldText">
            GU34<img src="../../Images/shim.gif" border="0" width="45" height="1" />U38<img src="../../Images/shim.gif" border="0" width="45" height="1" />CMIC
            Approval Date: 6/05<img src="../../Images/shim.gif" border="0" width="45" height="8" />rev:03/03/15<img src="../../Images/shim.gif" border="0" width="45" height="1" />Page <span id="PageNumber">3</span> of <span id="TotalPages">6</span><img src="../../Images/shim.gif" border="0" width="45" height="1" />ASMNTS
          </td>
        </tr>
      </table>
    </div>
    ...
    <div align="left"  style="page-break-after:always;">
      ...
      <table class="masterTable" border="0" cellspacing="0" cellpadding="0">
          ...
          <td class="FormOuterTableRow">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="FormInnerRowBottomBorder">
                  <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                    <span class="blackBoldText">Neobladder</span>
                </td>
              </tr>
              <tr>
                <td height="30" class="FormInnerRowBottomBorder">
                  <table id="NeobladderHTMLTable" class="pageWidth98percent" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="22%">&#160;</td>
                      <td width="14%" align="center">Daytime</td>
                      <td width="14%" align="center">Nighttime</td>
                      <td width="50%" rowspan="4" valign="top" class="smallGrayText" style="text-align: left; padding: 10px;">
                        &#160;&#160;&#160;&#160;1
                    ...
                    <tr>
                      <td style="text-align: right; padding-right: 6px;">Continence (see codes on right)</td>
                      <td class="FormInsideTableTopLeftCell"><xsl:value-of select="Surveys[@RecordId=201]/SurveyItems[@RecordId=1]/SurveyItemResult"/>&#160;</td>
                      <td class="FormInsideTableTopCell"><xsl:value-of select="Surveys[@RecordId=201]/SurveyItems[@RecordId=2]/SurveyItemResult"/>&#160;
                      </td>
                    </tr>
                    <tr>
                      <td style="text-align: right; padding-right: 6px;">Date Mild Continence Achieved</td>
                      <td class="FormInsideTableLeftCell"><xsl:value-of select="Surveys[@RecordId=202]/SurveyDateText"/>&#160;</td>
                      <td class="FormInsideTableRegCell"><xsl:value-of select="Surveys[@RecordId=203]/SurveyDateText"/>&#160;</td>
                    </tr>
                    <tr>
                      <td style="text-align: right; padding-right: 6px;">Date Total Continence Achieved</td>
                      <td class="FormInsideTableLeftCell"><xsl:value-of select="Surveys[@RecordId=204]/SurveyDateText"/>&#160;</td>
                      <td class="FormInsideTableRegCell"><xsl:value-of select="Surveys[@RecordId=205]/SurveyDateText"/>&#160;</td>
                    </tr>
                  </table>
                  <br/>
                  Treatment of Incontinence: <xsl:choose>
                  <xsl:when test="(QOL_Therapy[@RecordId=1]/QOL_Therapy != '')">
                    <span style="text-decoration:underline;">&#160;&#160;&#160;<xsl:value-of select="QOL_Therapy[@RecordId=1]/QOL_Therapy"/>&#160;&#160;&#160;</span>
                  </xsl:when>
                  <xsl:otherwise>_____________________</xsl:otherwise>
                </xsl:choose><img src="../../Images/shim.gif" border="0" width="60" height="1"/>
                    Tx Date: <xsl:choose>
                  <xsl:when test="(QOL_Therapy[@RecordId=1]/QOL_TxDateText != '')">
                    <span style="text-decoration:underline;">
                      &#160;&#160;&#160;<xsl:value-of select="QOL_Therapy[@RecordId=1]/QOL_TxDateText"/>&#160;&#160;&#160;
                    </span>
                  </xsl:when>
                  <xsl:otherwise>__________________</xsl:otherwise>
                </xsl:choose><br />
                    Treatment for Bladder Neck Contracture: <img src="../../Images/shim.gif" border="0" width="11" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(QOL_Therapy[@RecordId=2]/QOL_Therapy != '')">
                      <input type="checkbox" name="TreatmentforBladderNeckContractureYes" checked="checked" />Yes<img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                      <input type="checkbox" name="TreatmentforBladderNeckContractureNo"/>No
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="TreatmentforBladderNeckContractureYes" />Yes<img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                      <input type="checkbox" name="TreatmentforBladderNeckContractureNo" checked="checked"/>No
                    </xsl:otherwise>
                  </xsl:choose><img src="../../Images/shim.gif" border="0" width="34" height="1"/>
                              Tx Date: <xsl:choose>
                  <xsl:when test="(QOL_Therapy[@RecordId=1]/QOL_TxDateText != '')">
                    <span style="text-decoration:underline;">
                      &#160;&#160;&#160;<xsl:value-of select="QOL_Therapy[@RecordId=2]/QOL_TxDateText"/>&#160;&#160;&#160;
                    </span>
                  </xsl:when>
                  <xsl:otherwise>__________________</xsl:otherwise>
                </xsl:choose><br />
              ...
              <tr>
                <td height="25" class="FormInnerRowBottomBorder">
                  Need for Intermittent Cath:<img src="../../Images/shim.gif" border="0" width="10" height="8"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=207]/SurveyItems[@RecordId=1]/SurveyItemResult = 'No')">
                      <input type="checkbox" name="NeedforIntermittentCathNo" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="NeedforIntermittentCathNo"/>
                    </xsl:otherwise>
                  </xsl:choose>No<img src="../../Images/shim.gif" border="0" width="10" height="8"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=207]/SurveyItems[@RecordId=1]/SurveyItemResult = 'Yes')">
                      <input type="checkbox" name="NeedforIntermittentCathYes" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="NeedforIntermittentCathYes"/>
                    </xsl:otherwise>
                  </xsl:choose>
                          Yes<img src="../../Images/shim.gif" border="0" width="20" height="8"/>
                            Date: <xsl:choose>
                  <xsl:when test="(Surveys[@RecordId=207]/SurveyItems[@RecordId=2]/SurveyItemResult != '')">
                    <span style="text-decoration:underline;">
                      &#160;&#160;&#160;<xsl:value-of select="Surveys[@RecordId=207]/SurveyItems[@RecordId=2]/SurveyItemResult"/>&#160;&#160;&#160;
                    </span>
                  </xsl:when>
                  <xsl:otherwise>__________________</xsl:otherwise>
                </xsl:choose> <img src="../../Images/shim.gif" border="0" width="20" height="8"/>Frequency 
              of Cath: <xsl:choose>
                  <xsl:when test="(Surveys[@RecordId=207]/SurveyItems[@RecordId=4]/SurveyItemResult != '')">
                    <span style="text-decoration:underline;">
                      &#160;&#160;&#160;<xsl:value-of select="Surveys[@RecordId=207]/SurveyItems[@RecordId=4]/SurveyItemResult"/>&#160;&#160;&#160;
                    </span>
                  </xsl:when>
                  <xsl:otherwise>_______</xsl:otherwise>
                </xsl:choose> times / day</td>
              </tr>
              <tr>
                <td height="25" class="FormInnerRowBottomBorder">
                  Nocturia:<img src="../../Images/shim.gif" border="0" width="20" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=207]/SurveyItems[@RecordId=5]/SurveyItemResult = 'No')">
                      <input type="checkbox" name="NocturiaNo" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="NocturiaNo"/>
                    </xsl:otherwise>
                  </xsl:choose>No<img src="../../Images/shim.gif" border="0" width="10" height="8"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=207]/SurveyItems[@RecordId=5]/SurveyItemResult = 'Yes')">
                      <input type="checkbox" name="NocturiaYes" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="NocturiaYes"/>
                    </xsl:otherwise>
                  </xsl:choose>Yes<img src="../../Images/shim.gif" border="0" width="25" height="8"/>
                            #:<xsl:choose>
                  <xsl:when test="(Surveys[@RecordId=207]/SurveyItems[@RecordId=6]/SurveyItemResult != '')">
                    <span style="text-decoration:underline;">
                      &#160;&#160;&#160;<xsl:value-of select="Surveys[@RecordId=207]/SurveyItems[@RecordId=6]/SurveyItemResult"/>&#160;&#160;&#160;
                    </span>
                  </xsl:when>
                  <xsl:otherwise>_______</xsl:otherwise>
                </xsl:choose><img src="../../Images/shim.gif" border="0" width="60" height="1"/>
                              Pads:<img src="../../Images/shim.gif" border="0" width="20" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=207]/SurveyItems[@RecordId=7]/SurveyItemResult = 'No')">
                      <input type="checkbox" name="PadsNo" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="PadsNo"/>
                    </xsl:otherwise>
                  </xsl:choose>No<img src="../../Images/shim.gif" border="0" width="10" height="8"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=207]/SurveyItems[@RecordId=7]/SurveyItemResult = 'Yes')">
                      <input type="checkbox" name="PadsYes" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="PadsYes"/>
                    </xsl:otherwise>
                  </xsl:choose>Yes<img src="../../Images/shim.gif" border="0" width="25" height="1"/>#:<xsl:choose>
                  <xsl:when test="(Surveys[@RecordId=207]/SurveyItems[@RecordId=8]/SurveyItemResult != '')">
                    <span style="text-decoration:underline;">
                      &#160;&#160;&#160;<xsl:value-of select="Surveys[@RecordId=207]/SurveyItems[@RecordId=8]/SurveyItemResult"/>&#160;&#160;&#160;
                    </span>
                  </xsl:when>
            ...
            <table width="100%" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td height="25" class="FormInsideTableRegCell">
                  ...
                  Q2:______<img src="../../images/shim.gif" border="0" width="6" height="1"/>Q3:______
                </td>
                <td class="FormInsideTableRegCell">
                  ...
                  Yes&#160; <input type="checkbox" name="Yes22"/>No
                </td>
              </tr>
              <tr>
                <td height="25" class="FormInsideTableRegCell">
              ...
              <tr>
                ...
                <td align="left" class="FormInsideTableRegCell">
                  ...
                  <span style="display:inline-block;padding:1px 14px;border:solid 1px #666666;">
                    <xsl:value-of select="Surveys[@RecordId=3]/SurveyItems[@RecordId=1]/SurveyItemResult"/>&#160;
                  </span>
          ...
          <td class="FormOuterTableRow">
            <table class="pageWidth" border="0" cellspacing="0" cellpadding="2">
              <tr>
                <td class="FormInnerRowBottomBorder">
                  <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                    <span class="blackBoldText">Continent Cutaneous Diversions</span>
                </td>
              </tr>
              <tr>
                <td height="24" class="FormInnerRowBottomBorder">
                  <img src="../../Images/shim.gif" border="0" width="4" height="1"/>Cath Interval: <xsl:choose>
                  <xsl:when test="(Surveys[@RecordId=210]/SurveyItems[@RecordId=1]/SurveyItemResult != '')">
                    <span style="text-decoration:underline;">
                      &#160;&#160;&#160;<xsl:value-of select="Surveys[@RecordId=210]/SurveyItems[@RecordId=1]/SurveyItemResult"/>&#160;&#160;&#160;
                    </span>
                  </xsl:when>
                  <xsl:otherwise>_________</xsl:otherwise>
                </xsl:choose>&#160;hrs
              ...
              <tr valign="top">
                <td height="24" class="FormInnerRowBottomBorder">
                  ...
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=210]/SurveyItems[@RecordId=2]/SurveyItemResult != '')">
                        Continence:&#160;&#160;<span style="text-decoration:underline;" ><xsl:value-of select="Surveys[@RecordId=210]/SurveyItems[@RecordId=2]/SurveyItemResult"/></span>&#160;&#160;&#160;
                    </xsl:when>
                    <xsl:otherwise>
                      Continence (circle one):
                      <img src="../../Images/shim.gif" border="0" width="30" height="1"/>
                      Complete
                    ...
                    <br/>
                          <img src="../../Images/shim.gif" border="0" width="30" height="4"/>
                            <br/>
                            <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                              Within:<img src="../../Images/shim.gif" border="0" width="20" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=210]/SurveyItems[@RecordId=3]/SurveyItemResult != '')">
                      <span style="text-decoration:underline;" >
                        <xsl:value-of select="Surveys[@RecordId=210]/SurveyItems[@RecordId=3]/SurveyItemResult"/>
                      </span>&#160;&#160;&#160;
                    </xsl:when>
                    <xsl:otherwise>
                      ...
                      6h
                                ...
                                <img src="../../Images/shim.gif" border="0" width="60" height="1"/>
			# of pads:<xsl:choose>
                  <xsl:when test="(Surveys[@RecordId=210]/SurveyItems[@RecordId=4]/SurveyItemResult != '')">
                    <span style="text-decoration:underline;">
                      &#160;&#160;&#160;<xsl:value-of select="Surveys[@RecordId=210]/SurveyItems[@RecordId=4]/SurveyItemResult"/>&#160;&#160;&#160;
                    </span>
                  </xsl:when>
                  <xsl:otherwise>_________</xsl:otherwise>
                </xsl:choose></td>
              ...
              <tr>
                <td height="24" class="FormInnerRowBottomBorder">
                  ...
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=210]/SurveyItems[@RecordId=5]/SurveyItemResult != '')">
                      <span style="text-decoration:underline;" >
                        <xsl:value-of select="Surveys[@RecordId=210]/SurveyItems[@RecordId=5]/SurveyItemResult"/>
                      </span>&#160;&#160;&#160;
                    </xsl:when>
                    <xsl:otherwise>
                      12 F
                      ...
                      <img src="../../Images/shim.gif" border="0" width="30" height="1"/>
                      16 F
                      <img src="../../Images/shim.gif" border="0" width="30" height="8"/>
                      18 F
                      <img src="../../Images/shim.gif" border="0" width="30" height="1"/>&gt;20 F
                    </xsl:otherwise>
                  </xsl:choose></td>
              </tr>
              <tr valign="top">
                <td height="24" class="FormInnerRowBottomBorder">
                  <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                    ...
                    <img src="../../Images/shim.gif" border="0" width="20" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=210]/SurveyItems[@RecordId=6]/SurveyItemResult != '')">
                      <span style="text-decoration:underline;" >
                        &#160;&#160;&#160;<xsl:value-of select="Surveys[@RecordId=210]/SurveyItems[@RecordId=6]/SurveyItemResult"/>&#160;&#160;&#160;
                      </span>&#160;&#160;&#160;
                    </xsl:when>
                    <xsl:otherwise>
                      no difficulty
                      ...
                      1 /day
                          ...
                          <img src="../../Images/shim.gif" border="0" width="130" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=210]/SurveyItems[@RecordId=7]/SurveyItemResult = 'Unchanged')">
                      <input type="checkbox" name="EaseOfCatheterizationUnchanged" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="EaseOfCatheterizationUnchanged"/>
                    </xsl:otherwise>
                  </xsl:choose>unchanged

                  <img src="../../Images/shim.gif" border="0" width="20" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=210]/SurveyItems[@RecordId=7]/SurveyItemResult = 'Worse')">
                      <input type="checkbox" name="EaseOfCatheterizationWorse" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="EaseOfCatheterizationWorse"/>
                    </xsl:otherwise>
                  </xsl:choose>worse
                                  <img src="../../Images/shim.gif" border="0" width="20" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=210]/SurveyItems[@RecordId=7]/SurveyItemResult = 'Improved')">
                      <input type="checkbox" name="EaseOfCatheterizationImproved" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="EaseOfCatheterizationImproved"/>
                    </xsl:otherwise>
                  </xsl:choose>improved
                </td>
              </tr>
              <tr valign="top">
                <td height="30" class="FormInnerRowBottomBorder">
                  Complications<br/>
                  <table id="ContinentCutaneousComplicationsTable" width="90%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                    ...
                    <tr>
                      <td class="FormInsideTableLeftCell" style="text-align:left;">
                        <xsl:value-of select="Toxicities[@RecordId=21]/ToxName"/>&#160;
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=21]/ToxProbability = 'Definite')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=21]/ToxProbability = 'Unrelated')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:value-of select="Toxicities[@RecordId=21]/ToxDateText"/>&#160;
                      </td>
                      <td>&#160;</td>
                      <td class="FormInsideTableLeftCell" style="text-align:left;">
                        <xsl:value-of select="Toxicities[@RecordId=26]/ToxName"/>&#160;
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=26]/ToxProbability = 'Definite')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=26]/ToxProbability = 'Unrelated')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:value-of select="Toxicities[@RecordId=26]/ToxDateText"/>&#160;
                      </td>
                    </tr>
                    <tr>
                      <td class="FormInsideTableLeftCell" style="text-align:left;">
                        <xsl:value-of select="Toxicities[@RecordId=22]/ToxName"/>&#160;
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=22]/ToxProbability = 'Definite')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=22]/ToxProbability = 'Unrelated')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:value-of select="Toxicities[@RecordId=22]/ToxDateText"/>&#160;
                      </td>
                      <td>&#160;</td>
                      <td class="FormInsideTableLeftCell" style="text-align:left;">
                        <xsl:value-of select="Toxicities[@RecordId=27]/ToxName"/>&#160;
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=27]/ToxProbability = 'Definite')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=27]/ToxProbability = 'Unrelated')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:value-of select="Toxicities[@RecordId=27]/ToxDateText"/>&#160;
                      </td>
                    </tr>
                    <tr>
                      <td class="FormInsideTableLeftCell" style="text-align:left;">
                        <xsl:value-of select="Toxicities[@RecordId=23]/ToxName"/>&#160;
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=23]/ToxProbability = 'Definite')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=23]/ToxProbability = 'Unrelated')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:value-of select="Toxicities[@RecordId=23]/ToxDateText"/>&#160;
                      </td>
                      <td>&#160;</td>
                      <td class="FormInsideTableLeftCell" style="text-align:left;">
                        <xsl:value-of select="Toxicities[@RecordId=28]/ToxName"/>&#160;
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=28]/ToxProbability = 'Definite')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=28]/ToxProbability = 'Unrelated')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:value-of select="Toxicities[@RecordId=28]/ToxDateText"/>&#160;
                      </td>
                    </tr>
                    <tr>
                      <td class="FormInsideTableLeftCell" style="text-align:left;">
                        <xsl:value-of select="Toxicities[@RecordId=24]/ToxName"/>&#160;
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=24]/ToxProbability = 'Definite')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=24]/ToxProbability = 'Unrelated')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:value-of select="Toxicities[@RecordId=24]/ToxDateText"/>&#160;
                      </td>
                      <td>&#160;</td>
                      <td class="FormInsideTableLeftCell" style="text-align:left;">
                        <xsl:value-of select="Toxicities[@RecordId=29]/ToxName"/>&#160;
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=29]/ToxProbability = 'Definite')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=29]/ToxProbability = 'Unrelated')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:value-of select="Toxicities[@RecordId=29]/ToxDateText"/>&#160;
                      </td>
                    </tr>
                    <tr>
                      <td class="FormInsideTableLeftCell" style="text-align:left;">
                        <xsl:value-of select="Toxicities[@RecordId=25]/ToxName"/>&#160;
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=25]/ToxProbability = 'Definite')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=25]/ToxProbability = 'Unrelated')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:value-of select="Toxicities[@RecordId=25]/ToxDateText"/>&#160;
                      </td>
                      <td>&#160;</td>
                      <td class="FormInsideTableLeftCell" style="text-align:left;">
                        <xsl:value-of select="Toxicities[@RecordId=30]/ToxName"/>&#160;
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=30]/ToxProbability = 'Definite')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:choose>
                          <xsl:when test="(Toxicities[@RecordId=30]/ToxProbability = 'Unrelated')">X</xsl:when>
                          <xsl:otherwise>&#160;</xsl:otherwise>
                        </xsl:choose>
                      </td>
                      <td class="FormInsideTableRegCell">
                        <xsl:value-of select="Toxicities[@RecordId=30]/ToxDateText"/>&#160;
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr valign="top">
                <td width="625" class="FormInnerRowBottomBorder">
                  <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                    Required Revisions:
                    <img src="../../Images/shim.gif" border="0" width="20" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=210]/SurveyItems[@RecordId=8]/SurveyItemResult = 'No')">
                      <input type="checkbox" name="RequiredRevisionsNo" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="RequiredRevisionsNo"/>
                    </xsl:otherwise>
                  </xsl:choose>&#160;No
                        <img src="../../Images/shim.gif" border="0" width="20" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=210]/SurveyItems[@RecordId=8]/SurveyItemResult = 'Yes')">
                      <input type="checkbox" name="RequiredRevisionsYes" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="RequiredRevisionsYes"/>
                    </xsl:otherwise>
                  </xsl:choose>&#160;Yes
                            <img src="../../Images/shim.gif" border="0" width="60" height="1"/>
                              Revision Date: <xsl:choose>
                  <xsl:when test="(Surveys[@RecordId=210]/SurveyItems[@RecordId=9]/SurveyItemResult != '')">
                    <span style="text-decoration:underline;">
                      &#160;&#160;&#160;<xsl:value-of select="Surveys[@RecordId=210]/SurveyItems[@RecordId=9]/SurveyItemResult"/>&#160;&#160;&#160;
                    </span>
                  </xsl:when>
                  <xsl:otherwise>__________________</xsl:otherwise>
                </xsl:choose><br/>
                              <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                                ...
                                <img src="../../Images/shim.gif" border="0" width="20" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=210]/SurveyItems[@RecordId=11]/SurveyItemResult = 'Stomal Stenosis')">
                      <input type="checkbox" name="stomalStenosis" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="stomalStenosis"/>
                    </xsl:otherwise>
                  </xsl:choose>Stomal Stenosis
                                  <img src="../../Images/shim.gif" border="0" width="30" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=210]/SurveyItems[@RecordId=11]/SurveyItemResult = 'Limb Revision')">
                      <input type="checkbox" name="limbRevision" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="limbRevision"/>
                    </xsl:otherwise>
                  </xsl:choose>Limb Revision
                                    <img src="../../Images/shim.gif" border="0" width="30" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=210]/SurveyItems[@RecordId=11]/SurveyItemResult = 'Pouch')">
                      <input type="checkbox" name="pouch" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="pouch"/>
                    </xsl:otherwise>
                  </xsl:choose>Pouch
                </td>
              </tr>
        ...
        <tr>
          <td class="FormOuterTableRow">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td width="100%" colspan="3" class="FormInsideTableTopCell">
                  <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                    <span class="blackBoldText">Ileal Conduit Diversion</span>
                </td>
              </tr>
              <tr>
                <td width="30%" class="FormInsideTableLeftCell">
                  <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                    <span>
                      <strong>Conduit Stoma:</strong>
                    </span>
                    <br />
                    <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                      Pink and Viable
                      <img src="../../Images/shim.gif" border="0" width="11" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=1]/SurveyItemResult = 'Yes')">
                      <input type="checkbox" name="PinkandViableYes" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="PinkandViableYes"/>
                    </xsl:otherwise>
                  </xsl:choose> Yes
                          <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=1]/SurveyItemResult = 'No')">
                      <input type="checkbox" name="PinkandViableNo" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="PinkandViableNo"/>
                    </xsl:otherwise>
                  </xsl:choose>
                              No<br />
                              <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                                Stoma Type:<br />
                                <img src="../../Images/shim.gif" border="0" width="1" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=2]/SurveyItemResult = 'Turnbull')">
                      <input type="checkbox" name="Turnbull" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="Turnbull"/>
                    </xsl:otherwise>
                  </xsl:choose>Turnbull
                                    <img src="../../Images/shim.gif" border="0" width="2" height="1"/>

                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=2]/SurveyItemResult = 'Rosebud')">
                      <input type="checkbox" name="Rosebud" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="Rosebud"/>
                    </xsl:otherwise>
                  </xsl:choose>Rosebud
                </td>
                <td width="35%" class="FormInsideTableRegCell">
                  <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                    ...
                    <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=3]/SurveyItemResult = 'Yes')">
                      <input type="checkbox" name="StomalStenosisYes" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="StomalStenosisYes"/>
                    </xsl:otherwise>
                  </xsl:choose> Yes
                  <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=3]/SurveyItemResult = 'No')">
                      <input type="checkbox" name="StomalStenosisNo" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="StomalStenosisNo"/>
                    </xsl:otherwise>
                  </xsl:choose>
                            No<br />
                            <span class="smallGrayText">
                              ...
                              <xsl:choose>
                                <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=4]/SurveyItemResult = 'Yes')">
                                  <input type="checkbox" name="RequiredRevisionYes" checked="checked" />
                                </xsl:when>
                                <xsl:otherwise>
                                  <input type="checkbox" name="RequiredRevisionYes"/>
                                </xsl:otherwise>
                              </xsl:choose> Yes
                              <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                              <xsl:choose>
                                <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=4]/SurveyItemResult = 'No')">
                                  <input type="checkbox" name="RequiredRevisionNo" checked="checked" />
                                </xsl:when>
                                <xsl:otherwise>
                                  <input type="checkbox" name="RequiredRevisionNo"/>
                                </xsl:otherwise>
                              </xsl:choose>No<br />
                                        <img src="../../Images/shim.gif" border="0" width="4" height="1"/>Date: <xsl:choose>
                              <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=5]/SurveyItemResult != '')">
                                <span style="text-decoration:underline;">
                                  &#160;&#160;&#160;<xsl:value-of select="Surveys[@RecordId=211]/SurveyItems[@RecordId=5]/SurveyItemResult"/>&#160;&#160;&#160;
                                </span>
                              </xsl:when>
                ...
                <td width="35%" class="FormInsideTableRegCell">
                  <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                    ...
                    <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=7]/SurveyItemResult = 'Yes')">
                      <input type="checkbox" name="PeristomalHerniaYes" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="PeristomalHerniaYes"/>
                    </xsl:otherwise>
                  </xsl:choose> Yes
                  <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=7]/SurveyItemResult = 'No')">
                      <input type="checkbox" name="PeristomalHerniaNo" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="PeristomalHerniaNo"/>
                    </xsl:otherwise>
                  </xsl:choose>No<br />
                            <span class="smallGrayText">
                              <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                                ...
                                <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                              <xsl:choose>
                                <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=8]/SurveyItemResult = 'Yes')">
                                  <input type="checkbox" name="PeristomalHerniaRequiredRevisionYes" checked="checked" />
                                </xsl:when>
                                <xsl:otherwise>
                                  <input type="checkbox" name="PeristomalHerniaRequiredRevisionYes"/>
                                </xsl:otherwise>
                              </xsl:choose> Yes
                              <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                              <xsl:choose>
                                <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=8]/SurveyItemResult = 'No')">
                                  <input type="checkbox" name="PeristomalHerniaRequiredRevisionNo" checked="checked" />
                                </xsl:when>
                                <xsl:otherwise>
                                  <input type="checkbox" name="PeristomalHerniaRequiredRevisionNo"/>
                                </xsl:otherwise>
                              </xsl:choose>No<br />
                                        <img src="../../Images/shim.gif" border="0" width="4" height="1"/>Date: <xsl:choose>
                              <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=9]/SurveyItemResult != '')">
                                <span style="text-decoration:underline;">
                                  &#160;&#160;&#160;<xsl:value-of select="Surveys[@RecordId=211]/SurveyItems[@RecordId=9]/SurveyItemResult"/>&#160;&#160;&#160;
                                </span>
                              </xsl:when>
                              <xsl:otherwise>___________</xsl:otherwise>
                            </xsl:choose></span>
              ...
              <tr>
                <td width="100%" colspan="3" class="FormInsideTableRegCell">
                  <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                    <span>
                    ...
                    <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=11]/SurveyItemResult != '')">
                      <input type="checkbox" name="ApplianceNoProblemsOrLeakage" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="ApplianceNoProblemsOrLeakage"/>
                    </xsl:otherwise>
                  </xsl:choose>
                        No Problems or Leakage
                        <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                          # Days Between Plate Changes: <xsl:choose>
                  <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=12]/SurveyItemResult != '')">
                    <span style="text-decoration:underline;">
                      &#160;&#160;&#160;<xsl:value-of select="Surveys[@RecordId=211]/SurveyItems[@RecordId=12]/SurveyItemResult"/>&#160;&#160;&#160;
                    </span>
                  </xsl:when>
                  <xsl:otherwise>_____</xsl:otherwise>
                          ...
                          <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=13]/SurveyItemResult != '')">
                      <input type="checkbox" name="ApplianceUsesAbdominalBinder" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="ApplianceUsesAbdominalBinder"/>
                    </xsl:otherwise>
                  </xsl:choose>Uses Abdominal Binder
                              <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=211]/SurveyItems[@RecordId=14]/SurveyItemResult != '')">
                      <input type="checkbox" name="ApplianceUsesApplianceBelt" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="ApplianceUsesApplianceBelt"/>
                    </xsl:otherwise>
                  </xsl:choose>Uses Appliance Belt
                </td>
              </tr>
            </table>
          </td>
          ...
          <td class="FormOuterTableRow">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td width="100%" colspan="3" class="FormInsideTableTopCell">
                  <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                    <span class="blackBoldText">Ureteral Anastamosis</span>
                </td>
              </tr>
              <tr>
                <td width="50%" class="FormInsideTableLeftCell">
                  <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                    Hydronephrosis
                    <img src="../../Images/shim.gif" border="0" width="9" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=1]/SurveyItemResult = 'Yes')">
                      <input type="checkbox" name="HydronephrosisYes" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="HydronephrosisYes"/>
                    </xsl:otherwise>
                  </xsl:choose> Yes
                  <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=1]/SurveyItemResult = 'No')">
                      <input type="checkbox" name="HydronephrosisNo" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="HydronephrosisNo"/>
                    </xsl:otherwise>
                  </xsl:choose>No<br />
                            <span class="smallGrayText">
                              <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                                Date: <xsl:choose>
                              <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=2]/SurveyItemResult != '')">
                                <span style="text-decoration:underline;">
                                  &#160;&#160;&#160;<xsl:value-of select="Surveys[@RecordId=212]/SurveyItems[@RecordId=2]/SurveyItemResult"/>&#160;&#160;&#160;
                                </span>
                              </xsl:when>
                              <xsl:otherwise>___________</xsl:otherwise>
                            </xsl:choose>
                                <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                                  ...
                                  <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                              <xsl:choose>
                                <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=4]/SurveyItemResult = 'Left')">
                                  <input type="checkbox" name="HydronephrosisSideLeft" checked="checked" />
                                </xsl:when>
                                <xsl:otherwise>
                                  <input type="checkbox" name="HydronephrosisSideLeft"/>
                                </xsl:otherwise>
                              </xsl:choose>Left
                                      <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                              <xsl:choose>
                                <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=4]/SurveyItemResult = 'Right')">
                                  <input type="checkbox" name="HydronephrosisSideRight" checked="checked" />
                                </xsl:when>
                                <xsl:otherwise>
                                  <input type="checkbox" name="HydronephrosisSideRight"/>
                                </xsl:otherwise>
                              </xsl:choose>Right
                                          <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                              <xsl:choose>
                                <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=4]/SurveyItemResult = 'Bilateral')">
                                  <input type="checkbox" name="HydronephrosisSideBilateral" checked="checked" />
                                </xsl:when>
                                <xsl:otherwise>
                                  <input type="checkbox" name="HydronephrosisSideBilateral"/>
                                </xsl:otherwise>
                              </xsl:choose>Bilateral
                            </span>
                </td>
                <td width="50%" class="FormInsideTableRegCell">
                  <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                    ...
                    <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=9]/SurveyItemResult = 'Yes')">
                      <input type="checkbox" name="UreteralStenosisYes" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="UreteralStenosisYes"/>
                    </xsl:otherwise>
                  </xsl:choose> Yes
                  <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=9]/SurveyItemResult = 'No')">
                      <input type="checkbox" name="UreteralStenosisNo" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="UreteralStenosisNo"/>
                    </xsl:otherwise>
                  </xsl:choose>No<br />
                            <span class="smallGrayText">
                              <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                                Date: <xsl:choose>
                              <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=10]/SurveyItemResult != '')">
                                <span style="text-decoration:underline;">
                                  &#160;&#160;&#160;<xsl:value-of select="Surveys[@RecordId=212]/SurveyItems[@RecordId=10]/SurveyItemResult"/>&#160;&#160;&#160;
                                </span>
                              </xsl:when>
                              <xsl:otherwise>___________</xsl:otherwise>
                            </xsl:choose>
                            ...
                            <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                            <xsl:choose>
                              <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=12]/SurveyItemResult = 'Left')">
                                <input type="checkbox" name="UreteralStenosisSideLeft" checked="checked" />
                              </xsl:when>
                              <xsl:otherwise>
                                <input type="checkbox" name="UreteralStenosisSideLeft"/>
                              </xsl:otherwise>
                            </xsl:choose>Left
                            <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                            <xsl:choose>
                              <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=12]/SurveyItemResult = 'Right')">
                                <input type="checkbox" name="UreteralStenosisSideRight" checked="checked" />
                              </xsl:when>
                              <xsl:otherwise>
                                <input type="checkbox" name="UreteralStenosisSideRight"/>
                              </xsl:otherwise>
                            </xsl:choose>Right
                            <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                            <xsl:choose>
                              <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=12]/SurveyItemResult = 'Bilateral')">
                                <input type="checkbox" name="UreteralStenosisSideBilateral" checked="checked" />
                              </xsl:when>
                              <xsl:otherwise>
                                <input type="checkbox" name="UreteralStenosisSideBilateral"/>
                              </xsl:otherwise>
                            </xsl:choose>Bilateral
                          </span>
                </td>
              ...
              <tr>
                <td width="50%" class="FormInsideTableLeftCell">
                  <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                    ...
                    <img src="../../Images/shim.gif" border="0" width="9" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=5]/SurveyItemResult = 'Yes')">
                      <input type="checkbox" name="UpperTractRecurrenceYes" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="UpperTractRecurrenceYes"/>
                    </xsl:otherwise>
                  </xsl:choose> Yes
                  <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=5]/SurveyItemResult = 'No')">
                      <input type="checkbox" name="UpperTractRecurrenceNo" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="UpperTractRecurrenceNo"/>
                    </xsl:otherwise>
                  </xsl:choose>No<br />
                            <span class="smallGrayText">
                              <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                                Date: <xsl:choose>
                              <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=6]/SurveyItemResult != '')">
                                <span style="text-decoration:underline;">
                                  &#160;&#160;&#160;<xsl:value-of select="Surveys[@RecordId=212]/SurveyItems[@RecordId=6]/SurveyItemResult"/>&#160;&#160;&#160;
                                </span>
                              </xsl:when>
                              <xsl:otherwise>___________</xsl:otherwise>
                            </xsl:choose>
                            ...
                            <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                            <xsl:choose>
                              <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=8]/SurveyItemResult = 'Left')">
                                <input type="checkbox" name="UpperTractRecurrenceSideLeft" checked="checked" />
                              </xsl:when>
                              <xsl:otherwise>
                                <input type="checkbox" name="UpperTractRecurrenceSideLeft"/>
                              </xsl:otherwise>
                            </xsl:choose>Left
                            <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                            <xsl:choose>
                              <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=8]/SurveyItemResult = 'Right')">
                                <input type="checkbox" name="UpperTractRecurrenceSideRight" checked="checked" />
                              </xsl:when>
                              <xsl:otherwise>
                                <input type="checkbox" name="UpperTractRecurrenceSideRight"/>
                              </xsl:otherwise>
                            </xsl:choose>Right
                            <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                            <xsl:choose>
                              <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=8]/SurveyItemResult = 'Bilateral')">
                                <input type="checkbox" name="UpperTractRecurrenceSideBilateral" checked="checked" />
                              </xsl:when>
                              <xsl:otherwise>
                                <input type="checkbox" name="UpperTractRecurrenceSideBilateral"/>
                              </xsl:otherwise>
                            </xsl:choose>Bilateral
                          </span>
                </td>
                <td width="50%" class="FormInsideTableRegCell">
                  <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                    Required Revision or AI Procedure
                    <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=13]/SurveyItemResult = 'Yes')">
                      <input type="checkbox" name="RequiredRevisionorAIProcedureYes" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="RequiredRevisionorAIProcedureYes"/>
                    </xsl:otherwise>
                  </xsl:choose> Yes
                  <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                  <xsl:choose>
                    <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=13]/SurveyItemResult = 'No')">
                      <input type="checkbox" name="RequiredRevisionorAIProcedureNo" checked="checked" />
                    </xsl:when>
                    <xsl:otherwise>
                      <input type="checkbox" name="RequiredRevisionorAIProcedureNo"/>
                    </xsl:otherwise>
                  </xsl:choose>No<br />
                            <span class="smallGrayText">
                              <img src="../../Images/shim.gif" border="0" width="4" height="1"/>
                                Date: <xsl:choose>
                              <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=14]/SurveyItemResult != '')">
                                <span style="text-decoration:underline;">
                                  &#160;&#160;&#160;<xsl:value-of select="Surveys[@RecordId=212]/SurveyItems[@RecordId=14]/SurveyItemResult"/>&#160;&#160;&#160;
                                </span>
                              </xsl:when>
                              <xsl:otherwise>___________</xsl:otherwise>
                            </xsl:choose>
                            ...
                            <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                            <xsl:choose>
                              <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=16]/SurveyItemResult = 'Left')">
                                <input type="checkbox" name="RequiredRevisionorAIProcedureSideLeft" checked="checked" />
                              </xsl:when>
                              <xsl:otherwise>
                                <input type="checkbox" name="RequiredRevisionorAIProcedureSideLeft"/>
                              </xsl:otherwise>
                            </xsl:choose>Left
                            <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                            <xsl:choose>
                              <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=16]/SurveyItemResult = 'Right')">
                                <input type="checkbox" name="RequiredRevisionorAIProcedureSideRight" checked="checked" />
                              </xsl:when>
                              <xsl:otherwise>
                                <input type="checkbox" name="RequiredRevisionorAIProcedureSideRight"/>
                              </xsl:otherwise>
                            </xsl:choose>Right
                            <img src="../../Images/shim.gif" border="0" width="2" height="1"/>
                            <xsl:choose>
                              <xsl:when test="(Surveys[@RecordId=212]/SurveyItems[@RecordId=16]/SurveyItemResult = 'Bilateral')">
                                <input type="checkbox" name="RequiredRevisionorAIProcedureSideBilateral" checked="checked" />
                              </xsl:when>
                              <xsl:otherwise>
                                <input type="checkbox" name="RequiredRevisionorAIProcedureSideBilateral"/>
                              </xsl:otherwise>
                            </xsl:choose>Bilateral
                          </span>
                </td>
        ...
        <tr>
          <td height="14" align="center" valign="bottom" class="blackBoldText">
            GU34<img src="../../Images/shim.gif" border="0" width="45" height="1" />U38<img src="../../Images/shim.gif" border="0" width="45" height="1" />CMIC
            Approval Date: 6/05<img src="../../Images/shim.gif" border="0" width="45" height="8" />rev:03/03/15<img src="../../Images/shim.gif" border="0" width="45" height="1" />Page <span id="PageNumber">4</span> of <span id="TotalPages">6</span><img src="../../Images/shim.gif" border="0" width="45" height="1" />ASMNTS
          </td>
        </tr>
      </table>
    </div>
    ...
    <div align="left"  style="page-break-after:always;">
      ...
      <table class="masterTable" border="0" cellspacing="0" cellpadding="0">
                ...
                <xsl:choose>
                  <xsl:when test="((ExamSystem != '') or (Exam != '') or (ExamResult != '') or (ExamAttendingPerformed != '') or (ExamNotes != ''))">
                    ...
                    <tr class="EFormTableRow" onmouseover="this.className='chronListHilighted';" onmouseout="this.className='EFormTableRow'" onclick="LoadComponentByTable('EncExams',{./@RecordId})">
                      ...
                      <td align="center" valign="middle" class="FormInsideTableRegCell" style="border-right: none; padding: 3px 1px;">
        ...
        <tr>
          <td height="14" align="center" valign="bottom" class="blackBoldText">
            GU34<img src="../../Images/shim.gif" border="0" width="45" height="1" />U38<img src="../../Images/shim.gif" border="0" width="45" height="1" />CMIC
            Approval Date: 6/05<img src="../../Images/shim.gif" border="0" width="45" height="8" />rev:03/03/15<img src="../../Images/shim.gif" border="0" width="45" height="1" />Page <span id="PageNumber">5</span> of <span id="TotalPages">6</span><img src="../../Images/shim.gif" border="0" width="45" height="1" />ASMNTS
          </td>
        </tr>
      </table>
    </div>
...
<xsl:otherwise>________________________________</xsl:otherwise></xsl:choose>
            ...
            <table class="pageWidth98percent" border="0" cellspacing="0" cellpadding="2">
              ...
              <tr>
                <td colspan="4" style="padding-top: 20px; text-align: center;">
                  <span class="AttendingSignature_Blank blackBoldText"><img src="../../Images/shim.gif" border="0" width="1" height="20" /> Nurse Practitioner: ________________________________________<img src="../../Images/shim.gif" border="0" width="22" height="1" />Date:____/____/____<img src="../../Images/shim.gif" border="0" width="22" height="1" />Time:___:____ <span style="font-size: 9px;">AM / PM </span></span>
                  <span class="AttendingSignature_Signed blackBoldText" style="display: none;"><img src="../../Images/shim.gif" border="0" width="1" height="20" /> Nurse Practitioner: <img class="signedForm_signatureImage" style="height: 90px;vertical-align:middle;"  /><img src="../../Images/shim.gif" border="0" width="22" height="1" />Date: <span class="signedForm_date">____/____/____</span><img src="../../Images/shim.gif" border="0" width="22" height="1" />Time: <span class="signedForm_time">___:____ <span style="font-size: 9px;">AM / PM </span>
                    </span>
                  </span>
                </td>
              </tr>
        ...
        <tr>
          <td height="14" align="center" valign="bottom" class="blackBoldText">
            GU34<img src="../../Images/shim.gif" border="0" width="45" height="1" />U38<img src="../../Images/shim.gif" border="0" width="45" height="1" />CMIC
            Approval Date: 6/05<img src="../../Images/shim.gif" border="0" width="45" height="8" />rev:03/03/15<img src="../../Images/shim.gif" border="0" width="45" height="1" />Page <span id="PageNumber">6</span> of <span id="TotalPages">6</span><img src="../../Images/shim.gif" border="0" width="45" height="1" />ASMNTS
          </td>
        </tr>
      </table>
    </div>
