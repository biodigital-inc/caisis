<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.ProblemsAndPlans_Survivorship" CodeFile="ProblemsAndPlans_Survivorship.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="ProblemsAndPlans_Survivorship" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Problems and Plans"></asp:Label><img src="../../Images/ViewCopyFromPreviousVisit_small.gif" width="176" height="17" hspace="10" class="ClickableImage" style="margin-left: 300px;" title="Click here to view past problems and plans." onclick="showPreviousProblems();" /><br />
...
<table id="targetTable" width="650" border="0" cellspacing="0" cellpadding="0" class="eformLargePopulatedTable" style="background-position: 0 20;">
	    ...
	    <td colspan="2"  style="padding-left: 10px; font-size: 10px;" valign="top" height="190"><strong>Associated Plans</strong> - select up to 5<br />
		  ...
		  <table width="98%" border="0" cellspacing="0" cellpadding="3" style="font-size: 10px;" id="CommonPlansTable">
            ...
            <asp:Repeater ID="CommonPlans" runat="server" > 
				<ItemTemplate> 
					<td style="text-align: left; vertical-align: top;" class="EFormPickerOptions"><input type="checkbox" id="Plan_<%# DataBinder.Eval(Container.DataItem, "LkpCode") %>" value="<%# DataBinder.Eval(Container.DataItem, "LkpCode") %>" /><%# DataBinder.Eval(Container.DataItem, "LkpCode") %></td>
				</ItemTemplate>
  ...
  <tr>
    ...
    <td class="ControlBoxLinedRows" style="padding-top: 6px; vertical-align: top;"><euc:EformCheckbox Runat="server" Value="Bladder Cancer" Text="Bladder Cancer"  TABLE="PatientProblems" FIELD="ProblemName" RecordId="1" ID="ProblemName_1" /></td>
  <td  style="padding-top: 6px; vertical-align: top;" class="ControlBoxLinedRows">
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="Return Visit in 12 Months" Text="Return Visit in 12 Months"  TABLE="ProblemPlans" FIELD="PlanName" ParentRecordId="1" RecordId="1" ID="PlanName_1_1" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="Return Visit in 6 Months" Text="Return Visit in 6 Months"  TABLE="ProblemPlans" FIELD="PlanName" ParentRecordId="1" RecordId="2" ID="PlanName_1_2" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="Urine Cytology" Text="Urine Cytology"  TABLE="ProblemPlans" FIELD="PlanName" ParentRecordId="1" RecordId="3" ID="PlanName_1_3" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="Renal US" Text="Renal US"  TABLE="ProblemPlans" FIELD="PlanName" ParentRecordId="1" RecordId="4" ID="PlanName_1_4" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="CXR" Text="CXR"  TABLE="ProblemPlans" FIELD="PlanName" ParentRecordId="1" RecordId="5" ID="PlanName_1_5" /></span>
  
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="PSA" Text="PSA"  TABLE="ProblemPlans" FIELD="PlanName" ParentRecordId="1" RecordId="6" ID="PlanName_1_6" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="CMP" Text="CMP"  TABLE="ProblemPlans" FIELD="PlanName" ParentRecordId="1" RecordId="7" ID="PlanName_1_7" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="CBC" Text="CBC"  TABLE="ProblemPlans" FIELD="PlanName" ParentRecordId="1" RecordId="8" ID="PlanName_1_8" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="CT Urogram" Text="CT Urogram"  TABLE="ProblemPlans" FIELD="PlanName" ParentRecordId="1" RecordId="9" ID="PlanName_1_9" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="MR Urogram" Text="MR Urogram"  TABLE="ProblemPlans" FIELD="PlanName" ParentRecordId="1" RecordId="10" ID="PlanName_1_10" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="Urine Cytology: Urethral Wash" Text="Urine Cytology: Urethral Wash"  TABLE="ProblemPlans" FIELD="PlanName" ParentRecordId="1" RecordId="11" ID="PlanName_1_11" /></span>

  <span style="display: block; margin-left: 4px; margin-top: 4px; vertical-align: top; font-weight: bold;">Other: <euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" style="width: 227px; height: 30px; vertical-align: top;" Runat="server" RecordId="12" ParentRecordId="1" ID="PlanName_1_12"/></span>
  ...
  <tr>
    ...
    <td class="ControlBoxLinedRows" style="padding-top: 6px; vertical-align: top;"><euc:EformCheckbox Runat="server" Value="Testicular Cancer" Text="Testicular Cancer"  TABLE="PatientProblems" FIELD="ProblemName" RecordId="2" ID="ProblemName_2" /></td>
  <td  style="padding-top: 6px; vertical-align: top;" class="ControlBoxLinedRows">
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="Return Visit in 12 Months" Text="Return Visit in 12 Months"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="2" RecordId="1" ID="PlanName_2_1" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="Return Visit in 6 Months" Text="Return Visit in 6 Months"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="2" RecordId="2" ID="PlanName_2_2" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="CXR" Text="CXR"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="2" RecordId="3" ID="PlanName_2_3" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="AFP, Bhcg, LDH" Text="AFP, Bhcg, LDH"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="2" RecordId="4" ID="PlanName_2_4" /></span>
  <span style="display: block; margin-left: 4px; margin-top: 4px; vertical-align: top; font-weight: bold;">Other: <euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" style="width: 227px; height: 30px; vertical-align: top;" Runat="server" RecordId="5" ParentRecordId="2" ID="PlanName_2_5"/></span>
  ...
  <tr>
    ...
    <td class="ControlBoxLinedRows" style="padding-top: 6px; vertical-align: top;"><euc:EformCheckbox Runat="server" Value="Prostate Cancer" Text="Prostate Cancer"  TABLE="PatientProblems" FIELD="ProblemName" RecordId="3" ID="ProblemName_3" /></td>
  <td  style="padding-top: 6px; vertical-align: top;" class="ControlBoxLinedRows">
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="Return Visit in 12 Months" Text="Return Visit in 12 Months"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="3" RecordId="1" ID="PlanName_3_1" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="Return Visit in 6 Months" Text="Return Visit in 6 Months"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="3" RecordId="2" ID="PlanName_3_2" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="Discharge to PCP for Continued Annual PSA and Exam" Text="Discharge to PCP for Continued Annual PSA and Exam"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="3" RecordId="3" ID="PlanName_3_3" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="Repeat PSA in 12 Months" Text="Repeat PSA in 12 Months"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="3" RecordId="4" ID="PlanName_3_4" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="Repeat PSA in 6 Months" Text="Repeat PSA in 6 Months"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="3" RecordId="5" ID="PlanName_3_5" /></span>
  <span style="display: block; margin-left: 4px; margin-top: 4px; vertical-align: top; font-weight: bold;">Other: <euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" style="width: 227px; height: 30px; vertical-align: top;" Runat="server" RecordId="6" ParentRecordId="3" ID="PlanName_3_6"/></span>
  </td>
  </tr>
  
  <tr>
    <td height="80" align="center" valign="top" style="border-bottom: solid 1px #cccccc; padding-top: 6px;"><strong>4</strong></td>
    <td class="ControlBoxLinedRows" style="padding-top: 6px; vertical-align: top;"><euc:EformCheckbox Runat="server" Value="Renal Cancer" Text="Renal Cancer"  TABLE="PatientProblems" FIELD="ProblemName" RecordId="4" ID="ProblemName_4" /></td>
  <td  style="padding-top: 6px; vertical-align: top;" class="ControlBoxLinedRows">
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="Return Visit in 12 Months" Text="Return Visit in 12 Months"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="4" RecordId="1" ID="PlanName_4_1" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="Return Visit in 6 Months" Text="Return Visit in 6 Months"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="4" RecordId="2" ID="PlanName_4_2" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="Renal US" Text="Renal US"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="4" RecordId="3" ID="PlanName_4_3" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="CXR" Text="CXR"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="4" RecordId="4" ID="PlanName_4_4" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="MRI Renal Protocol" Text="MRI Renal Protocol"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="4" RecordId="5" ID="PlanName_4_5" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="CT Abdomen/Pelvis" Text="CT Abdomen/Pelvis"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="4" RecordId="6" ID="PlanName_4_6" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="UA" Text="UA"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="4" RecordId="7" ID="PlanName_4_7" /></span>
  <span style="display: block;"><euc:EformCheckbox Runat="server" Value="BMP" Text="BMP"  TABLE="ProblemPlans" FIELD="PlanName"  ParentRecordId="4" RecordId="8" ID="PlanName_4_8" /></span>
  <span style="display: block; margin-left: 4px; margin-top: 4px; vertical-align: top; font-weight: bold;">Other: <euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" style="width: 227px; height: 30px; vertical-align: top;" Runat="server" RecordId="9" ParentRecordId="4" ID="PlanName_4_9"/></span>
  ...
  <tr>
    ...
    <td valign="top" class="ControlBoxLinedRows" style="padding-top: 6px;"><euc:EformCheckbox Runat="server" Value="Renal Mass" Text="Renal Mass"  TABLE="PatientProblems" FIELD="ProblemName" RecordId="5" ID="ProblemName_5" />
  ...
  <tr>
    ...
    <td valign="top" class="ControlBoxLinedRows" style="padding-top: 6px;"><euc:EformCheckbox Runat="server" Value="Active Surveillance" Text="Active Surveillance"  TABLE="PatientProblems" FIELD="ProblemName" RecordId="6" ID="ProblemName_6" />
  ...
  <tr>
    <td height="80" align="center" valign="top" style="border-bottom: solid 1px #cccccc; padding-top: 6px;"><strong>7</strong></td>
    <td valign="top" class="ControlBoxLinedRows" style="padding-top: 6px;"><img src="../../Images/OpenPicker_red.gif" width="14" height="20" hspace="1" align="right" class="ClickableImage"  style="margin-right: 6px;" onclick="showCommonProblems(7, this);" /><euc:EformTextArea TextMode="MultiLine" TABLE="PatientProblems" FIELD="ProblemName" Rows="2" style="width: 267px;" Runat="server"  RecordId="7" ID="ProblemName_7"/>	
    ...
    <td valign="top" class="ControlBoxLinedRows">
		...
		<tr><td><euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" Rows="2" style="width: 277px;" Runat="server" RecordId="1" ParentRecordId="7" ID="PlanName_7_1"/></td></tr>
		<tr style="display: none;"><td><euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" Rows="2" style="width: 277px;" Runat="server" RecordId="2" ParentRecordId="7" ID="PlanName_7_2"/></td></tr>
		<tr style="display: none;"><td><euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" Rows="2" style="width: 277px;" Runat="server" RecordId="3" ParentRecordId="7" ID="PlanName_7_3"/></td></tr>
		<tr style="display: none;"><td><euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" Rows="2" style="width: 277px;" Runat="server" RecordId="4" ParentRecordId="7" ID="PlanName_7_4"/></td></tr>
		<tr style="display: none;"><td><euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" Rows="2" style="width: 277px;" Runat="server" RecordId="5" ParentRecordId="7" ID="PlanName_7_5"/></td></tr>
		</table>	</td>
  </tr>
  <tr>
    <td height="80" align="center" valign="top" style="border-bottom: solid 1px #cccccc; padding-top: 6px;"><strong>8</strong></td>
    <td valign="top" class="ControlBoxLinedRows" style="padding-top: 6px;"><img src="../../Images/OpenPicker_red.gif" width="14" height="20" hspace="1" align="right" class="ClickableImage"  style="margin-right: 6px;" onclick="showCommonProblems(8, this);" /><euc:EformTextArea TextMode="MultiLine" TABLE="PatientProblems" FIELD="ProblemName" Rows="2" style="width: 267px;" Runat="server"  RecordId="8" ID="ProblemName_8"/>	
    ...
    <td valign="top" class="ControlBoxLinedRows">
		...
		<tr><td><euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" Rows="2" style="width: 277px;" Runat="server" RecordId="1" ParentRecordId="8" ID="PlanName_8_1"/></td></tr>
		<tr style="display: none;"><td><euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" Rows="2" style="width: 277px;" Runat="server" RecordId="2" ParentRecordId="8" ID="PlanName_8_2"/></td></tr>
		<tr style="display: none;"><td><euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" Rows="2" style="width: 277px;" Runat="server" RecordId="3" ParentRecordId="8" ID="PlanName_8_3"/></td></tr>
		<tr style="display: none;"><td><euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" Rows="2" style="width: 277px;" Runat="server" RecordId="4" ParentRecordId="8" ID="PlanName_8_4"/></td></tr>
		<tr style="display: none;"><td><euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" Rows="2" style="width: 277px;" Runat="server" RecordId="5" ParentRecordId="8" ID="PlanName_8_5"/></td></tr>
		</table>	</td>
  </tr>
  <tr>
    <td height="80" align="center" valign="top" style="border-bottom: solid 1px #cccccc; padding-top: 6px;"><strong>9</strong></td>
    <td valign="top" class="ControlBoxLinedRows" style="padding-top: 6px;"><img src="../../Images/OpenPicker_red.gif" width="14" height="20" hspace="1" align="right" class="ClickableImage"  style="margin-right: 6px;" onclick="showCommonProblems(9, this);" /><euc:EformTextArea TextMode="MultiLine" TABLE="PatientProblems" FIELD="ProblemName" Rows="2" style="width: 267px;" Runat="server"  RecordId="9" ID="ProblemName_9"/>	
    ...
    <td valign="top" class="ControlBoxLinedRows">
		...
		<tr><td><euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" Rows="2" style="width: 277px;" Runat="server" RecordId="1" ParentRecordId="9" ID="PlanName_9_1"/></td></tr>
		<tr style="display: none;"><td><euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" Rows="2" style="width: 277px;" Runat="server" RecordId="2" ParentRecordId="9" ID="PlanName_9_2"/></td></tr>
		<tr style="display: none;"><td><euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" Rows="2" style="width: 277px;" Runat="server" RecordId="3" ParentRecordId="9" ID="PlanName_9_3"/></td></tr>
		<tr style="display: none;"><td><euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" Rows="2" style="width: 277px;" Runat="server" RecordId="4" ParentRecordId="9" ID="PlanName_9_4"/></td></tr>
		<tr style="display: none;"><td><euc:EformTextArea TextMode="MultiLine" TABLE="ProblemPlans" FIELD="PlanName" Rows="2" style="width: 277px;" Runat="server" RecordId="5" ParentRecordId="9" ID="PlanName_9_5"/></td></tr>
		</table>	</td>
  </tr>
<%-- 
  <tr>
