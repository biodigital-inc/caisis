<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Prostate.Eforms.PSAAndOtherLabs" CodeFile="PSAAndOtherLabs.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="PSAAndOtherLabs" />
<table width="650" cellpadding="0" cellspacing="0">
<tr>
<td valign="top">
<a name="PSAsAnchor" /><span class="controlBoxTitle">PSAs</span><br>
<table width="250" cellpadding="3" cellspacing="0" class="ClinicalEformTable" id="PSALabTestsHtmlTable">
  <tr> 
...
<td width="50">&nbsp;</td>
<td valign="top">
<span class="controlBoxTitle">Other Lab Tests</span><br>
