namespace Caisis.UI.Modules.Prostate.Eforms
{
	...
	/// <summary>
    ///		Summary description for PCCTCMedications.
	/// </summary>
    public partial class PCCTCMedications : BaseEFormControl
	{

        protected bool PriorMedicationsExist = false;
...
//           BuildAllMedications(this._patientId, this._eformName, "Dynamic");
        ...
        protected virtual void BuildAdditionalGUMedicationSection(int PatientID, string FormName, string FormType)
        {
            ...
            if (medDv.Count > 0) PriorMedicationsExist = true;
