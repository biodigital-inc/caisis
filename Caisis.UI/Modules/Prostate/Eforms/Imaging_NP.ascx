<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Prostate.Eforms.Imaging_NP" CodeFile="Imaging_NP.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>

<!-- example table array populator -->
<script type="text/javascript">
	tableArray.ImagingNPHtmlTable = "ImagingNPHtmlTable";
</script>

<style type="text/css">
table#MRIDetailsTable
{
}
</style>

<a name="Imaging_NP" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Imaging" style="margin-right: 40px;"></asp:Label>
...
<br/>
<table width="675" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="ImagingNPHtmlTable">
  <tr> 
  ...
  <tr style="DISPLAY: none">
    ...
    <td style="white-space: nowrap;">
		<euc:EformComboBox DropDownWidth="auto"  RecordId="11" LookupCode="DxType" TABLE="Diagnostics" FIELD="DxType" Runat="server" ID="DxType_11"/>
	</td>
    <td align="left" style="white-space: nowrap;">
		<euc:EformComboBox DropDownWidth="auto"   LookupCode="DxResult" style="width:140;" Field="DxResult" RecordId="11" Table="Diagnostics" Runat="server" id="DxResult_11"  />
	</td>
    <td align="center">
    ...
    <td style="white-space: nowrap;">
		<euc:EformComboBox DropDownWidth="auto"  RecordId="12" LookupCode="DxType" TABLE="Diagnostics" FIELD="DxType" Runat="server" ID="DxType_12"/>
	</td>
    <td align="left" style="white-space: nowrap;">
		<euc:EformComboBox DropDownWidth="auto"   LookupCode="DxResult" style="width:140;" Field="DxResult" RecordId="12" Table="Diagnostics" Runat="server" id="DxResult_12"  />
	</td>
    <td align="center">
  ...
  <tr style="DISPLAY: none">
    ...
    <td style="white-space: nowrap;">
		<euc:EformComboBox DropDownWidth="auto"  RecordId="13" LookupCode="DxType" TABLE="Diagnostics" FIELD="DxType" Runat="server" ID="DxType_13"/>
	</td>
    <td align="left" style="white-space: nowrap;">
		<euc:EformComboBox DropDownWidth="auto"   LookupCode="DxResult" style="width:140;" Field="DxResult" RecordId="13" Table="Diagnostics" Runat="server" id="DxResult_13"  />
	</td>
    <td align="center">
		<euc:EformTextBox RecordId="13" ShowCalendar="False" CalcDate="False" style="width:160px;" TABLE="Diagnostics" FIELD="DxNotes" Runat="server" ID="DxNotes_13"/>
	</td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
  <tr style="DISPLAY: none">
    ...
    <td style="white-space: nowrap;">
		<euc:EformComboBox DropDownWidth="auto"  RecordId="14" LookupCode="DxType" TABLE="Diagnostics" FIELD="DxType" Runat="server" ID="DxType_14"/>
	</td>
    <td align="left" style="white-space: nowrap;">
		<euc:EformComboBox DropDownWidth="auto"   LookupCode="DxResult" style="width:140;" Field="DxResult" RecordId="14" Table="Diagnostics" Runat="server" id="DxResult_14"  />
	</td>
    <td align="center">
		<euc:EformTextBox RecordId="14" ShowCalendar="False" CalcDate="False" style="width:160px;" TABLE="Diagnostics" FIELD="DxNotes" Runat="server" ID="DxNotes_14"/>
	</td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
    <tr style="DISPLAY: none">
    ...
    <td style="white-space: nowrap;">
		<euc:EformComboBox DropDownWidth="auto"  RecordId="15" LookupCode="DxType" TABLE="Diagnostics" FIELD="DxType" Runat="server" ID="DxType_15"/>
	</td>
    <td align="left" style="white-space: nowrap;">
		<euc:EformComboBox DropDownWidth="auto"   LookupCode="DxResult" style="width:140;" Field="DxResult" RecordId="15" Table="Diagnostics" Runat="server" id="DxResult_15"  />
	</td>
    <td align="center">
		<euc:EformTextBox RecordId="15" ShowCalendar="False" CalcDate="False" style="width:160px;" TABLE="Diagnostics" FIELD="DxNotes" Runat="server" ID="DxNotes_15"/>
	</td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr> --%>
</table>
<img src="../../Images/EFormAddARow.gif" hspace="0" width="117" height="16" border="0" class="ClickableImage" align="left"  onclick="return showFirstAdditionalRow(this,'ImagingNPHtmlTable');" />

<br/><br/>
<span style="font-weight: bold;">Additional Comments on Imaging</span>
<span style="display: block; margin-bottom: 60px; clear: both;">
<euc:EformTextArea TextMode="MultiLine" Table="NoTable" Field="Imaging_AdditionalComments" Rows="4" style="width: 600px;" Id="Imaging_AdditionalComments" Runat="server"></euc:EformTextArea>
</span>
<script type="text/javascript">
showHideBasedOnCheckboxToggle($('MRIToggleContainer'), $('MRIDetailsTable'));
</script>