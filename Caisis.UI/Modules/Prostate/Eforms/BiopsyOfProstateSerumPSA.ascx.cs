namespace Caisis.UI.Modules.Prostate.Eforms
{
    ...
    /// </summary>
    public partial class BiopsyOfProstateSerumPSA : BaseEFormControl
    {

        protected double lastPSA = 0;
        protected string lastPSADate = "";
        ...
        private void BuildRepeater(Repeater r, DataSet ds, string filter)
        {
            ...
            if (dv.Count > 0)
            {
                ...
                if (double.TryParse(dv[dv.Count-1][BOL.LabTest.LabResult].ToString(), out lastPSA))
                {
                    lastPSADate = dv[dv.Count - 1][BOL.LabTest.LabDateText].ToString();
                }
