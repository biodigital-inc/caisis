<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.ProblemsAndPlans" CodeFile="ProblemsAndPlans.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="ProblemsAndPlans" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Problems and Plans"></asp:Label><img src="../../Images/ViewCopyFromPreviousVisit_small.gif" width="176" height="17" hspace="10" class="ClickableImage" style="margin-left: 300px;" title="Click here to view past problems and plans." onclick="showPreviousProblems();" /><br />
