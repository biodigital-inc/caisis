<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Prostate.Eforms.Exam_NP" CodeFile="Exam_NP.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<table width="700" border="0" cellspacing="0" cellpadding="1" style="border: solid 1px #cccccc; border-collapse: collapse;" id="ExamsHtmlTable">
  ...
  <tr class="Exam_DefaultDataEntryRow">
    ...
    <td class="ControlBoxLinedRows" align="center">
		<euc:EformTextBox RecordId="26" ShowCalendar="False" CalcDate="False" style="width:200px;" TABLE="EncExams" FIELD="ExamNotes" ShowTextEditor="true" Runat="server" ID="ExamNotes_26"/>
  ...
  <tr class="Exam_DefaultDataEntryRow">
    ...
    <td class="ControlBoxLinedRows" align="center">
	<euc:EformTextBox RecordId="27" ShowCalendar="False" CalcDate="False" style="width:200px;" TABLE="EncExams" FIELD="ExamNotes" ShowTextEditor="true" Runat="server" ID="ExamNotes_27"/>
	
	</td>
    <td class="ControlBoxLinedRows" align="center"><euc:EformDeleteIcon runat="server" ID="ExamDeleteIcon_27"/></td>
  </tr>
  <tr class="Exam_DefaultDataEntryRow">
    <td valign="top" class="ControlBoxLinedRowsShaded"><euc:EformDefaultLabel ID="Exam_System_28" runat="server" DefaultField="EncExams.ExamSystem,28" /></td>
  ...
  <tr class="Exam_DefaultDataEntryRow">
    <td valign="top" class="ControlBoxLinedRowsShaded"><euc:EformDefaultLabel ID="Exam_System_29" runat="server" DefaultField="EncExams.ExamSystem,29" /></td>
  ...
  <tr class="Exam_DefaultDataEntryRow">
    <td valign="top" class="ControlBoxLinedRowsShaded"><euc:EformDefaultLabel ID="Exam_System_30" runat="server" DefaultField="EncExams.ExamSystem,30" /></td>
  ...
  <tr class="Exam_DefaultDataEntryRow">
    <td valign="top" class="ControlBoxLinedRowsShaded"><euc:EformDefaultLabel ID="Exam_System_31" runat="server" DefaultField="EncExams.ExamSystem,31" /></td>
  ...
  <tr class="Exam_DefaultDataEntryRow">
    <td valign="top" class="ControlBoxLinedRowsShaded"><euc:EformDefaultLabel ID="Exam_System_32" runat="server" DefaultField="EncExams.ExamSystem,32" /></td>
  ...
  <tr class="Exam_DefaultDataEntryRow">
    <td valign="top" class="ControlBoxLinedRowsShaded"><euc:EformDefaultLabel ID="Exam_System_33" runat="server" DefaultField="EncExams.ExamSystem,33" /></td>
  ...
  <tr class="Exam_DefaultDataEntryRow">
    <td valign="top" class="ControlBoxLinedRowsShaded"><euc:EformDefaultLabel ID="Exam_System_34" runat="server" DefaultField="EncExams.ExamSystem,34" /></td>
  ...
  <tr>
    <td class="ControlBoxLinedRowsShaded"><euc:EformSelect RecordId="35" LookupCode="BodySystem" TABLE="EncExams" FIELD="ExamSystem" Runat="server" ID="ExamSystem_35" style="width: 35px;"/></td>
    <td class="ControlBoxLinedRowsShaded" style="border-right: none;"><euc:EformSelect RecordId="35" LookupCode="Exam" TABLE="EncExams" FIELD="Exam" Runat="server" ID="Exam_35" style="width: 102px;"/></td>
	<euc:EformRadioButtonGroup Table="EncExams" Field="ExamResult" id="ExamResult_35" RecordId="35" GroupName="ExamResultGroup_35" runat="server">
		<td class="ControlBoxLinedRowsShaded" align="center"><span><span><euc:EformRadioButton Id="ExamResultNormal_35" Value="Normal" runat="server"/></span></span></td>
		<td class="ControlBoxLinedRows" align="center"><span><span><euc:EformRadioButton Id="ExamResultAbnormal_35" Value="Abnormal" runat="server"/></span></span></td>
		<td class="ControlBoxLinedRows" align="center"><span><span><euc:EformRadioButton Id="ExamResultNotDone_35" Value="Not Done" runat="server"/></span></span></td>
	</euc:EformRadioButtonGroup>
  ...
  <tr>
    <td class="ControlBoxLinedRowsShaded"><euc:EformSelect RecordId="36" LookupCode="BodySystem" TABLE="EncExams" FIELD="ExamSystem" Runat="server" ID="ExamSystem_36" style="width: 35px;"/></td>
    <td class="ControlBoxLinedRowsShaded" style="border-right: none;"><euc:EformSelect RecordId="36" LookupCode="Exam" TABLE="EncExams" FIELD="Exam" Runat="server" ID="Exam_36" style="width: 102px;"/></td>
	<euc:EformRadioButtonGroup Table="EncExams" Field="ExamResult" id="ExamResult_36" RecordId="36" GroupName="ExamResultGroup_36" runat="server">
		<td class="ControlBoxLinedRowsShaded" align="center"><span><span><euc:EformRadioButton Id="ExamResultNormal_36" Value="Normal" runat="server"/></span></span></td>
		<td class="ControlBoxLinedRows" align="center"><span><span><euc:EformRadioButton Id="ExamResultAbnormal_36" Value="Abnormal" runat="server"/></span></span></td>
		<td class="ControlBoxLinedRows" align="center"><span><span><euc:EformRadioButton Id="ExamResultNotDone_36" Value="Not Done" runat="server"/></span></span></td>
	</euc:EformRadioButtonGroup>
  ...
  <tr>
    <td class="ControlBoxLinedRowsShaded"><euc:EformSelect RecordId="37" LookupCode="BodySystem" TABLE="EncExams" FIELD="ExamSystem" Runat="server" ID="ExamSystem_37" style="width: 35px;"/></td>
    <td class="ControlBoxLinedRowsShaded" style="border-right: none;"><euc:EformSelect RecordId="37" LookupCode="Exam" TABLE="EncExams" FIELD="Exam" Runat="server" ID="Exam_37" style="width: 102px;"/></td>
	<euc:EformRadioButtonGroup Table="EncExams" Field="ExamResult" id="ExamResult_37" RecordId="37" GroupName="ExamResultGroup_37" runat="server">
		<td class="ControlBoxLinedRowsShaded" align="center"><span><span><euc:EformRadioButton Id="ExamResultNormal_37" Value="Normal" runat="server"/></span></span></td>
		<td class="ControlBoxLinedRows" align="center"><span><span><euc:EformRadioButton Id="ExamResultAbnormal_37" Value="Abnormal" runat="server"/></span></span></td>
		<td class="ControlBoxLinedRows" align="center"><span><span><euc:EformRadioButton Id="ExamResultNotDone_37" Value="Not Done" runat="server"/></span></span></td>
	</euc:EformRadioButtonGroup>
  ...
  <tr>
    <td class="ControlBoxLinedRowsShaded"><euc:EformSelect RecordId="38" LookupCode="BodySystem" TABLE="EncExams" FIELD="ExamSystem" Runat="server" ID="ExamSystem_38" style="width: 35px;"/></td>
    <td class="ControlBoxLinedRowsShaded" style="border-right: none;"><euc:EformSelect RecordId="38" LookupCode="Exam" TABLE="EncExams" FIELD="Exam" Runat="server" ID="Exam_38" style="width: 102px;"/></td>
	<euc:EformRadioButtonGroup Table="EncExams" Field="ExamResult" id="ExamResult_38" RecordId="38" GroupName="ExamResultGroup_38" runat="server">
		<td class="ControlBoxLinedRowsShaded" align="center"><span><span><euc:EformRadioButton Id="ExamResultNormal_38" Value="Normal" runat="server"/></span></span></td>
		<td class="ControlBoxLinedRows" align="center"><span><span><euc:EformRadioButton Id="ExamResultAbnormal_38" Value="Abnormal" runat="server"/></span></span></td>
		<td class="ControlBoxLinedRows" align="center"><span><span><euc:EformRadioButton Id="ExamResultNotDone_38" Value="Not Done" runat="server"/></span></span></td>
	</euc:EformRadioButtonGroup>
  ...
  <tr>
    <td class="ControlBoxLinedRowsShaded"><euc:EformSelect RecordId="39" LookupCode="BodySystem" TABLE="EncExams" FIELD="ExamSystem" Runat="server" ID="ExamSystem_39" style="width: 35px;"/></td>
    <td class="ControlBoxLinedRowsShaded" style="border-right: none;"><euc:EformSelect RecordId="39" LookupCode="Exam" TABLE="EncExams" FIELD="Exam" Runat="server" ID="Exam_39" style="width: 102px;"/></td>
  ...
  <tr>
    <td class="ControlBoxLinedRowsShaded"><euc:EformSelect RecordId="40" LookupCode="BodySystem" TABLE="EncExams" FIELD="ExamSystem" Runat="server" ID="ExamSystem_40" style="width: 35px;"/></td>
    <td class="ControlBoxLinedRowsShaded" style="border-right: none;"><euc:EformSelect RecordId="40" LookupCode="Exam" TABLE="EncExams" FIELD="Exam" Runat="server" ID="Exam_40" style="width: 102px;"/></td>
