<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Prostate.PaperForms.UroProsNP_Regional" CodeFile="UroProsNP_Regional.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BasePaperFormControl" %>
  ...
  <td style="text-align:center;"><font size="-1">CONTAINS PROTECTED HEALTH INFORMATION - HANDLE ACCORDING TO <%= institutionShortName%> POLICY</font></td>
    ...
    <tr> 
	  <td class="FormOuterTableRow">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr> 
				<td width="28%" rowspan="2" valign="top" class="FormInsideTableTopLeftCell"><span class="blackBoldText"><img src="../../Images/shim.gif" border="0" width="4" height="12">Nomogram 
				  Predictions </span></td>
				<td width="9%" align="right" class="FormInsideTableTopCell">PreRP 5:</td>
				<td width="9%" class="FormInsideTableTopCell">&nbsp;<asp:Label ID="preRP5Nomo" Runat="server" /></td>
				<td width="9%" align="right" class="FormInsideTableTopCell">PreRP 10:</td>
				<td width="9%" class="FormInsideTableTopCell">&nbsp;<asp:Label ID="preRP10Nomo" Runat="server" /></td>
				<td width="9%" align="right" class="FormInsideTableTopCell">PreXRT:</td>
				<td width="9%" class="FormInsideTableTopCell">&nbsp;<asp:Label ID="preXRTNomo" Runat="server" /></td>
				<td width="9%" align="right" class="FormInsideTableTopCell">PreBrachy:</td>
				<td width="9%" class="FormInsideTableTopCell">&nbsp;<asp:Label ID="preBrachyNomo" Runat="server" /></td>
    ...
    <tr> 
      <td height="14" align="center" valign="bottom" class="blackBoldText">GU01<img src="../../Images/shim.gif" border="0" width="45" height="1">U05<img src="../../Images/shim.gif" border="0" width="45" height="1">CMIC 
        Approval Date: 6/03<img src="../../Images/shim.gif" border="0" width="45" height="8">rev:09/01/10<img src="../../Images/shim.gif" border="0" width="45" height="1">Page 
  ...
  <td style="text-align:center;"><font size="-1">CONTAINS PROTECTED HEALTH INFORMATION - HANDLE ACCORDING TO <%= institutionShortName%> POLICY</font></td>
    ...
    <tr>
      <td class="FormOuterTableRow"><table class="pageWidth" cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td rowspan="2" width="50%" valign="top"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td class="blackBoldText">Medications</td>
                  <td colspan="2" align="right">&nbsp;</td>
                </tr>
                <tr align="center">
                  <td width="50%" class="FormInsideTableTopCell">Agent</td>
                  <td width="24%" class="FormInsideTableTopCell">Dose</td>
                  <td width="26%" class="FormInsideTableTopCell">Schedule</td>
                </tr>
          ...
          <tr>
            <td ><table align="center" border="0" width="100%" cellpadding="0" cellspacing="0">
                <tr>
    ...
    <tr> 
      <td class="FormOuterTableRow"> <span class="blackBoldText"><img src="../../Images/shim.gif" border="0" width="4" height="0">Diagnostic 
        ...
        Done at MSK</span><br/> <table align="center" border="0" width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr> 
            <td colspan="6"><table align="center" border="0" class="pageWidth" cellpadding="0" cellspacing="0">
              <tr>
                <td width="5%" align="center" class="FormInsideTableTopCell">Side</td>
                <td width="5%" align="center" class="FormInsideTableTopCell">Laterality</td>
                <td width="5%" align="center" class="FormInsideTableTopCell">Level</td>
                <td width="6%" align="center" class="FormInsideTableTopCell">#Cores</td>
                <td width="5%" align="center" class="FormInsideTableTopCell">GG1</td>
                <td width="5%" align="center" class="FormInsideTableTopCell">GG2</td>
                <td width="5%" align="center" class="FormInsideTableTopCell">GGS</td>
                <td width="5%" align="center" class="FormInsideTableTopCell">%Ca</td>
                <td width="5%" align="center" class="FormInsideTableTopCell">mmCa</td>
                <td width="5%" align="center" class="FormInsideTableTopCell">mmCore</td>
                <td width="5%" align="center" class="FormInsideTableTopCell">PNI</td>
                <td width="5%" align="center" class="FormInsideTableTopCell">PIN</td>
                <td width="5%" align="center" class="FormInsideTableTopCell">ASAP</td>
                <td width="7%" align="center" class="FormInsideTableTopCell">HG PIN </td>
                <td width="36%" align="center" class="FormInsideTableTopCell">Biopsy Notes</td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="24" align="center" class="FormInsideTableRegCell">Left</td>
                <td align="center" class="FormInsideTableRegCell">Lateral</td>
                <td align="center" class="FormInsideTableRegCell">A</td>
                <td class="FormInsideTableRegCell">&nbsp;</td>
                <td class="FormInsideTableRegCell">&nbsp;</td>
...
<br/>                <img src="../../Images/shim.gif" border="0" width="1" height="15">Total Sexual QOL Score (Q5+Q6): 
    ...
    <tr> 
      <td height="35" class="FormOuterTableRow">&nbsp; <input name="HistoryROSReview" type="checkbox" id="HistoryROSReview" value="Yes"> 
        <span class="blackBoldText"> PFSH and ROS performed by: _____________________________________&nbsp;&nbsp;&nbsp;&nbsp;Date: ____/____/____ </span></td>
    </tr>
    <tr>
      <td height="14" align="center" valign="bottom" class="blackBoldText">GU01<img src="../../Images/shim.gif" border="0" width="45" height="1">U05<img src="../../Images/shim.gif" border="0" width="45" height="1">CMIC 
        Approval Date: 6/03<img src="../../Images/shim.gif" border="0" width="45" height="8">rev:09/01/10<img src="../../Images/shim.gif" border="0" width="45" height="1">Page 
        <span id="PageNumber">4</span> of <span id="TotalPages">6</span><img src="../../Images/shim.gif" border="0" width="45" height="1">B/02.070.<span class="blackBoldTextSmall">01</span></td>
    </tr>
  </table>
</div>
<div align="left" style="page-break-after:always">
...
<table align="center" border="0" width="100%" cellpadding="0" cellspacing="0">
          ...
          <tr> 
            ...
            <td align="center" class="FormInsideTableRegCell"><img src="../../Images/FormImages/WinCheckbox.gif" width="13" height="13"></td>
            <td align="center" class="FormInsideTableRegCell"><img src="../../Images/FormImages/WinCheckbox.gif" width="13" height="13"></td>
            <td rowspan="4" align="left" valign="top" class="FormInnerRowBottomBorder">&nbsp;</td>
          </tr>
          <tr> 
            ...
            <td colspan="5" align="left" class="FormInnerRowBottomBorder"><span class="blackBoldText">Rectal Exam</span><br/>
			  <table width="100%" border="0" cellspacing="0" cellpadding="4">
                <tr valign="top"> 
                  ...
                  <td><span class="blackBoldText"><img src="../../Images/shim.gif" border="0" width="30" height="1">2002 Clinical T Stage: __________</span><br/><img src="../../Images/ProstateImageURONVWeb.gif" width="251" height="125"></td>
                </tr>
                <tr valign="top"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td height="14" align="center" valign="bottom" class="blackBoldText">GU01<img src="../../Images/shim.gif" border="0" width="45" height="1">U05<img src="../../Images/shim.gif" border="0" width="45" height="1">CMIC 
        Approval Date: 6/03<img src="../../Images/shim.gif" border="0" width="45" height="8">rev:09/01/10<img src="../../Images/shim.gif" border="0" width="45" height="1">Page 
        <span id="PageNumber">5</span> of <span id="TotalPages">6</span><img src="../../Images/shim.gif" border="0" width="45" height="1">B/02.070.<span class="blackBoldTextSmall">01</span></td>
    </tr>
  </table>
</div>
  ...
  <td style="text-align:center;"><font size="-1">CONTAINS PROTECTED HEALTH INFORMATION - HANDLE ACCORDING TO <%= institutionShortName%> POLICY</font></td>
    ...
    <tr> 
      <td class="FormOuterTableRow">
          ...
          <tr> 
            <td height="80" valign="top" class="FormInsideTableRegCell">1.</td>
            <td class="FormInnerRowBottomBorder">&nbsp;</td>
          </tr>
          <tr> 
            <td height="80" valign="top" class="FormInsideTableRegCell">2.</td>
            <td class="FormInnerRowBottomBorder">&nbsp;</td>
          </tr>
          <tr> 
            <td height="80" valign="top" class="FormInsideTableRegCell">3.</td>
            <td class="FormInnerRowBottomBorder">&nbsp;</td>
          </tr>
          <tr> 
            <td height="80" valign="top" class="FormInsideTableRegCell">4.</td>
            <td class="FormInnerRowBottomBorder">&nbsp;</td>
          </tr>
          <tr> 
            <td height="80" valign="top" class="FormInnerRowRightBorder">5.</td>
            <td>&nbsp;</td>
          </tr>
        </table>
		</td>
			...
			<table width="100%" cellpadding="4" cellspacing="0" class="FormInnerTableBlackTopRow">
                <tr> 
                  <td>I personally performed or was physically present during the <strong>key portions</strong> of the visit today.  I agree with the history, physical exam, and assessment/plan as documented by the <strong>fellow</strong> above.<br/>
                    <img src="../../Images/shim.gif" border="0" width="1" height="20"><span class="blackBoldText">Attending MD: ________________________________________________ </span></td>
				</tr>
				<tr>
    ...
    <tr>
      <td height="14" align="center" valign="bottom" bgcolor="#FFFFFF" class="blackBoldText">GU01<img src="../../Images/shim.gif" border="0" width="45" height="1">U05<img src="../../Images/shim.gif" border="0" width="45" height="1">CMIC 
        Approval Date: 6/03<img src="../../Images/shim.gif" border="0" width="45" height="8">rev:09/01/10<img src="../../Images/shim.gif" border="0" width="45" height="1">Page 
        <span id="PageNumber">6</span> of <span id="TotalPages">6</span><img src="../../Images/shim.gif" border="0" width="45" height="8">B/02.070.<span class="blackBoldTextSmall">01</span></td>
    </tr>
  </table>
</div>
