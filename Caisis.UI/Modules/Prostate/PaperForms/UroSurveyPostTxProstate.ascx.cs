namespace Caisis.UI.Modules.Prostate.PaperForms
{
	...
	/// </summary>
    public partial class UroSurveyPostTxProstate : BasePaperFormControl
	{
		...
		{
            this._formName = "UroSurveyPostTxProstate";
			this._formTitle = "Urology Prostate Post-Treatment Questionnaire";
