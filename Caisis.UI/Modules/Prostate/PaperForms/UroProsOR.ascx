<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Prostate.PaperForms.UroProsOR" CodeFile="UroProsOR.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BasePaperFormControl" %>
  ...
  <td style="text-align:center;"><font size="-1">CONTAINS PROTECTED HEALTH INFORMATION - HANDLE ACCORDING TO <%= institutionShortName%> POLICY</font></td>
    ...
    <tr> 
      <td class="FormOuterTableTopRow"><table align="center" border="0" width="100%" cellpadding="0" cellspacing="0">
          <tr> 
            <td width="50%" align="center" valign="middle" class="FormInnerRowRightBorder"><span class="blackBoldText"><img src="../../Images/FormImages/<%= institutionShortName%>_FormLogo.gif" width="90" alt="" border="0" align="left"><%= institutionName%><br/>Urology Prostatectomy Details<br/></span></td>
    ...
    <tr> 
      <td valign="top"> <table  class="pageWidth" border="0" cellspacing="0" cellpadding="0" style="background-color: #ffffff;">
          <tr valign="top"> 
            <td style="background-color: #ffffff;"><img src="../../Images/FormImages/ProstateOR_PG1_20080502_NH.gif" class="pageWidth" border="0" /></td>
          </tr>
        </table></td>
    </tr>
  </table>
