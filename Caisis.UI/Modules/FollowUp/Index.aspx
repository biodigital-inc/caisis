<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Index.aspx.cs" Inherits="Caisis.UI.Modules.FollowUp.Modules_FollowUp_Index" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head> 
	<title>Caisis: Follow Up Management</title>
	...
	<script type="text/javascript">
	    ...
	    {	
		    $('SearchTarget').value = '/FollowUp/ViewPatientSurveySummary.aspx?usePtInSession=true';
        ...
        <tr>
			<td class="MenuContainter" nowrap align="center" width="100%" >
			    <ul id="menu" style="text-align: center; padding-left: 180px;">  
                     ...
                     <%-- <li style="width: 150px;"><a href="FollowUpSplash.aspx"  target="MainWindow">Surveys</a>
                        <ul style="width: 150px;">
                            <li>
                                <a target="MainWindow" href="BatchPrintSurveys.aspx">Batch Print Surveys</a>
                                <a target="MainWindow" href="ViewPatientSurveySummary.aspx">Enter Survey Data</a>
                            </li>
                        </ul>
                    </li>
                  <li style="width: 150px;"><a href="FollowUpSplash.aspx"  target="MainWindow">Reports</a>
                        <ul style="width: 150px;">
                            <li>
                                <a target="MainWindow" href="../../Core/DataAnalysis/Reports/ReportsContainer.aspx?report=SurveyReport">Follow Up Report</a>
                            </li>
                        </ul>
                    </li>--%>
			    </ul>
				...
				<table id="contentTable" cellspacing="0" cellpadding="0" width="100%" border="0" >
					<tr>
						<td style="vertical-align: top;" align="center">
							<iframe runat="server" id="MainWindow" style="width: 95%; height: 800px; overflow:hidden;padding-top:10px;" scrolling="auto" name="MainWindow" src="FollowUpSplash.aspx" frameborder="0">
							</iframe>
						</td>
					</tr>
				</table>
	            ...
	            <tr>
	                <td align="center" >
	                    <table cellpadding="0" cellspacing="0" border="0" width="400">
	                        <tr>
		                        <td colspan="6"><img id="PanelTop" name="PanelTop" src="Images/PatientSurveyDataFormTop.gif" height="37" width="400" border="0" /><br></td>
	                        </tr>
	                        <tr class="popupTable">
	                        ...
	                        <tr class="popupTable" id="SplashCurrentPatientTableRow" runat="server">
		                        <td  class="loginBorder"><img src="../../Images/shim.gif" height="1" width="1" border="0" /></td>
		                        <td>&nbsp;</td>
		                        <td colspan="3" class="popupLabel" style="TEXT-ALIGN: left" valign="bottom"><img src="../../Images/PopupWidget.gif" height="11" width="8" border="0" hspace="5" /><asp:Label ID="SplashCurrentPatient" Runat="server">There is no patient currently selected.</asp:Label><br><img src="../../Images/shim.gif" height="14" width="19" border="0" /><a id="CurrentPatientPanelLink" name="CurrentPatientPanelLink" href="ViewPatientSurveySummary.aspx?usePtInSession=true" target="MainWindow" class="popupAlertMedium" onclick="hideSelectPatientPanel();"><asp:Literal ID="ViewEditPatientName" Runat="server" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MRN: <asp:Literal ID="ViewEditPatientMRN" Runat="server" /></a></td>
		                        <td  class="loginBorder"><img src="../../Images/shim.gif" height="1" width="1" border="0" /></td>
	                        </tr>
		                    <tr class="popupTable">
		                        <td  class="loginBorder" height="30"><img src="../../Images/shim.gif" height="1" width="1" border="0" /></td>
