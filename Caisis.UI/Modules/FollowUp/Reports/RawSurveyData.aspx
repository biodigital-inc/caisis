<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RawSurveyData.aspx.cs" Inherits="Caisis.UI.Modules.FollowUp.RawSurveyData" %>
...
<body class="reportContentBody">
    ...
    <form id="form1" runat="server">
         ...
         <table style="table-layout: fixed; width: 95%; margin: auto;" border="0">
            <tr>
