<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RandPreTxSurvey.ascx.cs" Inherits="Modules_FollowUp_Surveys_EVUQOLPreTx" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
    <title>Pre Treatment Survey</title>
            ...
            <table height="900">
                <tr>
                    <td valign="top">
                        ...
                        <br />
                        <span style="font-size:18px;"><b>We would like to better understand how patients cope with aspects of their treatment
                            for prostate cancer and the medical tests involved in their care.</b></span>
                        <br />
                        <br />
                        <br />
                        <div class="boxedQuestion">
                        ...
                        <div class="boxedQuestion">
                            <ol start="32">
                                <li>This Question Intentionally Left Blank.</li>
                            </ol>
                        </div>
                        <table border="0" class="smallquestionsGridR">
                            <tr>
            ...
            <table height="900">
                <tr>
                    <td valign="top">
                        ...
                        <script type="text/javascript">
                            if (!(bw.ie7 || bw.ie8)) {
                                document.write('<div class="bottomSpacer">&nbsp;</div><div class="bottomSpacer">&nbsp;</div><div class="bottomSpacer">&nbsp;</div><div class="bottomSpacer">&nbsp;</div><div class="bottomSpacer">&nbsp;</div>')
                            }
                        </script>
                    </td>
                </tr>
