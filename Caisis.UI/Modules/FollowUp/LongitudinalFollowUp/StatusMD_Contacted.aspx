<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StatusMD_Contacted.aspx.cs"
    Inherits="Caisis.UI.Modules.FollowUp.StatusMD_Contacted"  %>
                        ...
                        <table width="98%"> 
                            <tr>			                                    
                                <td align="left"  class="TableNotes" style="cursor:default; ">
                                    Click the corresponding button below to indicate that either:<br /><br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;1.  data has been received or,<br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;2.  to re-contact MD.
                                    <br /><br />
                                ...
                                <ItemTemplate>
                                    <tr id="listRow" runat="server"  valign="middle"   >
                                        <td id="ControlCellValue" runat="server" align="center" class="ListManDataTableCellA"  >
                                            <asp:ImageButton ID="DataReceivedBtn" runat="server" ImageUrl="~/Modules/FollowUp/Images/DataReceived.gif"  CommandName="DataReceived" CommandArgument='<%# Eval("PatientId") %>' OnClientClick="showLoading();"/>
                                            <span>
                                                <img id="DataReceivedImg" runat="server" border="0" src="~/Modules/FollowUp/Images/checkBox.gif" style="display: none; " />
                                                <asp:Label ID="DataReceivedLBL" runat="server" Text="" ForeColor="Green" Font-Bold="true"  />
                                            </span>                                                                                              
                                        </td>
                                        <td id="ControlCellValue2" runat="server" align="center"  class="ListManDataTableCellA">
                                            <asp:ImageButton ID="NeedMD_ContactBtn" runat="server" ImageUrl="~/Modules/FollowUp/Images/ReContactMD.gif"  CommandName="NeedMD_Contact" CommandArgument='<%# Eval("PatientId") %>' OnClientClick="showLoading();"/>
                                            <span>
                                                <img id="NeedMD_ContactImg" runat="server" border="0" src="~/Modules/FollowUp/Images/checkBox.gif" style="display: none; " />
                                                <asp:Label ID="NeedMD_ContactLBL" runat="server" Text="" ForeColor="Green" Font-Bold="true"  />
                                            </span>                                                                                              
