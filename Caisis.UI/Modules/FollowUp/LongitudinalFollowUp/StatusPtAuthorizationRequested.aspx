<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StatusPtAuthorizationRequested.aspx.cs"
    Inherits="Caisis.UI.Modules.FollowUp.StatusPtAuthorizationRequested"  %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function cancelPage() {
            ...
            if (confirmSubmit('No authorization received updates have been processed for patient.\rAre you sure you want to quit?'))
                    reloadMainPage();
        }
...
<body class="reportContentBody" onunload="return false; reloadMainPage();">
    <form id="ContactStatusForm" runat="server" method="post">
        ...
        <table width="98%"> 
            <tr>			                                    
                <td align="left" class="SectionTitle2"><strong>Authorization Received: </strong><i class="ListManTitle" ><%= PatientName %></i> </td>
            </tr>
            <tr>
                <td>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="20">
                            ...
                            <tr>
                               <td width="33%" valign="top" align="center" >
                                    ...
                                    <strong>Select an option that represents the status of the authorization</strong><br /><br />
                                                            ...
                                                            <td valign="top" width="100%">
                                                                <table width="100%" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" align="left" style="white-space: nowrap; " class="PatientListSplashMsg"><asp:Label ID="Option1Title" runat="server" Text="Option 1:  Authorization was recieved complete." /></td>                                                                        
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td valign="top" width="100%">
                                                                <table width="100%" cellpadding="0">
                                                                    <tr>
                                                                        ...
                                                                        <td valign="top" align="left" style="white-space: nowrap; " class="PatientListSplashMsg"><asp:Label ID="Option2Title" runat="server" Text="Option 2:  Authorization was returned to sender." /><strong></strong>&nbsp;&nbsp;</td>                                                                        
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                ...
                                                <td class="dashboardBG_TopLeft" height="200px" >                                                    
                                                    <div id="Option1ResultDiv" runat="server" style="display: none; " align="center" >
                                                        ...
                                                        <table class="" cellspacing="5" >
                                                            <tr>
                                                                <td colspan="2">Enter date authorization was received (or today's date if unknown):</td>
                                                            </tr>
                                                            <tr>
                                                                <td colspan="2">
                                                                    <euc:CaisisTextBox ID="AuthorizationReceivedDateText" runat="server" ShowLabel="false" CalcDate="true" ShowCalendar="true"/>
                                                                    <euc:CaisisHidden ID="AuthorizationReceivedDate" runat="server" ShowLabel="false" />
                                                                </td>                                                                
                                                            </tr>
                                                            <tr>                                                            
                                                                 <td colspan="2" ><asp:ImageButton style="visibility: hidden; " ID="SubmitAuthorizationReceicedDateBtn" runat="server" ImageUrl="~/Modules/FollowUp/Images/ClickToCompleteBtn.gif" OnClick="AuthorizationReceivedClick" /></td>
                                                           </tr>
                                                       </table>          
    ...
    <script type="text/javascript">
        ...
        addEventShowElement($('<%= AuthorizationReceivedDateText.ClientID %>'), $('<%= SubmitAuthorizationReceicedDateBtn.ClientID %>'));
