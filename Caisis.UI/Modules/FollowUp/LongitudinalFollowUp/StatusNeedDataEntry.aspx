<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StatusNeedDataEntry.aspx.cs"
    Inherits="Caisis.UI.Modules.FollowUp.StatusNeedDataEntry"  %>
                        ...
                        <table width="98%"> 
                            <tr>			                                    
                                <td align="left"  class="TableNotes" style="cursor:default; ">
                                    1.  Indicate 'Yes' or 'No' for patient HIPAA authorizaiton.<br />
                                    2.  Click the corresponding button below to indicate Data has been entered.
                                    <br /><br />
                                ...
                                <HeaderTemplate>
                                 <table width="98%" class="ListManDataTableTop"> 
                                  <tr> 
                                    ...
                                    <td id="ControlCellTitle2" runat="server" class="ListManDataTableTop" >HIPAA Authorization?</td>
                                ...
                                <ItemTemplate>
                                    <tr id="listRow" runat="server"  valign="middle"   >
                                        <td id="ControlCellValue" runat="server" align="center" class="ListManDataTableCellA"  >
                                            <asp:ImageButton ID="DataEnteredBtn" runat="server" ImageUrl="~/Modules/FollowUp/Images/DataEntered.gif"  CommandName="DataEntered" CommandArgument='<%# Eval("PatientId") %>' OnClientClick="showLoading();"/>
                                            <span>
                                                <img id="DataEnteredImg" runat="server" border="0" src="~/Modules/FollowUp/Images/checkBox.gif" style="display: none; "  />
                                                <asp:Label ID="DataEnteredLBL" runat="server" Text="" ForeColor="Green" Font-Bold="true"  />
                                            </span>                                                                                              
                                        </td>
                                        <td id="ControlCellValue2" runat="server" align="center"  class="ListManDataTableCellA">
                                            ...
                                            <asp:DropDownList Width="170px" ID="HipaaDDL" runat="server"  OnSelectedIndexChanged="HipaaDDL_OnSelectedIndexChanged" AutoPostBack="true"   >
                                                <asp:ListItem Value="" Text=""/>
                                                <asp:ListItem Value="Yes" Text="Yes (found and unexpired)" />
                                                <asp:ListItem Value="No" Text="No (not found or expired)" />
                                            </asp:DropDownList>       
