...
{
    public partial class RetreiveRedCapSurveys : FollowUpBasePage
    {
        ...
        private void ConfigurePatientRepeater(Object Sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Header)
            {
                ...
                HtmlTableCell ContactStatusCellTitle = (HtmlTableCell)e.Item.FindControl("ContactStatusCellTitle");
                HtmlTableCell CommentsCellTitle = (HtmlTableCell)e.Item.FindControl("CommentsCellTitle");


                ControlCellTitle.Style["display"] = "none";
                ControlCellTitle2.Style["display"] = "none";
                NameCellTitle.Style["display"] = "";
                DateOfBirthCellTitle.Style["display"] = "";
                MRNCellTitle.Style["display"] = "";
                ContactStatusCellTitle.Style["display"] = "";
                CommentsCellTitle.Style["display"] = "";

                ControlCellTitle.Style["width"] = "0%";
                ControlCellTitle2.Style["width"] = "0%";
                NameCellTitle.Style["width"] = "20%";
                DateOfBirthCellTitle.Style["width"] = "15%";
                MRNCellTitle.Style["width"] = "20%";
                ContactStatusCellTitle.Style["width"] = "15%";
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                HtmlTableCell ContactStatusCellValue = (HtmlTableCell)e.Item.FindControl("ContactStatusCellValue");
                HtmlTableCell CommentsCellValue = (HtmlTableCell)e.Item.FindControl("CommentsCellValue");

                ControlCellValue.Style["display"] = "none";
                ControlCellValue2.Style["display"] = "none";
                NameCellValue.Style["display"] = "";
                DateOfBirthCellValue.Style["display"] = "";
                MRNCellValue.Style["display"] = "";
                ContactStatusCellValue.Style["display"] = "";
        ...
        protected void RetreiveCompletedSurveysBtnClick(object sender, EventArgs e)
        {
            try
            {
               // access REDCap to check for completed surveys for patient          
