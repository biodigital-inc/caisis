<%@ Control Language="C#" Inherits="Caisis.UI.Modules.Gynecology.Eforms.ComorbidityGTD" CodeFile="ComorbidityGTD.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="ComorbidityGTD" /><span class="controlBoxTitle">Comorbidities</span><br/>
        ...
        <td>
            ...
            <table width="650" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="GynComorsTbl">
             ...
             <%--   <td height="28" class="ClinicalEformGridColumnOne">	
               ...
               <tr> 
                <td align="left"><euc:EformCheckBox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_16" 
                    RecordId="16" Value="Recurrent Mole" />Recurrent Mole</td>
               ...
               <tr> 
                <td align="left"><euc:EformCheckBox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_17" 
                    RecordId="17" Value="Repetitive Mole" />Repetitive Mole</td>
                ...
                <tr> 
                <td align="left"><euc:EformCheckBox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_18" 
                    RecordId="18" Value="Unknown Mole" />Unknown Mole</td>
             ...
             <%--   <td height="28" class="ClinicalEformGridColumnOne">	
                ...
                <td align="left"><euc:EformComboBox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_11" 
                    RecordId="11" LookupCode="Comorbidity,Disease,GTD" /></td>
              ...
              <tr style="display:none;"> 
               <%-- <td height="28" class="ClinicalEformGridColumnOne">	
                ...
                <td align="left"><euc:EformComboBox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_12" 
                    RecordId="12" LookupCode="Comorbidity,Disease,GTD" /></td>
            ...
            <%--    <td height="28" class="ClinicalEformGridColumnOne">	
                ...
                <td align="left"><euc:EformComboBox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_13" 
                    RecordId="13" LookupCode="Comorbidity,Disease,GTD" /></td>
              ...
              <%--  <td height="28" class="ClinicalEformGridColumnOne">	
                ...
                <td align="left"><euc:EformComboBox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_14" 
                    RecordId="14" LookupCode="Comorbidity,Disease,GTD" /></td>
            ...
            <%--    <td height="28" class="ClinicalEformGridColumnOne">	
                ...
                <td align="left"><euc:EformComboBox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_15" 
                    RecordId="15" LookupCode="Comorbidity,Disease,GTD" /></td>
