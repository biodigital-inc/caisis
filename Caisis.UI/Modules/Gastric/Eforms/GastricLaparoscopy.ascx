<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Gastric.Eforms.GastricLaparoscopy" CodeFile="GastricLaparoscopy.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="GastricLaparoscopy" id="GastricLaparoscopy" />
<asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Laparoscopy 1"></asp:Label><br/>
<table border="0" cellspacing="0" cellpadding="16" width="700" class="eformXLargePopulatedTable">
 <tr >
	<td style="white-space:nowrap;" id="GastricLaparoscopyYesNonContainer"><strong>Laparoscopy Performed?</strong><euc:EformRadioButtonList Table="NoTable" Field="LaparoscopyPerformed" id="LaparoscopyPerformed" runat="server" 
 ...
 <table border="0" cellspacing="0" class="gastricPathTable"> 
      ...
      <tr >
       ...
       <strong>Path Report Date</strong>&nbsp;&nbsp;
            ...
            ShowCalendar="True" CalcDate="True" AppendToOnChange="setGastricLapPathSpecimenTypes()" />
	        <euc:EformHidden  ParentRecordId="12" RecordId="1" TABLE="Pathology" FIELD="PathDate" ID="PathDate_1" Runat="server" />	
	           ...
	           <euc:EformTextBox ParentRecordId="12" RecordId="1" TABLE="Pathology" FIELD="PathNum" ID="PathNum_1" Runat="server" Width="80px" ShowNumberPad="true"  AppendToOnChange="setGastricLapPathSpecimenTypes()" />

       </td>
     </tr>
     <tr >
       <td style="vertical-align: top;" onmouseout="setLap1ClinStageMBasedOnCytologyResult();">
       <strong>Result</strong>&nbsp;&nbsp;
       	 <euc:EFormSelect ParentRecordId="12" RecordId="1" Table="Pathology" Field="PathResult" id="PathResult_1" runat="server"
	    style="width: 100px;" DropDownWidth="550" DropDownHeight="auto" LookupCode="BxResult,Disease,Gastric" AppendToOnChange="setGastricLapPathSpecimenTypes()" />
...
--%></table>
 ...
 <table border="0" cellspacing="0" class="gastricPathTable"> 
      <tr><td><span class="controlBoxTitle" style="font-size: 12px;">Biopsy</span>
      		<euc:EformTextBox style="display: none;" ParentRecordId="12" RecordId="2" TABLE="Pathology"  FIELD="PathSpecimenType" ID="PathSpecimenType_2" Runat="server"  />
      </td></tr>
      <tr >
       <td style="vertical-align: top;">
       <strong>Path Report Date</strong>&nbsp;&nbsp;
	        ...
	        <euc:EformHidden  ParentRecordId="12" RecordId="2" TABLE="Pathology" FIELD="PathDate" ID="PathDate_2" Runat="server" />	
	            ...
	            <strong style="margin-left: 50px;">Path Accession #</strong>&nbsp;&nbsp;
	           <euc:EformTextBox ParentRecordId="12" RecordId="2" TABLE="Pathology" FIELD="PathNum" ID="PathNum_2" Runat="server" Width="80px" ShowNumberPad="true"  AppendToOnChange="setGastricLapPathSpecimenTypes()" />
 ...
 <table border="0" cellspacing="0" class="gastricPathTable"> 
      <tr><td><span class="controlBoxTitle" style="font-size: 12px;">Brushing</span>
      		<euc:EformTextBox style="display: none;" ParentRecordId="12" RecordId="3" TABLE="Pathology"  FIELD="PathSpecimenType" ID="PathSpecimenType_3" Runat="server"  />
      ...
      <tr >
       ...
       <strong>Path Report Date</strong>&nbsp;&nbsp;
	        ...
	        <euc:EformHidden  ParentRecordId="12" RecordId="3" TABLE="Pathology" FIELD="PathDate" ID="PathDate_3" Runat="server" />	
	            ...
	            <strong style="margin-left: 50px;">Path Accession #</strong>&nbsp;&nbsp;
	           <euc:EformTextBox ParentRecordId="12" RecordId="3" TABLE="Pathology" FIELD="PathNum" ID="PathNum_3" Runat="server" Width="80px" ShowNumberPad="true"  AppendToOnChange="setGastricLapPathSpecimenTypes()" />
...
function setGastricLapPathSpecimenTypes()
{
...
function setLap1ClinStageMBasedOnCytologyResult()
{
