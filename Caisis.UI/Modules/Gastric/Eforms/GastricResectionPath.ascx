<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Gastric.Eforms.GastricResectionPath" CodeFile="GastricResectionPath.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="GastricResectionPath" id="GastricResectionPath" />
