namespace Caisis.UI.Modules.Colorectal.Eforms
{
	...
	/// </summary>
    public partial class ColonAndRectalProcedures : BaseEFormControl
	{
        ...
        protected override void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                colonRectalProcDt.Value = SurgeryDate;

                PelvisAbdomenProcDt.Value = SurgeryDate;

                MiscHepaticProcDt.Value = SurgeryDate;
            }
        }
	}
}
