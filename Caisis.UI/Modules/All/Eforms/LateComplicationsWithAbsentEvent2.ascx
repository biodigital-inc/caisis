<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.LateComplicationsWithAbsentEvent2" CodeFile="LateComplicationsWithAbsentEvent2.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>
<script language="javascript">
	tableArray.ComplicationsHtmlTable = "ComplicationsHtmlTable";
</script>
<link href="../../../StyleSheets/EformStyles.css" rel="stylesheet" type="text/css">
<a name="LateComplicationsWithAbsentEvent2" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text=""></asp:Label><br/>
...
<table width="650" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="ComplicationsHtmlTable">
  ...
  <tr >
    ...
    <td style="white-space:nowrap;"><euc:EformComboBox DropDownWidth="auto"  LookupCode="ToxName_Complication"    style="width:150;" Field="ToxName" RecordId="6" Table="Toxicities" Runat="server" id="ToxName_6"  /></td>
    <td style="white-space:nowrap;"><euc:EformComboBox DropDownWidth="auto"  LookupCode="ToxGrade"    style="width:100px;" Field="ToxGrade" RecordId="6" Table="Toxicities" Runat="server" id="ToxGrade_6"  /></td>
  ...
  <tr >
    ...
    <td style="white-space:nowrap;"><euc:EformComboBox DropDownWidth="auto"  LookupCode="ToxName_Complication"    style="width:150;" Field="ToxName" RecordId="7" Table="Toxicities" Runat="server" id="ToxName_7"  /></td>
    <td style="white-space:nowrap;"><euc:EformComboBox DropDownWidth="auto"  LookupCode="ToxGrade"    style="width:100px;" Field="ToxGrade" RecordId="7" Table="Toxicities" Runat="server" id="ToxGrade_7"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td style="white-space:nowrap;"><euc:EformComboBox DropDownWidth="auto"  LookupCode="ToxName_Complication"    style="width:150;" Field="ToxName" RecordId="8" Table="Toxicities" Runat="server" id="ToxName_8"  /></td>
    <td style="white-space:nowrap;"><euc:EformComboBox DropDownWidth="auto"  LookupCode="ToxGrade"    style="width:100px;" Field="ToxGrade" RecordId="8" Table="Toxicities" Runat="server" id="ToxGrade_8"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td style="white-space:nowrap;"><euc:EformComboBox DropDownWidth="auto"  LookupCode="ToxName_Complication"    style="width:150;" Field="ToxName" RecordId="9" Table="Toxicities" Runat="server" id="ToxName_9"  /></td>
    <td style="white-space:nowrap;"><euc:EformComboBox DropDownWidth="auto"  LookupCode="ToxGrade"    style="width:100px;" Field="ToxGrade" RecordId="9" Table="Toxicities" Runat="server" id="ToxGrade_9"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td style="white-space:nowrap;"><euc:EformComboBox DropDownWidth="auto"  LookupCode="ToxName_Complication"    style="width:150;" Field="ToxName" RecordId="10" Table="Toxicities" Runat="server" id="ToxName_10"  /></td>
    <td style="white-space:nowrap;"><euc:EformComboBox DropDownWidth="auto"  LookupCode="ToxGrade"    style="width:100px;" Field="ToxGrade" RecordId="10" Table="Toxicities" Runat="server" id="ToxGrade_10"  /></td>
...
<script type="text/javascript">
    ...
    function postOpCompRadioClick(postOpCompoption_value,postOpComphideDiv,postOpComphideAbsentDiv,toxDateTextID,toxDateID,toxNameID,toxGradeID,toxNotesID)
    {
      ...
      else if (postOpCompoption_value == "No" || postOpCompoption_value == "Unknown")
      {
        ...
        if (postOpCompoption_value == "Unknown")       
