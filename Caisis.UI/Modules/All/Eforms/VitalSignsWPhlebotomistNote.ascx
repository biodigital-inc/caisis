<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.VitalSignsWPhlebotomistNote" CodeFile="VitalSignsWPhlebotomistNote.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>
<link href="../../../StyleSheets/EformStyles.css" rel="stylesheet" type="text/css">

<a name="VitalSignsWPhlebotomistNote" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Vital Signs"></asp:Label>
<euc:EformCheckbox TABLE="NoTable" FIELD="PhlebotomistNote" Runat="server" ID="PhlebotomistNote" Value="Vital signs were verified by checking phlebotomist note." style="margin-left: 50px;" />Vital signs were verified by checking phlebotomist note.
<br/>
<table width="690" border="0" cellspacing="0" cellpadding="3" style="border-top: solid 1px #cccccc;border-right: solid 1px #cccccc;">
  ...
  <tr>
    ...
    <td class="ClinicalEformGridColumnTwo" style="border-bottom: solid 1px #cccccc;"><euc:EformComboBox LookupCode="KPS" style="width:60px;" DropDownWidth="340" TABLE="Encounters" FIELD="EncKPS" Runat="server" ID="KPS" /></td>
