<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.OutsideProcedureHistory" CodeFile="OutsideProcedureHistory.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>
<script type="text/javascript" language="javascript">
	tableArray.ProceduresHtmlTable = "ProceduresHtmlTable";
</script>
<link href="../../../StyleSheets/EformStyles.css" rel="stylesheet" type="text/css"/>
<a name="OutsideProcedureHistory" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Procedure History (Outside)"></asp:Label><br/>
<table width="650" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="SurgeriesHtmlTable">
  ...
  <tr id="NoSurgicalHistoryMsgTr" runat="server"  class="ClinicalEformPopulatedRowNonClickable" > 
			<td colspan="6" class="ClinicalEformPopulatedColumn" align="center" height="40"> No prior outside surgical procedures have been recorded for this patient.</td>
  </tr> 
...
<tr> 
    ...
    <td align="center"  style="white-space: nowrap;">
                                      &nbsp;<euc:EformComboBox Runat="server"   RecordId="1"  ID="ProcName_1"     Table="Procedures" Field="ProcName"    LookupCode="ProcName" RefBy="ProcName" style="width:150;"  MaxLength="50"    />	</td>
    <td  style="white-space: nowrap;">&nbsp;<euc:EformSelect   Runat="server"   RecordId="1"  ID="ProcSide_1"     TABLE="Procedures" FIELD="ProcSide"    LookupCode="OpSide"  style="width:65px;"   DropDownWidth="90" DropDownHeight="auto"    /></td>
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox   LookupCode="ProcName" RefBy="ProcName" style="width:150;" Field="ProcName" RecordId="2" Table="Procedures" MaxLength="50"  Runat="server"   id="ProcName_2"  />	</td>
  ...
  <tr > 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox   LookupCode="ProcName" RefBy="ProcName" style="width:150;" Field="ProcName" RecordId="3" Table="Procedures" MaxLength="50"  Runat="server"   id="ProcName_3"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox   LookupCode="ProcName" RefBy="ProcName" style="width:150;" Field="ProcName" RecordId="4" Table="Procedures" MaxLength="50"  Runat="server"   id="ProcName_4"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox   LookupCode="ProcName" RefBy="ProcName" style="width:150;" Field="ProcName" RecordId="5" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_5"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox   LookupCode="ProcName" RefBy="ProcName" style="width:150;" Field="ProcName" RecordId="6" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_6"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox   LookupCode="ProcName" RefBy="ProcName" style="width:150;" Field="ProcName" RecordId="7" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_7"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox   LookupCode="ProcName" RefBy="ProcName" style="width:150;" Field="ProcName" RecordId="8" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_8"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox   LookupCode="ProcName" RefBy="ProcName" style="width:150;" Field="ProcName" RecordId="9" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_9"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox   LookupCode="ProcName" RefBy="ProcName" style="width:150;" Field="ProcName" RecordId="10" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_10"  />	</td>
