<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.PatientsSocialHistories" CodeFile="PatientsSocialHistories.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>


<link href="../../../StyleSheets/EformStyles.css" rel="stylesheet" type="text/css"/>

<a name="PatientsSocialHistories" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Social History"></asp:Label><br/>
