<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.RadiationTherapy2" CodeFile="RadiationTherapy2.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="RadiationTherapy2" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Radiation Therapy"></asp:Label><br/>
<table width="650" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="RadiationTherapyHtmlTable">
  ...
  <tr >
    ...
    <td><euc:EformComboBox  LookupCode="RadTxTarget"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="11" Table="RadiationTherapy" Runat="server" id="RadTxTarget_11"  /></td>
    ...
    <td><euc:EformComboBox  LookupCode="Institution,PercentUsage,Top80" RefBy="Institution"  style="width:80;" Field="RadTxInstitution" RecordId="11" Table="RadiationTherapy" Runat="server" id="RadTxInstitution_11"  /></td>
    ...
    <td><euc:EformComboBox  LookupCode="RadTxTarget"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="12" Table="RadiationTherapy" Runat="server" id="RadTxTarget_12"  /></td>
    ...
    <td><euc:EformComboBox  LookupCode="Institution,PercentUsage,Top80" RefBy="Institution"  style="width:80;" Field="RadTxInstitution" RecordId="12" Table="RadiationTherapy" Runat="server" id="RadTxInstitution_12"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformComboBox  LookupCode="RadTxTarget"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="13" Table="RadiationTherapy" Runat="server" id="RadTxTarget_13"  /></td>
    ...
    <td><euc:EformComboBox  LookupCode="Institution,PercentUsage,Top80" RefBy="Institution"  style="width:80;" Field="RadTxInstitution" RecordId="13" Table="RadiationTherapy" Runat="server" id="RadTxInstitution_13"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformComboBox  LookupCode="RadTxTarget"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="14" Table="RadiationTherapy" Runat="server" id="RadTxTarget_14"  /></td>
    ...
    <td><euc:EformComboBox  LookupCode="Institution,PercentUsage,Top80" RefBy="Institution"  style="width:80;" Field="RadTxInstitution" RecordId="14" Table="RadiationTherapy" Runat="server" id="RadTxInstitution_14"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformComboBox  LookupCode="RadTxTarget"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="15" Table="RadiationTherapy" Runat="server" id="RadTxTarget_15"  /></td>
    ...
    <td><euc:EformComboBox  LookupCode="Institution,PercentUsage,Top80" RefBy="Institution"  style="width:80;" Field="RadTxInstitution" RecordId="15" Table="RadiationTherapy" Runat="server" id="RadTxInstitution_15"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformComboBox  LookupCode="RadTxTarget"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="16" Table="RadiationTherapy" Runat="server" id="RadTxTarget_16"  /></td>
    ...
    <td><euc:EformComboBox  LookupCode="Institution,PercentUsage,Top80" RefBy="Institution"  style="width:80;" Field="RadTxInstitution" RecordId="16" Table="RadiationTherapy" Runat="server" id="RadTxInstitution_16"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformComboBox  LookupCode="RadTxTarget"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="17" Table="RadiationTherapy" Runat="server" id="RadTxTarget_17"  /></td>
    ...
    <td><euc:EformComboBox  LookupCode="Institution,PercentUsage,Top80" RefBy="Institution"  style="width:80;" Field="RadTxInstitution" RecordId="17" Table="RadiationTherapy" Runat="server" id="RadTxInstitution_17"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformComboBox  LookupCode="RadTxTarget"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="18" Table="RadiationTherapy" Runat="server" id="RadTxTarget_18"  /></td>
    ...
    <td><euc:EformComboBox  LookupCode="Institution,PercentUsage,Top180" RefBy="Institution"  style="width:80;" Field="RadTxInstitution" RecordId="18" Table="RadiationTherapy" Runat="server" id="RadTxInstitution_18"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformComboBox  LookupCode="RadTxTarget"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="19" Table="RadiationTherapy" Runat="server" id="RadTxTarget_19"  /></td>
    ...
    <td><euc:EformComboBox  LookupCode="Institution,PercentUsage,Top80" RefBy="Institution"  style="width:80;" Field="RadTxInstitution" RecordId="19" Table="RadiationTherapy" Runat="server" id="RadTxInstitution_19"  /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformComboBox  LookupCode="RadTxTarget"  RefBy="RadTxTarget" style="width:80;" Field="RadTxTarget" RecordId="20" Table="RadiationTherapy" Runat="server" id="RadTxTarget_20"  /></td>
    ...
    <td><euc:EformComboBox  LookupCode="Institution,PercentUsage,Top80" RefBy="Institution"  style="width:80;" Field="RadTxInstitution" RecordId="20" Table="RadiationTherapy" Runat="server" id="RadTxInstitution_20"  /></td>
