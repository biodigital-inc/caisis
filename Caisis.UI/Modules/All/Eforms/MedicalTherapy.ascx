<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.MedicalTherapy" CodeFile="MedicalTherapy.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="MedicalTherapy" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Medical Therapies"></asp:Label><br/>
<table width="650" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="MedicalTherapyHtmlTable">
  ...
  <tr >
    ...
    <td style="white-space:nowrap;"><euc:EformSelect RecordId="1" LookupCode="MedUnits" DropDownWidth="270" TABLE="MedicalTherapy" FIELD="MedTxUnits" Runat="server" ID="MedTxUnits_1" style="width: 55px;"/></td>
    ...
    <td style="white-space:nowrap;"><euc:EformSelect RecordId="2" LookupCode="MedUnits" DropDownWidth="270" TABLE="MedicalTherapy" FIELD="MedTxUnits" Runat="server" ID="MedTxUnits_2" style="width: 55px;"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td style="white-space:nowrap;"><euc:EformSelect RecordId="3" LookupCode="MedUnits" DropDownWidth="270" TABLE="MedicalTherapy" FIELD="MedTxUnits" Runat="server" ID="MedTxUnits_3" style="width: 55px;"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td style="white-space:nowrap;"><euc:EformSelect RecordId="4" LookupCode="MedUnits" DropDownWidth="270" TABLE="MedicalTherapy" FIELD="MedTxUnits" Runat="server" ID="MedTxUnits_4" style="width: 55px;"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td style="white-space:nowrap;"><euc:EformSelect RecordId="5" LookupCode="MedUnits" DropDownWidth="270" TABLE="MedicalTherapy" FIELD="MedTxUnits" Runat="server" ID="MedTxUnits_5" style="width: 55px;"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td style="white-space:nowrap;"><euc:EformSelect RecordId="6" LookupCode="MedUnits" DropDownWidth="270" TABLE="MedicalTherapy" FIELD="MedTxUnits" Runat="server" ID="MedTxUnits_6" style="width: 55px;"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td style="white-space:nowrap;"><euc:EformSelect RecordId="7" LookupCode="MedUnits" DropDownWidth="270" TABLE="MedicalTherapy" FIELD="MedTxUnits" Runat="server" ID="MedTxUnits_7" style="width: 55px;"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td style="white-space:nowrap;"><euc:EformSelect RecordId="8" LookupCode="MedUnits" DropDownWidth="270" TABLE="MedicalTherapy" FIELD="MedTxUnits" Runat="server" ID="MedTxUnits_8" style="width: 55px;"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td style="white-space:nowrap;"><euc:EformSelect RecordId="9" LookupCode="MedUnits" DropDownWidth="270" TABLE="MedicalTherapy" FIELD="MedTxUnits" Runat="server" ID="MedTxUnits_9" style="width: 55px;"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td style="white-space:nowrap;"><euc:EformSelect RecordId="10" LookupCode="MedUnits" DropDownWidth="270" TABLE="MedicalTherapy" FIELD="MedTxUnits" Runat="server" ID="MedTxUnits_10" style="width: 55px;"/></td>
