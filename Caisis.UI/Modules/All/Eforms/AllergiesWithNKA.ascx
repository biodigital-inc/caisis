<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.AllergiesWithNKA" CodeFile="AllergiesWithNKA.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<script type="text/javascript" language="javascript">
	...
	function toggleAllergyView()
	{
	    ...
	    if (Allergies_NKA.checked) showDataEntryFields = false;
...
<a name="AllergiesWithNKA" /><%--<div id="readOnlyMeds">
...
<euc:EformCheckBox runat="server" Table="NoTable" Field="Allergies_NKA" id="Allergies_NKA" Value="true" onclick="toggleAllergyView();" style="margin-left: 40px;" />NKA
<br/>
...
<table cellpadding="2" cellspacing="0" class="ClinicalEformTable" id="AllergiesHtmlTable">
  ...
  <asp:Repeater ID="allergies" runat="server" OnItemDataBound="AllergyRepeaterOnDataBound" > 
	<ItemTemplate> 
		<tr class="ClinicalEformPopulatedRow" onMouseOver="this.className='ClinicalEformHighlightedRow';" onMouseOut="this.className='ClinicalEformPopulatedRow';" onclick="LoadDataEntryForm('Allergies', <%# DataBinder.Eval(Container.DataItem, "AllergyId") %>, 'Allergen,AllergyResponse,AllergyNotes', 'Allergies');"> 
			<td class="ClinicalEformPopulatedColumn">&nbsp;<%# DataBinder.Eval(Container.DataItem, "Allergen") %></td>
		  <td align="center" class="ClinicalEformPopulatedColumn">&nbsp;<asp:Literal ID="AllergyResponseText" runat="server" /></td>
