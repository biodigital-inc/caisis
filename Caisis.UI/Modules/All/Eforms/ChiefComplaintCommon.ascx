<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.ChiefComplaintCommon" CodeFile="ChiefComplaintCommon.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="ChiefComplaintCommon" id="ChiefComplaint" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Chief Complaints"></asp:Label><br/>
...
<table border="0" cellspacing="0" cellpadding="16" width="600" class="eformLargePopulatedTable">
 ...
 <tr >
	...
	<td ><strong>Attending</strong><br/>
		<euc:EformComboBox LookupCode="Physician" id="EncPhysician" Table="Encounters" Field="EncPhysician" runat="server"/>
...
<table border="0" cellspacing="0" cellpadding="16" width="600" class="ClinicalEformTable">
  ...
  <tr>
      ...
      <td align="center">       
       <euc:EformExtendedCheckBoxList ShowOther="true" Table="Encounters" Field="EncChiefComplaint" id="EncChiefComplaint_List" RepeatLayout="Table" RepeatDirection="Horizontal" RepeatColumns="3"  CellPadding="0" runat="server" >
