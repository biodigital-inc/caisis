namespace Caisis.UI.Modules.All.Eforms
{
	...
	/// <summary>
    ///		Summary description for OutsideProcedureHistory.
	/// </summary>
    public partial class OutsideProcedureHistory : BaseEFormControl
	{
		...
		protected void BuildSurgicalHistory()
		{
            ...
            dv.RowFilter = "Quality = 'OUT'";

            if (dv.Count > 0)
			{
                rptSurgicalHistory.DataSource = dv;
