<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.ORDateAndCaseSurgeon" CodeFile="ORDateAndCaseSurgeon.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>

<a name="ORDateAndCaseSurgeon" />
