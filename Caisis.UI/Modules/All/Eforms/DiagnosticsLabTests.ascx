<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.DiagnosticsLabTests" CodeFile="DiagnosticsLabTests.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>
<script language="javascript">
	tableArray.OtherLabTestsHtmlTable = "OtherLabTestsHtmlTable";
</script>
<link href="../../../StyleSheets/EformStyles.css" rel="stylesheet" type="text/css">
<a name="DiagnosticsLabTests" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Lab Tests"></asp:Label><br/>
<table width="250" cellpadding="3" cellspacing="0" class="ClinicalEformTable" id="OtherLabTestsHtmlTable">
	<tr> 
		...
		<td width="9%" class="controlBoxDataGridHeaderFirstCol">Quality</td>
	...
	<asp:Repeater ID="OtherLabTests" runat="server" OnItemDataBound="EFormRepeaterOnDataBoundForOther"> 
		<ItemTemplate> 
			<tr class="ClinicalEformPopulatedRow" onMouseOver="this.className='ClinicalEformHighlightedRow';" onMouseOut="this.className='ClinicalEformPopulatedRow';"  onclick="LoadDataEntryForm('LabTests', <%# DataBinder.Eval(Container.DataItem, "LabTestId") %>, 'LabDateText,LabDate,LabTest,LabResult,LabUnits,LabQuality', 'BiochemicalMarkers');"> 
	...
	<tr> 
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox DropDownWidth="auto" style="width:80px;"  RecordId="1"  ID="LabTest_1"     TABLE="LabTests" Field="LabTest"     LookupCode="LabTest,Disease,@DiseaseView" Runat="server" /></td>
        <td align="center">
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox  DropDownWidth="auto"  style="width:80px;"  RecordId="1"  ID="LabUnits_1"    TABLE="LabTests" Field="LabUnits"    LookupCode="LabUnits,Disease,@DiseaseView" Runat="server"    /></td>
        <td style="white-space: nowrap;">
  	...
  	<tr> 
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox DropDownWidth="auto" style="width:80px;"  RecordId="2"  ID="LabTest_2"     TABLE="LabTests" Field="LabTest"     LookupCode="LabTest,Disease,@DiseaseView" Runat="server" /></td>
        <td align="center">
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox  DropDownWidth="auto"  style="width:80px;"  RecordId="2"  ID="LabUnits_2"    TABLE="LabTests" Field="LabUnits"    LookupCode="LabUnits,Disease,@DiseaseView" Runat="server"    /></td>
        <td style="white-space: nowrap;">
  	...
  	<tr> 
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox DropDownWidth="auto" style="width:80px;"  RecordId="3"  ID="LabTest_3"     TABLE="LabTests" Field="LabTest"     LookupCode="LabTest,Disease,@DiseaseView" Runat="server" /></td>
        <td align="center">
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox  DropDownWidth="auto"  style="width:80px;"  RecordId="3"  ID="LabUnits_3"    TABLE="LabTests" Field="LabUnits"    LookupCode="LabUnits,Disease,@DiseaseView" Runat="server"    /></td>
        <td style="white-space: nowrap;">
  	...
  	<tr style="DISPLAY: none"> 
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox DropDownWidth="auto" style="width:80px;"  RecordId="4"  ID="LabTest_4"     TABLE="LabTests" Field="LabTest"     LookupCode="LabTest,Disease,@DiseaseView" Runat="server" /></td>
        <td align="center">
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox  DropDownWidth="auto"  style="width:80px;"  RecordId="4"  ID="LabUnits_4"    TABLE="LabTests" Field="LabUnits"    LookupCode="LabUnits,Disease,@DiseaseView" Runat="server"    /></td>
        <td style="white-space: nowrap;">
  	...
  	<tr style="DISPLAY: none"> 
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox DropDownWidth="auto" style="width:80px;"  RecordId="5"  ID="LabTest_5"     TABLE="LabTests" Field="LabTest"     LookupCode="LabTest,Disease,@DiseaseView" Runat="server" /></td>
        <td align="center">
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox DropDownWidth="auto"   style="width:80px;"  RecordId="5"  ID="LabUnits_5"    TABLE="LabTests" Field="LabUnits"    LookupCode="LabUnits,Disease,@DiseaseView" Runat="server"    /></td>
        <td style="white-space: nowrap;">
  ...
  <tr style="DISPLAY: none"> 
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox DropDownWidth="auto" style="width:80px;"  RecordId="6"  ID="LabTest_6"     TABLE="LabTests" Field="LabTest"     LookupCode="LabTest,Disease,@DiseaseView" Runat="server" /></td>
        <td align="center">
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox DropDownWidth="auto"   style="width:80px;"  RecordId="6"  ID="LabUnits_6"    TABLE="LabTests" Field="LabUnits"    LookupCode="LabUnits,Disease,@DiseaseView" Runat="server"    /></td>
        <td style="white-space: nowrap;">
  ...
  <tr style="DISPLAY: none"> 
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox DropDownWidth="auto" style="width:80px;"  RecordId="7"  ID="LabTest_7"     TABLE="LabTests" Field="LabTest"     LookupCode="LabTest,Disease,@DiseaseView" Runat="server" /></td>
        <td align="center">
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox DropDownWidth="auto"   style="width:80px;"  RecordId="7"  ID="LabUnits_7"    TABLE="LabTests" Field="LabUnits"    LookupCode="LabUnits,Disease,@DiseaseView" Runat="server"    /></td>
        <td style="white-space: nowrap;">
  ...
  <tr style="DISPLAY: none"> 
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox DropDownWidth="auto" style="width:80px;"  RecordId="8"  ID="LabTest_8"     TABLE="LabTests" Field="LabTest"     LookupCode="LabTest,Disease,@DiseaseView" Runat="server" /></td>
        <td align="center">
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox DropDownWidth="auto"   style="width:80px;"  RecordId="8"  ID="LabUnits_8"    TABLE="LabTests" Field="LabUnits"    LookupCode="LabUnits,Disease,@DiseaseView" Runat="server"    /></td>
        <td style="white-space: nowrap;">
  ...
  <tr style="DISPLAY: none"> 
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox DropDownWidth="auto" style="width:80px;"  RecordId="9"  ID="LabTest_9"     TABLE="LabTests" Field="LabTest"     LookupCode="LabTest,Disease,@DiseaseView" Runat="server" /></td>
        <td align="center">
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox  DropDownWidth="auto"  style="width:80px;"  RecordId="9"  ID="LabUnits_9"    TABLE="LabTests" Field="LabUnits"    LookupCode="LabUnits,Disease,@DiseaseView" Runat="server"    /></td>
        <td style="white-space: nowrap;">
  ...
  <tr style="DISPLAY: none"> 
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox DropDownWidth="auto" style="width:80px;"  RecordId="10"  ID="LabTest_10"     TABLE="LabTests" Field="LabTest"     LookupCode="LabTest,Disease,@DiseaseView" Runat="server" /></td>
        <td align="center">
        ...
        <td style="white-space: nowrap;">
                <euc:EformComboBox  DropDownWidth="auto"  style="width:80px;"  RecordId="10"  ID="LabUnits_10"    TABLE="LabTests" Field="LabUnits"    LookupCode="LabUnits,Disease,@DiseaseView" Runat="server"    /></td>
        <td style="white-space: nowrap;">
