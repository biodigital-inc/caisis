namespace Caisis.UI.Modules.All.Eforms
{
	...
	/// <summary>
    ///		Summary description for UrodynamicsAppointment.
	/// </summary>
    public partial class UrodynamicsAppointment : BaseEFormControl
	{
        ...
        protected void SyncDates()
        {
            if (EncDateText.Value.Length > 0)
            {
                SurveyDateText.Value = EncDateText.Value;
                SurveyDateText.Disabled = false;
                SurveyDate.Value = EncDate.Value;
                SurveyDate.Disabled = false;
            }
        }
