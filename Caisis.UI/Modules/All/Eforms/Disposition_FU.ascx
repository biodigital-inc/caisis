<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.Disposition_FU" CodeFile="Disposition_FU.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>
<link href="../../../StyleSheets/EformStyles.css" rel="stylesheet" type="text/css">
<a name="Disposition_FU" /><span class="controlBoxTitle">Disposition</span><br>
