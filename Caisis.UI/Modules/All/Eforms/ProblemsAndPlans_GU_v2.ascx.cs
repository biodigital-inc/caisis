namespace Caisis.UI.Modules.All.Eforms
{
	...
	/// <summary>
    ///		Summary description for ProblemsAndPlans_GU.
	/// </summary>
    public partial class ProblemsAndPlans_GU_v2 : BaseEFormControl
	{
		...
		{
			LookupCodeDa lDa = new LookupCodeDa();
			DataTable lDt = lDa.GetLookupCodes("ProblemPlan");
        ...
        {
            if (!Request.PhysicalPath.Contains("ValidateEForm"))
            {
                base.BuildComorbidities(PatientID, FormName, FormType);
            }
            else
            {
                Comorbidity_1.Visible = false;
                Comorbidity_2.Visible = false;
                Comorbidity_3.Visible = false;
                Comorbidity_4.Visible = false;
                Comorbidity_5.Visible = false;
                Comorbidity_6.Visible = false;
                Comorbidity_7.Visible = false;
                Comorbidity_8.Visible = false;
                Comorbidity_9.Visible = false;
                Comorbidity_10.Visible = false;
                Comorbidity_11.Visible = false;
                Comorbidity_12.Visible = false;
                Comorbidity_13.Visible = false;
                Comorbidity_14.Visible = false;
                Comorbidity_15.Visible = false;
            }
        }
