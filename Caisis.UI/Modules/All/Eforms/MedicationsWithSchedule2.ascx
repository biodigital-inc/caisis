<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.MedicationsWithSchedule2" CodeFile="MedicationsWithSchedule2.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="MedicationsWithSchedule2" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Medications"></asp:Label>
...
<table width="650" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="MedicationsWithScheduleHtmlTable2">
  ...
  <tr >
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:120px;" RecordId="11" TABLE="Medications" FIELD="Medication"      ID="Medication_11"      Runat="server" LookupCode="Medication,Disease,@DiseaseView"  /></td>
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:65px;" RecordId="11" TABLE="Medications" FIELD="MedUnits"        ID="MedUnits_11"        Runat="server" LookupCode="MedUnits,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:80px;" RecordId="11" TABLE="Medications" FIELD="MedRoute"        ID="MedRoute_11"        Runat="server" LookupCode="MedRoute,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformComboBox style="width:80px;" RecordId="11" TABLE="Medications" FIELD="MedSchedule"     ID="MedSchedule_11"     Runat="server" LookupCode="MedSchedule,Disease,@DiseaseView" /></td>
  ...
  <tr style="DISPLAY: none;" >
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:120px;" RecordId="12" TABLE="Medications" FIELD="Medication"      ID="Medication_12"      Runat="server" LookupCode="Medication,Disease,@DiseaseView"  /></td>
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:65px;" RecordId="12" TABLE="Medications" FIELD="MedUnits"        ID="MedUnits_12"        Runat="server" LookupCode="MedUnits,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:80px;" RecordId="12" TABLE="Medications" FIELD="MedRoute"        ID="MedRoute_12"        Runat="server" LookupCode="MedRoute,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformComboBox style="width:80px;" RecordId="12" TABLE="Medications" FIELD="MedSchedule"     ID="MedSchedule_12"     Runat="server" LookupCode="MedSchedule,Disease,@DiseaseView" /></td>
  ...
  <tr style="DISPLAY: none;" >
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:120px;" RecordId="13" TABLE="Medications" FIELD="Medication"      ID="Medication_13"      Runat="server" LookupCode="Medication,Disease,@DiseaseView"  /></td>
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:65px;" RecordId="13" TABLE="Medications" FIELD="MedUnits"        ID="MedUnits_13"        Runat="server" LookupCode="MedUnits,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:80px;" RecordId="13" TABLE="Medications" FIELD="MedRoute"        ID="MedRoute_13"        Runat="server" LookupCode="MedRoute,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformComboBox style="width:80px;" RecordId="13" TABLE="Medications" FIELD="MedSchedule"     ID="MedSchedule_13"     Runat="server" LookupCode="MedSchedule,Disease,@DiseaseView" /></td>
  ...
  <tr style="DISPLAY: none;" >
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:120px;" RecordId="14" TABLE="Medications" FIELD="Medication"      ID="Medication_14"      Runat="server" LookupCode="Medication,Disease,@DiseaseView"  /></td>
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:65px;" RecordId="14" TABLE="Medications" FIELD="MedUnits"        ID="MedUnits_14"        Runat="server" LookupCode="MedUnits,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:80px;" RecordId="14" TABLE="Medications" FIELD="MedRoute"        ID="MedRoute_14"        Runat="server" LookupCode="MedRoute,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformComboBox style="width:80px;" RecordId="14" TABLE="Medications" FIELD="MedSchedule"     ID="MedSchedule_14"     Runat="server" LookupCode="MedSchedule,Disease,@DiseaseView" /></td>
  ...
  <tr style="DISPLAY: none;" >
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:120px;" RecordId="15" TABLE="Medications" FIELD="Medication"      ID="Medication_15"      Runat="server" LookupCode="Medication,Disease,@DiseaseView"  /></td>
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:65px;" RecordId="15" TABLE="Medications" FIELD="MedUnits"        ID="MedUnits_15"        Runat="server" LookupCode="MedUnits,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:80px;" RecordId="15" TABLE="Medications" FIELD="MedRoute"        ID="MedRoute_15"        Runat="server" LookupCode="MedRoute,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformComboBox style="width:80px;" RecordId="15" TABLE="Medications" FIELD="MedSchedule"     ID="MedSchedule_15"     Runat="server" LookupCode="MedSchedule,Disease,@DiseaseView" /></td>
  ...
  <tr style="DISPLAY: none;" >
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:120px;" RecordId="16" TABLE="Medications" FIELD="Medication"      ID="Medication_16"      Runat="server" LookupCode="Medication,Disease,@DiseaseView"  /></td>
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:65px;" RecordId="16" TABLE="Medications" FIELD="MedUnits"        ID="MedUnits_16"        Runat="server" LookupCode="MedUnits,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:80px;" RecordId="16" TABLE="Medications" FIELD="MedRoute"        ID="MedRoute_16"        Runat="server" LookupCode="MedRoute,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformComboBox style="width:80px;" RecordId="16" TABLE="Medications" FIELD="MedSchedule"     ID="MedSchedule_16"     Runat="server" LookupCode="MedSchedule,Disease,@DiseaseView" /></td>
  ...
  <tr style="DISPLAY: none;" >
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:120px;" RecordId="17" TABLE="Medications" FIELD="Medication"      ID="Medication_17"      Runat="server" LookupCode="Medication,Disease,@DiseaseView"  /></td>
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:65px;" RecordId="17" TABLE="Medications" FIELD="MedUnits"        ID="MedUnits_17"        Runat="server" LookupCode="MedUnits,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:80px;" RecordId="17" TABLE="Medications" FIELD="MedRoute"        ID="MedRoute_17"        Runat="server" LookupCode="MedRoute,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformComboBox style="width:80px;" RecordId="17" TABLE="Medications" FIELD="MedSchedule"     ID="MedSchedule_17"     Runat="server" LookupCode="MedSchedule,Disease,@DiseaseView" /></td>
  ...
  <tr style="DISPLAY: none;" >
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:120px;" RecordId="18" TABLE="Medications" FIELD="Medication"      ID="Medication_18"      Runat="server" LookupCode="Medication,Disease,@DiseaseView"  /></td>
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:65px;" RecordId="18" TABLE="Medications" FIELD="MedUnits"        ID="MedUnits_18"        Runat="server" LookupCode="MedUnits,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:80px;" RecordId="18" TABLE="Medications" FIELD="MedRoute"        ID="MedRoute_18"        Runat="server" LookupCode="MedRoute,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformComboBox style="width:80px;" RecordId="18" TABLE="Medications" FIELD="MedSchedule"     ID="MedSchedule_18"     Runat="server" LookupCode="MedSchedule,Disease,@DiseaseView" /></td>
  ...
  <tr style="DISPLAY: none;" >
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:120px;" RecordId="19" TABLE="Medications" FIELD="Medication"      ID="Medication_19"      Runat="server" LookupCode="Medication,Disease,@DiseaseView"  /></td>
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:65px;" RecordId="19" TABLE="Medications" FIELD="MedUnits"        ID="MedUnits_19"        Runat="server" LookupCode="MedUnits,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:80px;" RecordId="19" TABLE="Medications" FIELD="MedRoute"        ID="MedRoute_19"        Runat="server" LookupCode="MedRoute,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformComboBox style="width:80px;" RecordId="19" TABLE="Medications" FIELD="MedSchedule"     ID="MedSchedule_19"     Runat="server" LookupCode="MedSchedule,Disease,@DiseaseView" /></td>
  ...
  <tr style="DISPLAY: none;" >
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:120px;" RecordId="20" TABLE="Medications" FIELD="Medication"      ID="Medication_20"      Runat="server" LookupCode="Medication,Disease,@DiseaseView"  /></td>
    ...
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:65px;" RecordId="20" TABLE="Medications" FIELD="MedUnits"        ID="MedUnits_20"        Runat="server" LookupCode="MedUnits,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformSelect   style="width:80px;" RecordId="20" TABLE="Medications" FIELD="MedRoute"        ID="MedRoute_20"        Runat="server" LookupCode="MedRoute,Disease,@DiseaseView"  /></td>
    <td style="white-space:nowrap;"><euc:EformComboBox style="width:80px;" RecordId="20" TABLE="Medications" FIELD="MedSchedule"     ID="MedSchedule_20"     Runat="server" LookupCode="MedSchedule,Disease,@DiseaseView" /></td>
