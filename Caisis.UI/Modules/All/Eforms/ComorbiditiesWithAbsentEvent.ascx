<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.ComorbiditiesWithAbsentEvent" CodeFile="ComorbiditiesWithAbsentEvent.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="ComorbiditiesWithAbsentEvent" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text=""></asp:Label><br/>


<table class="eformLargePopulatedTable">
    <tr>
        <td>
            <span class="controlBoxTitle">Comorbidities ?</span></td>
        <td height="28">
...
<script type="text/javascript">
    ...
    function ComorbRadioClick(Comorboption_value,ComorbhideDiv,ComorbhideAbsentDiv,comorbDateTextID,comorbDateID,comorbidityID,comorbNotesID)
    {
      ...
      else if (Comorboption_value == "No" || Comorboption_value == "Unknown")
      {
