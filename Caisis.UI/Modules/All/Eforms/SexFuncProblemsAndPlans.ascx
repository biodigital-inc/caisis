<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.SexFuncProblemsAndPlans" CodeFile="SexFuncProblemsAndPlans.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="SexFuncProblemsAndPlans" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Problems and Plans"></asp:Label><img src="../../Images/ViewCopyFromPreviousVisit_small.gif" width="176" height="17" hspace="10" class="ClickableImage" style="margin-left: 310px;" title="Click here to view past problems and plans." onclick="showPreviousProblems();" /><br />
...
<table id="targetTable" width="650" border="0" cellspacing="0" cellpadding="0" class="eformLargePopulatedTable" style="background-position: 0 20;">
  ...
  <tr>
    ...
    <td valign="top" class="ControlBoxLinedRows" style="padding-top: 6px;"><img src="../../Images/OpenPicker_red.gif" width="14" height="20"  align="right" class="ClickableImage" style="margin-right: 6px;" onclick="showCommonProblems(1, this);" /><euc:EformComboBox TABLE="PatientProblems" FIELD="ProblemName" DropDownWidth="257" DropDownHeight="auto" width="257" LookupCode="PatientProblem_SexualFunction" Runat="server" RecordId="1" ID="ProblemName_1"/>
    <br />
  ...
  <tr>
    ...
    <td valign="top" class="ControlBoxLinedRows" style="padding-top: 6px;"><img src="../../Images/OpenPicker_red.gif" width="14" height="20" hspace="1" align="right" class="ClickableImage" style="margin-right: 6px;"  onclick="showCommonProblems(2, this);" /><euc:EformComboBox TABLE="PatientProblems" FIELD="ProblemName" DropDownWidth="257" DropDownHeight="auto" width="257" LookupCode="PatientProblem_SexualFunction" Runat="server" RecordId="2" ID="ProblemName_2"/>
    <br />	
  ...
  <tr>
    ...
    <td valign="top" class="ControlBoxLinedRows" style="padding-top: 6px;"><img src="../../Images/OpenPicker_red.gif" width="14" height="20" hspace="1" align="right" class="ClickableImage" style="margin-right: 6px;"  onclick="showCommonProblems(3, this);" /><euc:EformComboBox TABLE="PatientProblems" FIELD="ProblemName" DropDownWidth="257" DropDownHeight="auto" width="257" LookupCode="PatientProblem_SexualFunction" Runat="server" RecordId="3" ID="ProblemName_3"/>
    <br />	
  ...
  <tr>
    ...
    <td valign="top" class="ControlBoxLinedRows" style="padding-top: 6px;"><img src="../../Images/OpenPicker_red.gif" width="14" height="20" hspace="1" align="right" class="ClickableImage"  style="margin-right: 6px;" onclick="showCommonProblems(4, this);" />
    <%--<euc:EformTextArea TextMode="MultiLine" TABLE="PatientProblems" FIELD="ProblemName" Rows="2" style="width: 277px;" Runat="server" RecordId="4" ID="ProblemName_4"/>--%>
    <euc:EformComboBox TABLE="PatientProblems" FIELD="ProblemName" DropDownWidth="257" DropDownHeight="auto" width="257" LookupCode="PatientProblem_SexualFunction" Runat="server" RecordId="4" ID="ProblemName_4"/>
    <br /><a href="javascript:;" onclick="return showFirstAdditionalRow(this,'ProblemPlanHtmlTable_4');"><img src="../../Images/AddAPlanForThisProblem.gif" width="155" height="18"  border="0" style="margin-left:115px; margin-top: 10px; margin-bottom: 15px;" /></a></td>
    <td valign="top" class="ControlBoxLinedRows">
  ...
  <tr>
    ...
    <td valign="top" class="ControlBoxLinedRows" style="padding-top: 6px;"><img src="../../Images/OpenPicker_red.gif" width="14" height="20" hspace="1" align="right" class="ClickableImage"  style="margin-right: 6px;" onclick="showCommonProblems(5, this);" /><euc:EformComboBox TABLE="PatientProblems" FIELD="ProblemName" DropDownWidth="257" DropDownHeight="auto" width="257" LookupCode="PatientProblem_SexualFunction" Runat="server" RecordId="5" ID="ProblemName_5"/>
    <br />
  ...
  <tr>
    ...
    <td valign="top" class="ControlBoxLinedRows" style="padding-top: 6px;"><img src="../../Images/OpenPicker_red.gif" width="14" height="20" hspace="1" align="right" class="ClickableImage"  style="margin-right: 6px;" onclick="showCommonProblems(6, this);" /><euc:EformComboBox TABLE="PatientProblems" FIELD="ProblemName" DropDownWidth="257" DropDownHeight="auto" width="257" LookupCode="PatientProblem_SexualFunction" Runat="server" RecordId="6" ID="ProblemName_6"/>
    <br />	
