<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.Imaging" CodeFile="Imaging.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="Imaging" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Imaging"></asp:Label><br/>
<table width="675" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="DiagnosticsHtmlTable">
  ...
  <tr align="left"> 
    ...
    <td style="white-space: nowrap;">
		<euc:EformComboBox DropDownWidth="auto"  RecordId="1" LookupCode="DxType" TABLE="Diagnostics" FIELD="DxType" Runat="server" ID="DxType_1"/>
	</td>
    <td align="left" style="white-space: nowrap;">
		<euc:EformComboBox DropDownWidth="auto"  LookupCode="DxResult" RefBy="DxResult" style="width:140;" Field="DxResult" RecordId="1" Table="Diagnostics" Runat="server" id="DxResult_1"  />
	</td>
    <td align="center">
		<euc:EformTextBox RecordId="1" ShowCalendar="False" CalcDate="False" style="width:160px;" TABLE="Diagnostics" FIELD="DxNotes" Runat="server" ID="DxNotes_1"/>
	</td>
  ...
  <tr >
    ...
    <td style="white-space: nowrap;">
		<euc:EformComboBox DropDownWidth="auto"  RecordId="2" LookupCode="DxType" TABLE="Diagnostics" FIELD="DxType" Runat="server" ID="DxType_2"/>
	</td>
    <td align="left" style="white-space: nowrap;">
  ...
  <tr >
    ...
    <td style="white-space: nowrap;">
		<euc:EformComboBox DropDownWidth="auto"  RecordId="3" LookupCode="DxType" TABLE="Diagnostics" FIELD="DxType" Runat="server" ID="DxType_3"/>
	</td>
    <td align="left" style="white-space: nowrap;">
