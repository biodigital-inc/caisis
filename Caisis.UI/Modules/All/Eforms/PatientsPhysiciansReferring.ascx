<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.PatientsPhysiciansReferring" CodeFile="PatientsPhysiciansReferring.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>

<script type="text/javascript" language="javascript">
	tableArray.PatientsPhysiciansReferringHtmlTable = "PatientsPhysiciansReferringHtmlTable";
</script>
...
<script type="text/javascript">
     ...
     function setPatientIdPhysicianNameFields(patientID,patientIDvalue,physicianID, physicianNameID, physicianRoleID)
     {
           ...
           if(physicianID.value != '' && patientIDvalue.value != '' )
           {
            ...
            physicianRoleID.value = "Referring";
                     
            }else{
            patientID.value = '';
            physicianRoleID.value = '';
...
<tr>
        ...
        <a name="PatientsPhysiciansReferring" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Referring MDs"></asp:Label><br/>       
        </td>
...
<table width="550" cellpadding="3" cellspacing="0" class="ClinicalEformTable" id="PatientsPhysiciansReferringHtmlTable">
	<tr> 
	...
	<tr> 
        <td style="white-space: nowrap;">
                 ...
                 <euc:EformHidden id="PhName_1" TABLE="NoTable" Field="PatientPhysicians_PhName_1" runat="server"/>
                <euc:EformTextBox Width="1px" style="display:none;"  RecordId="1"  ID="PtPhRole_1"   TABLE="PatientPhysicians" FIELD="PtPhRole" LookupCode="PtPhRole"  Runat="server"  /></td>
        <td style="white-space: nowrap;">
  ...
  <tr style="display: none;" > 
        <td style="white-space: nowrap;">
                 ...
                 <euc:EformHidden id="PhName_2" TABLE="NoTable" Field="PatientPhysicians_PhName_2" runat="server"/>
                <euc:EformTextBox Width="1px" style="display:none;"  RecordId="2"  ID="PtPhRole_2"   TABLE="PatientPhysicians" FIELD="PtPhRole" LookupCode="PtPhRole"  Runat="server"  /></td>
        <td style="white-space: nowrap;">
    ...
    <tr style="display: none;" > 
        <td style="white-space: nowrap;">
                 ...
                 <euc:EformHidden id="PhName_3" TABLE="NoTable" Field="PatientPhysicians_PhName_3" runat="server"/>
                <euc:EformTextBox Width="1px" style="display:none;"  RecordId="3"  ID="PtPhRole_3"   TABLE="PatientPhysicians" FIELD="PtPhRole" LookupCode="PtPhRole"  Runat="server"  /></td>
        <td style="white-space: nowrap;">
  ...
  <tr style="display: none;" > 
        <td style="white-space: nowrap;">
                 ...
                 <euc:EformHidden id="PhName_4" TABLE="NoTable" Field="PatientPhysicians_PhName_4" runat="server"/>
                <euc:EformTextBox Width="1px" style="display:none;"  RecordId="4"  ID="PtPhRole_4"   TABLE="PatientPhysicians" FIELD="PtPhRole" LookupCode="PtPhRole"  Runat="server"  /></td>
        <td style="white-space: nowrap;">
  ...
  <tr style="display: none;" > 
        <td style="white-space: nowrap;">
                 ...
                 <euc:EformHidden id="PhName_5" TABLE="NoTable" Field="PatientPhysicians_PhName_5" runat="server"/>
                <euc:EformTextBox Width="1px" style="display:none;"  RecordId="5"  ID="PtPhRole_5"   TABLE="PatientPhysicians" FIELD="PtPhRole" LookupCode="PtPhRole"  Runat="server"  /></td>
        <td style="white-space: nowrap;">
  ...
  <tr style="display: none;" > 
        <td style="white-space: nowrap;">
                 ...
                 <euc:EformHidden id="PhName_6" TABLE="NoTable" Field="PatientPhysicians_PhName_6" runat="server"/>
                <euc:EformTextBox Width="1px" style="display:none;"  RecordId="6"  ID="PtPhRole_6"   TABLE="PatientPhysicians" FIELD="PtPhRole" LookupCode="PtPhRole"  Runat="server"  /></td>
        <td style="white-space: nowrap;">
  ...
  <tr style="display: none;" > 
        <td style="white-space: nowrap;">
                 ...
                 <euc:EformHidden id="PhName_7" TABLE="NoTable" Field="PatientPhysicians_PhName_7" runat="server"/>
                <euc:EformTextBox Width="1px" style="display:none;"  RecordId="7"  ID="PtPhRole_7"   TABLE="PatientPhysicians" FIELD="PtPhRole" LookupCode="PtPhRole"  Runat="server"  /></td>
        <td style="white-space: nowrap;">
  ...
  <tr style="display: none;" > 
        <td style="white-space: nowrap;">
                 ...
                 <euc:EformHidden id="PhName_8" TABLE="NoTable" Field="PatientPhysicians_PhName_8" runat="server"/>
                <euc:EformTextBox Width="1px" style="display:none;"  RecordId="8"  ID="PtPhRole_8"   TABLE="PatientPhysicians" FIELD="PtPhRole" LookupCode="PtPhRole"  Runat="server"  /></td>
        <td style="white-space: nowrap;">
   ...
   <tr style="display: none;" > 
        <td style="white-space: nowrap;">
                 ...
                 <euc:EformHidden id="PhName_9" TABLE="NoTable" Field="PatientPhysicians_PhName_9" runat="server"/>
                <euc:EformTextBox Width="1px" style="display:none;"  RecordId="9"  ID="PtPhRole_9"   TABLE="PatientPhysicians" FIELD="PtPhRole" LookupCode="PtPhRole"  Runat="server"  /></td>
        <td style="white-space: nowrap;">
  ...
  <tr style="display: none;" > 
        <td style="white-space: nowrap;">
                 ...
                 <euc:EformHidden id="PatientId_10" TABLE="PatientPhysicians" Field="PatientId" RecordId="10" runat="server"/>
                 <euc:EformHidden id="PhName_10" TABLE="NoTable" Field="PatientPhysicians_PhName_10" runat="server"/>
                <euc:EformTextBox Width="1px" style="display:none;"  RecordId="10"  ID="PtPhRole_10"   TABLE="PatientPhysicians" FIELD="PtPhRole" LookupCode="PtPhRole"  Runat="server"  /></td>
        <td style="white-space: nowrap;">
...
<img alt="" src="../../Images/EFormAddARow.gif" hspace="0" width="117" height="16" border="0" class="ClickableImage" align="left"  onclick="return showFirstAdditionalRow(this,'PatientsPhysiciansReferringHtmlTable');" />
<br/><br/><br />