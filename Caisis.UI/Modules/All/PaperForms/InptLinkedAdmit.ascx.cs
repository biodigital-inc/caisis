namespace Caisis.UI.Modules.All.PaperForms
{
	...
	/// </summary>
	public partial class InptLinkedAdmit : BasePaperFormControl
	{
		...
		override protected void Page_Load(object sender, EventArgs e)
		{
			...
			if (patientMRN != null && patientMRN.Length > 0)
			{
				...
				if (!piDs.Tables[0].Rows.Count.Equals(0))
				{
					...
					InPatientAdmitReason = "Reason for Admission: " + piDs.Tables[0].Rows[0]["InPtAdmitReason"].ToString();
				}
		...
		{
			this._formName = "InptLinkedAdmit";
			this._formTitle = "Linked Admission Follow-Up & Discharge";
		}
