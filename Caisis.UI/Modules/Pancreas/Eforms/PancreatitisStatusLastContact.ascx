<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Pancreas.Eforms.PancreatitisStatusLastContact" CodeFile="PancreatitisStatusLastContact.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<table border="0" cellspacing="0" cellpadding="5" class="ClinicalEformTable" style="background-color:#FFFFFF" id="LastContact" >
  ...
  <tr id="NED_StatusRow" runat="server" >
    ...
    <td align="center" class="ClinicalEformPopulatedColumn" ><euc:EformCheckBox TABLE="NoTable"  FIELD="CurrentStatus_NED_11" Runat="server" ID="CurrentStatus_NED_11" Value="True"  EnableHiddenOnUIEvent="NED_Status,StatusDisease_11"/>&nbsp;
                                                             <euc:EformHidden Enabled="false" RecordId="11" TABLE="Status"  FIELD="StatusDisease" ID="StatusDisease_11" Value="Pancreatitis" Runat="server" />&nbsp;</td>
  ...
  <tr id="AWD_StatusRow" runat="server" >
    ...
    <td align="center" class="ClinicalEformPopulatedColumn" ><euc:EformCheckBox TABLE="NoTable"  FIELD="CurrentStatus_AWD_12" Runat="server" ID="CurrentStatus_AWD_12" Value="True"  EnableHiddenOnUIEvent="AWD_Status,StatusDisease_12"/>&nbsp;
                                                             <euc:EformHidden Enabled="false"  RecordId="12" TABLE="Status"  FIELD="StatusDisease" ID="StatusDisease_12" Value="Pancreatitis" Runat="server" />&nbsp;</td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
          <euc:EformTextBox Width="100px" RecordId="12" TABLE="Status" FIELD="StatusNotes" Runat="server" ID="StatusNotes_12" EnableHiddenOnUIEvent="NED_Status,StatusDisease_12" ShowTextEditor="true" /></td>
  </tr>
<tr id="AWD_Local_Recurrence_StatusRow" runat="server" >
    ...
    <td align="center" class="ClinicalEformPopulatedColumn" ><euc:EformCheckBox TABLE="NoTable"  FIELD="CurrentStatus_AWD_Local_Recurrence_13" Runat="server" ID="CurrentStatus_AWD_Local_Recurrence_13" Value="True" EnableHiddenOnUIEvent="AWD_Local_Recurrence_Status,StatusDisease_13" />&nbsp;
                                                             <euc:EformHidden Enabled="false"  RecordId="13" TABLE="Status"  FIELD="StatusDisease" ID="StatusDisease_13" Value="Pancreatitis" Runat="server" />&nbsp;</td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
          <euc:EformTextBox Width="100px" RecordId="13" TABLE="Status" FIELD="StatusNotes" Runat="server" ID="StatusNotes_13" EnableHiddenOnUIEvent="NED_Status,StatusDisease_13" ShowTextEditor="true" /></td>
  </tr>
<tr id="AWD_Distant_Metastasis_StatusRow" runat="server" >
    ...
    <td align="center" class="ClinicalEformPopulatedColumn" ><euc:EformCheckBox TABLE="NoTable"  FIELD="CurrentStatus_AWD_Distant_Metastasis_14" Runat="server" ID="CurrentStatus_AWD_Distant_Metastasis_14" Value="True" EnableHiddenOnUIEvent="AWD_Distant_Metastasis_Status,StatusDisease_14" />&nbsp;
                                                             <euc:EformHidden Enabled="false"  RecordId="14" TABLE="Status"  FIELD="StatusDisease" ID="StatusDisease_14" Value="Pancreatitis" Runat="server" />&nbsp;</td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
          <euc:EformTextBox Width="100px" RecordId="14" TABLE="Status" FIELD="StatusNotes" Runat="server" ID="StatusNotes_14" EnableHiddenOnUIEvent="NED_Status,StatusDisease_14" ShowTextEditor="true" /></td>
  </tr>
<tr id="AWD_Local_and_Metastasis_StatusRow" runat="server" >
    ...
    <td align="center" class="ClinicalEformPopulatedColumn" ><euc:EformCheckBox TABLE="NoTable"  FIELD="CurrentStatus_AWD_Local_and_Metastasis_15" Runat="server" ID="CurrentStatus_AWD_Local_and_Metastasis_15" Value="True"  EnableHiddenOnUIEvent="AWD_Local_and_Metastasis_Status,StatusDisease_15"/>&nbsp;
                                                             <euc:EformHidden Enabled="false"  RecordId="15" TABLE="Status"  FIELD="StatusDisease" ID="StatusDisease_15" Value="Pancreatitis" Runat="server" />&nbsp;</td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
          <euc:EformTextBox Width="100px" RecordId="15" TABLE="Status" FIELD="StatusNotes" Runat="server" ID="StatusNotes_15" EnableHiddenOnUIEvent="NED_Status,StatusDisease_15" ShowTextEditor="true" /></td>
</tr>
<%--<tr id="Lost_to_Follow_up_StatusRow" runat="server" >
    ...
    <td align="center" class="ClinicalEformPopulatedColumn" ><euc:EformCheckBox TABLE="NoTable"  FIELD="CurrentStatus_Lost_to_Follow_up_16" Runat="server" ID="CurrentStatus_Lost_to_Follow_up_16" Value="True"  EnableHiddenOnUIEvent="Lost_to_Follow_up_Status,StatusDisease_16"/>&nbsp;
                                                             <euc:EformHidden Enabled="false"  RecordId="16" TABLE="Status"  FIELD="StatusDisease" ID="StatusDisease_16" Value="Pancreatitis" Runat="server" />&nbsp;</td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
          <euc:EformTextBox Width="100px" RecordId="16" TABLE="Status" FIELD="StatusNotes" Runat="server" ID="StatusNotes_16" EnableHiddenOnUIEvent="NED_Status,StatusDisease_16" ShowTextEditor="true" /></td>
</tr>--%>
<tr id="DOC_StatusRow" runat="server" >
    <td height="32" class="ClinicalEformPopulatedColumn" >Death of Cancer (DOC)</td>
    <td class="ClinicalEformPopulatedColumn" ><asp:Label ID="DOC_DateLabel" Runat="server" />
	
		  <euc:EformHidden Enabled="false" id="DOC_Status" runat="server" RecordId="17" Table="Status" FIELD="Status"  Value="Death of Cancer"/>
		  <euc:EformHidden id="DOC_StatusDate" runat="server" RecordId="17" Table="Status" Field="StatusDate"/>
          <euc:EformTextBox ShowCalendar="true" CalcDate="true" style="width:90px;" TABLE="Status"  RecordId="17"  FIELD="StatusDateText" Runat="server" ID="DOC_StatusDateText" EnableHiddenOnUIEvent="DOC_Status,StatusDisease_17" />	</td>
    <td align="center" class="ClinicalEformPopulatedColumn" ><euc:EformCheckBox TABLE="NoTable"  FIELD="CurrentStatus_DOC_17" Runat="server" ID="CurrentStatus_DOC_17" Value="True"  EnableHiddenOnUIEvent="DOC_Status,StatusDisease_17"/>&nbsp;
                                                             <euc:EformHidden Enabled="false"  RecordId="17" TABLE="Status"  FIELD="StatusDisease" ID="StatusDisease_17" Value="Pancreatitis" Runat="server" />&nbsp;</td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
...
<tr id="Other1_StatusRow" runat="server" >
    ...
    <td align="center" class="ClinicalEformPopulatedColumn" ><euc:EformCheckBox TABLE="NoTable"  FIELD="CurrentStatus_Other1_18" Runat="server" ID="CurrentStatus_Other1_18" Value="True"  EnableHiddenOnUIEvent="StatusDisease_18"/>&nbsp;
                                                             <euc:EformHidden Enabled="false"  RecordId="18" TABLE="Status"  FIELD="StatusDisease" ID="StatusDisease_18" Value="Pancreatitis" Runat="server" />&nbsp;</td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
...
<tr id="Other2_StatusRow" runat="server" >
    ...
    <td align="center" class="ClinicalEformPopulatedColumn" ><euc:EformCheckBox TABLE="NoTable"  FIELD="CurrentStatus_Other2_19" Runat="server" ID="CurrentStatus_Other2_19" Value="True"  EnableHiddenOnUIEvent="StatusDisease_19"/>&nbsp;
                                                             <euc:EformHidden Enabled="false"  RecordId="19" TABLE="Status"  FIELD="StatusDisease" ID="StatusDisease_19" Value="Pancreatitis" Runat="server" />&nbsp;</td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
...
<tr id="Other3_StatusRow" runat="server" >
    ...
    <td align="center" class="ClinicalEformPopulatedColumn" ><euc:EformCheckBox TABLE="NoTable"  FIELD="CurrentStatus_Other3_20" Runat="server" ID="CurrentStatus_Other3_20" Value="True"  EnableHiddenOnUIEvent="StatusDisease_20"/>&nbsp;
                                                             <euc:EformHidden Enabled="false"  RecordId="20" TABLE="Status"  FIELD="StatusDisease" ID="StatusDisease_20" Value="Pancreatitis" Runat="server" />&nbsp;</td>
    <td align="center" class="ClinicalEformPopulatedColumn" >
