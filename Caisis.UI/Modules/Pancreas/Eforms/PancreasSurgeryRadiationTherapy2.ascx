<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Pancreas.Eforms.PancreasSurgeryRadiationTherapy2" CodeFile="PancreasSurgeryRadiationTherapy2.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="PancreasSurgeryRadiationTherapy2" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Radiation Therapy"></asp:Label><br/>
<table width="650" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="RadiationTherapyHtmlTable">
  ...
  <tr >
    ...
    <td><euc:EformSelect RecordId="11" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_11"/></td>
    ...
    <td><euc:EformSelect RecordId="12" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_12"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="13" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_13"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="14" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_14"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="15" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_15"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="16" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_16"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="17" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_17"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="18" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_18"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="19" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_19"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="20" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_20"/></td>
