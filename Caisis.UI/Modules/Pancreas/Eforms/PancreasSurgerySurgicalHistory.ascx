<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Pancreas.Eforms.PancreasSurgerySurgicalHistory" CodeFile="PancreasSurgerySurgicalHistory.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="PancreasSurgerySurgicalHistory" /><br/>

<table class="eformLargePopulatedTableBlue">
    <tr>
        <td>
            <span class="controlBoxTitle"><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Surgical History"></asp:Label>?</span></td>
        <td height="28">
...
<table width="550" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="SurgeriesHtmlTable">
  <tr> 
    ...
    <td class="controlBoxDataGridHeaderFirstCol" style="text-align: left; ">Surgery Type </td>
  ...
  <asp:Repeater ID="rptSurgicalHistory" Runat="server"  OnItemDataBound="ChronListItemDataBound"> 
	<ItemTemplate> 
		<tr id="SurgicalHistoryRow" runat="server"  class="ClinicalEformPopulatedRowNonClickable" > 
			<td class="ClinicalEformPopulatedColumn" style="text-align: left; ">&nbsp;<asp:Literal ID="ChronListDateField" Runat="server" /></td>
			<td class="ClinicalEformPopulatedColumn" style="text-align: left; "><%# DataBinder.Eval(Container.DataItem, "varName") %>&nbsp;</td>
			<td class="ClinicalEformPopulatedColumn" style="text-align: left; "><%# DataBinder.Eval(Container.DataItem, "varValue") %>&nbsp;</td>
		</tr>      
	</ItemTemplate>
  </asp:Repeater>
  
  <tr id="NoSurgicalHistoryMsgTr" runat="server"  class="ClinicalEformPopulatedRowNonClickable" > 
			<td colspan="3" class="ClinicalEformPopulatedColumn" align="center" height="40"> No prior surgical procedures have been recorded for this patient.</td>
  </tr> 
...
<table width="550" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="ProceduresHtmlTable">
  <tr> 
    <td class="controlBoxDataGridHeaderFirstCol" style="text-align: left;">&nbsp;Date</td>
    <td class="controlBoxDataGridHeaderFirstCol" style="text-align: left; ">Procedure Type </td>
...
<tr> 
    ...
    <td style="white-space: nowrap;">
                                      &nbsp;<euc:EformComboBox DropDownWidth="300px" Width="200px" Runat="server"   RecordId="1"  ID="ProcName_1"     Table="Procedures" Field="ProcName"    LookupCode="ProcName,Disease,@DiseaseView"    MaxLength="50"    />	</td>
    <td  style="white-space: nowrap;">&nbsp;<euc:EformTextBox  Runat="server"   RecordId="1"  ID="ProcNotes_1"    TABLE="Procedures" FIELD="ProcNotes"   ShowTextEditor ="true" CalcDate="False" style="width:190px;"  /></td>
    ...
    <td style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="300px" Width="200px"   LookupCode="ProcName,Disease,@DiseaseView"   Field="ProcName" RecordId="2" Table="Procedures" MaxLength="50"  Runat="server"   id="ProcName_2"  />	</td>
    <td  style="white-space: nowrap;">&nbsp;<euc:EformTextBox  RecordId="2" ShowTextEditor ="true" CalcDate="False" style="width:190px;" TABLE="Procedures" FIELD="ProcNotes" Runat="server"   ID="ProcNotes_2"/></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
  ...
  <tr > 
    ...
    <td style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox  DropDownWidth="300px" Width="200px"  LookupCode="ProcName,Disease,@DiseaseView"   Field="ProcName" RecordId="3" Table="Procedures" MaxLength="50"  Runat="server"   id="ProcName_3"  />	</td>
    <td  style="white-space: nowrap;">&nbsp;<euc:EformTextBox  RecordId="3" ShowTextEditor ="true" CalcDate="False" style="width:190px;" TABLE="Procedures" FIELD="ProcNotes" Runat="server"   ID="ProcNotes_3"/></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
  <tr style="DISPLAY: none"> 
    ...
    <td style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="300px" Width="200px"   LookupCode="ProcName,Disease,@DiseaseView"   Field="ProcName" RecordId="4" Table="Procedures" MaxLength="50"  Runat="server"   id="ProcName_4"  />	</td>
    <td  style="white-space: nowrap;">&nbsp;<euc:EformTextBox  RecordId="4" ShowTextEditor ="true" CalcDate="False" style="width:190px;" TABLE="Procedures" FIELD="ProcNotes" Runat="server"   ID="ProcNotes_4"/></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
  <tr style="DISPLAY: none"> 
    ...
    <td style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="300px" Width="200px"   LookupCode="ProcName,Disease,@DiseaseView"   Field="ProcName" RecordId="5" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_5"  />	</td>
    <td  style="white-space: nowrap;">&nbsp;<euc:EformTextBox  RecordId="5" ShowTextEditor ="true" CalcDate="False" style="width:190px;" TABLE="Procedures" FIELD="ProcNotes" Runat="server"   ID="ProcNotes_5"/></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
  <tr style="DISPLAY: none"> 
    ...
    <td style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="300px" Width="200px"   LookupCode="ProcName,Disease,@DiseaseView"   Field="ProcName" RecordId="6" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_6"  />	</td>
    <td  style="white-space: nowrap;">&nbsp;<euc:EformTextBox  RecordId="6" ShowTextEditor ="true" CalcDate="False" style="width:190px;" TABLE="Procedures" FIELD="ProcNotes" Runat="server"   ID="ProcNotes_6"/></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
  <tr style="DISPLAY: none"> 
    ...
    <td style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox  DropDownWidth="300px" Width="200px"  LookupCode="ProcName,Disease,@DiseaseView"   Field="ProcName" RecordId="7" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_7"  />	</td>
    <td  style="white-space: nowrap;">&nbsp;<euc:EformTextBox  RecordId="7" ShowTextEditor ="true" CalcDate="False" style="width:190px;" TABLE="Procedures" FIELD="ProcNotes" Runat="server"   ID="ProcNotes_7"/></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
  <tr style="DISPLAY: none"> 
    ...
    <td style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="300px" Width="200px"   LookupCode="ProcName,Disease,@DiseaseView"   Field="ProcName" RecordId="8" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_8"  />	</td>
    <td  style="white-space: nowrap;">&nbsp;<euc:EformTextBox  RecordId="8" ShowTextEditor ="true" CalcDate="False" style="width:190px;" TABLE="Procedures" FIELD="ProcNotes" Runat="server"   ID="ProcNotes_8"/></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
  <tr style="DISPLAY: none"> 
    ...
    <td style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="300px" Width="200px"   LookupCode="ProcName,Disease,@DiseaseView"   Field="ProcName" RecordId="9" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_9"  />	</td>
    <td  style="white-space: nowrap;">&nbsp;<euc:EformTextBox  RecordId="9" ShowTextEditor ="true" CalcDate="False" style="width:190px;" TABLE="Procedures" FIELD="ProcNotes" Runat="server"   ID="ProcNotes_9"/></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
  <tr style="DISPLAY: none"> 
    ...
    <td style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="300px" Width="200px"   LookupCode="ProcName,Disease,@DiseaseView"   Field="ProcName" RecordId="10" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_10"  />	</td>
    <td  style="white-space: nowrap;">&nbsp;<euc:EformTextBox  RecordId="10" ShowTextEditor ="true" CalcDate="False" style="width:190px;" TABLE="Procedures" FIELD="ProcNotes" Runat="server"   ID="ProcNotes_10"/></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
</table>
...
<script type="text/javascript">
    ...
    function SurgicalHxRadioClick(SurgicalHxoption_value,SurgicalHxhideDiv,SurgicalHxhideAbsentDiv,procDateTextID,procDateID,procNameID,procNotesID)
    {
      ...
      else if (SurgicalHxoption_value == "No" || SurgicalHxoption_value == "Unknown" || SurgicalHxoption_value == "N/A")
      {
        ...
        else if (SurgicalHxoption_value == "Unknown")       
            document.getElementById('<%= AbsentReason_2.ClientID %>').value = 'Unknown';
        else if (SurgicalHxoption_value == "N/A")
            document.getElementById('<%= AbsentReason_2.ClientID %>').value = 'Not Applicable';


        document.getElementById('<%= AbsentEventPrefix.ClientID %>').innerHTML = document.getElementById('<%= AbsentReason_2.ClientID %>').value + ' as of ';
