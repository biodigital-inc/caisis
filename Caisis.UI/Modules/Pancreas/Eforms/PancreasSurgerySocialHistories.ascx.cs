namespace Caisis.UI.Modules.Pancreas.Eforms
{
	...
	/// <summary>
    ///		Summary description for PancreasSurgerySocialHistories.
	/// </summary>
    public partial class PancreasSurgerySocialHistories : BaseEFormControl
	{
		...
		override protected void Page_Load(object sender, System.EventArgs e)
		{
            ...
            // for now, hide occupation, marital status, and num of children
            rowNoHx1.Visible = false;
            rowHasHx1.Visible = false;

            // never show no data msg for now
        ...
        protected void BuildSocialHistory(int PatientID, string FormName, string FormType)
        {
            ...
            if (socialHxDs.Tables.Count > 0 && socialHxDs.Tables[0].Rows.Count > 0)
            {
                ...
                rowHasHx4.DataBind();
                rowHasHx5.DataSource = socialHxDs.Tables[0].DefaultView;
                rowHasHx5.DataBind();
            }
            else
            {
