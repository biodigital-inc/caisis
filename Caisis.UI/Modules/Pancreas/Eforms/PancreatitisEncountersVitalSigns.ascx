<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Pancreas.Eforms.PancreatitisEncountersVitalSigns" CodeFile="PancreatitisEncountersVitalSigns.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>
<link href="../../../StyleSheets/EformStyles.css" rel="stylesheet" type="text/css"/>

<a name="PancreatitisEncountersVitalSigns" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Vital Signs"></asp:Label><br/>
...
<a name="PancreatitisWeightHistory" /><span class="controlBoxTitle">Weight History</span><br/>
...
<table border="0" cellpadding="6" cellspacing="0" class="eformLargePopulatedTable" id="WeightHistoryHtmlTable" > 
          ...
          <tr>
           ...
           <tr>
            <td valign="top" style="white-space: nowrap;">
                <asp:Label ID="QuestionNum_2" runat="server" Text="2" />.&nbsp;&nbsp;<asp:Label ID="Question_2" runat="server" Text="Weight prior to admission  (kg)" />   
           ...
           <tr>
            <td valign="top" style="white-space: nowrap;">
                 <asp:Label ID="QuestionNum_3" runat="server" Text="3" />.&nbsp;&nbsp;<asp:Label ID="Question_3" runat="server" Text="Weight on admission  (kg)" />   
            ...
            <tr>
            <td valign="top" style="white-space: nowrap;">
                <asp:Label ID="QuestionNum_4" runat="server" Text="4" />.&nbsp;&nbsp;<asp:Label ID="Question_4" runat="server" Text="Lowest weight during illness  (kg)" />   
