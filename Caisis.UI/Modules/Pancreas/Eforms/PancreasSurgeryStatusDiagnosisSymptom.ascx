<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Pancreas.Eforms.PancreasSurgeryStatusDiagnosisSymptom" CodeFile="PancreasSurgeryStatusDiagnosisSymptom.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="PancreasSurgeryStatusDiagnosisSymptom" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Diagnosis Date"></asp:Label><br/>
