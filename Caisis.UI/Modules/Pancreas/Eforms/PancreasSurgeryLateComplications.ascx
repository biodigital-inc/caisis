<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Pancreas.Eforms.PancreasSurgeryLateComplications" CodeFile="PancreasSurgeryLateComplications.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>
<script language="javascript">
	tableArray.ComplicationsHtmlTable = "ComplicationsHtmlTable";
</script>
<link href="../../../StyleSheets/EformStyles.css" rel="stylesheet" type="text/css">
<a name="PancreasSurgeryLateComplications" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text=""></asp:Label><br/>
...
<table width="650" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="ComplicationsHtmlTable">
  ...
  <tr >
    ...
    <td style="white-space:nowrap;"><euc:EformComboBox DropDownWidth="auto"  LookupCode="ToxName_Complication,Disease,@DiseaseView"   RefBy="ToxName" style="width:150;" Field="ToxName" RecordId="1" Table="Toxicities" Runat="server" id="ToxName_1"  /></td>
    <td align="center"><euc:EformTextBox RecordId="1" ShowTextEditor="True" style="width:230px;" TABLE="Toxicities" FIELD="ToxNotes" Runat="server" ID="ToxNotes_1"/></td>
  ...
  <tr >
    ...
    <td style="white-space:nowrap;"><euc:EformComboBox DropDownWidth="auto"  LookupCode="ToxName_Complication,Disease,@DiseaseView"   RefBy="ToxName" style="width:150;" Field="ToxName" RecordId="2" Table="Toxicities" Runat="server" id="ToxName_2"  /></td>
    <td align="center"><euc:EformTextBox RecordId="2" ShowTextEditor="True" style="width:230px;" TABLE="Toxicities" FIELD="ToxNotes" Runat="server" ID="ToxNotes_2"/></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr style="DISPLAY: none">
    ...
    <td style="white-space:nowrap;"><euc:EformComboBox DropDownWidth="auto"  LookupCode="ToxName_Complication,Disease,@DiseaseView"   RefBy="ToxName" style="width:150;" Field="ToxName" RecordId="3" Table="Toxicities" Runat="server" id="ToxName_3"  /></td>
    <td align="center"><euc:EformTextBox RecordId="3" ShowTextEditor="True" style="width:230px;" TABLE="Toxicities" FIELD="ToxNotes" Runat="server" ID="ToxNotes_3"/></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr style="DISPLAY: none">
    ...
    <td style="white-space:nowrap;"><euc:EformComboBox DropDownWidth="auto"  LookupCode="ToxName_Complication,Disease,@DiseaseView"   RefBy="ToxName" style="width:150;" Field="ToxName" RecordId="4" Table="Toxicities" Runat="server" id="ToxName_4"  /></td>
    <td align="center"><euc:EformTextBox RecordId="4" ShowTextEditor="True" style="width:230px;" TABLE="Toxicities" FIELD="ToxNotes" Runat="server" ID="ToxNotes_4"/></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr style="DISPLAY: none">
    ...
    <td style="white-space:nowrap;"><euc:EformComboBox DropDownWidth="auto"  LookupCode="ToxName_Complication,Disease,@DiseaseView"   RefBy="ToxName" style="width:150;" Field="ToxName" RecordId="5" Table="Toxicities" Runat="server" id="ToxName_5"  /></td>
    <td align="center"><euc:EformTextBox RecordId="5" ShowTextEditor="True" style="width:230px;" TABLE="Toxicities" FIELD="ToxNotes" Runat="server" ID="ToxNotes_5"/></td>
...
<script type="text/javascript">
    ...
    function IntraOpCompRadioClick(IntraOpCompoption_value,IntraOpComphideDiv,IntraOpComphideAbsentDiv,toxDateTextID,toxDateID,toxNameID,toxNotesID)
    {
      ...
      else if (IntraOpCompoption_value == "No" || IntraOpCompoption_value == "Unknown" || IntraOpCompoption_value == "N/A")
      {
        ...
        else if (IntraOpCompoption_value == "Unknown")       
            document.getElementById('<%= AbsentReason_5.ClientID %>').value = 'Unknown';
        else if (IntraOpCompoption_value == "N/A")
