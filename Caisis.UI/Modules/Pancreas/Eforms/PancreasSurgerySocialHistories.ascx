<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Pancreas.Eforms.PancreasSurgerySocialHistories" CodeFile="PancreasSurgerySocialHistories.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>


<link href="../../../StyleSheets/EformStyles.css" rel="stylesheet" type="text/css"/>

<a name="PancreasSurgerySocialHistories" /><br/>
   ...
   <tr><td><br /></td></tr>
    ...
    <tr>
        <td>
           ...
           <!-- ********************** Row One ********************** -->
                  <tr ID="rowNoHxHeader1" runat="server" style="display: none;" > 
               ...
               <asp:Repeater ID="rowHasHx1" runat="server"  OnItemDataBound="EFormRepeaterOnDataBound" > 
                <ItemTemplate>
                  ...
                  <tr ID="rowNoHx1" runat="server"> 
                    ...
                    <td height="28" ><euc:EformComboBox  DropDownWidth="300px" style="width:100px;" TABLE="SocialHistories" FIELD="SocHxMaritalStatus" ID="SocHxMaritalStatus" RecordID="1"   Runat="server" TabIndex="2" LookupCode="SocHxMaritalStatus" /></td>
            ...
            <!-- ********************** Row Two ********************** -->                 
                  ...
                  <tr ID="rowNoHx2" runat="server"> 
                    <td height="28" ><euc:EformComboBox DropDownWidth="300px" style="width:100px;" TABLE="SocialHistories" FIELD="SocHxTobaccoType"        ID="SocHxTobaccoType"        RecordID="1"  Runat="server" LookupCode="SocHxTobaccoType,Disease,@DiseaseView" /></td>
                    ...
                    <td height="28" ><euc:EformTextBox style="width:100px;"  TABLE="SocialHistories" FIELD="SocHxTobaccoQuitYear"   ID="SocHxTobaccoQuitYear"    RecordID="1"  Runat="server"  /></td>    
                    <td></td>
                  </tr>

            <!-- ********************** Row Five ********************** -->
                  <tr> 
                    <td colspan="4" class="controlBoxDataGridHeaderFirstCol" style="text-align: left; white-space:nowrap;"  >&nbsp;Other Tobacco Usage</td> 
                  </tr>
                   <asp:Repeater ID="rowHasHx5" runat="server"  OnItemDataBound="EFormRepeaterOnDataBound" > 
                    <ItemTemplate>
	                    <tr class="ClinicalEformPopulatedRow" onmouseover="this.className='ClinicalEformHighlightedRow';" onmouseout="this.className='ClinicalEformPopulatedRow';"   onclick="LoadDataEntryForm('SocialHistories',  <%# DataBinder.Eval(Container.DataItem, "PatientId") %>, 'SocHxOccupation,SocHxMaritalStatus,SocHxChildren,SocHxTobaccoType,SocHxTobaccoPacksPerDay,SocHxTobaccoYears,SocHxTobaccoQuitYear,SocHxAlcohol,SocHxAlcoholDrinksPerDay,SocHxAlcoholYears,SocHxAlcoholQuitYear,SocHxOther,SocHxCarcinogen,SocHxNotes', 'SocialHistories');"> 
	                       <td colspan="3" class="ClinicalEformPopulatedColumn">&nbsp;<%# DataBinder.Eval(Container.DataItem, "SocHxCarcinogen")%></td>
                  ...
                  <tr ID="rowNoHx5" runat="server"> 
                    <td  colspan="4" height="28" ><euc:EformComboBox DropDownWidth="300px" style="width:100px;"  TABLE="SocialHistories" FIELD="SocHxOther" ID="SocHxOther" RecordID="1"  Runat="server" LookupCode="SocHxTobaccoType,Disease,@DiseaseView" /></td>    
                 </tr>
           ...
           <!-- ********************** Row Three ********************** -->
                  ...
                  <tr ID="rowNoHx3" runat="server"> 
                    <td height="28" ><euc:EformComboBox DropDownWidth="300px" style="width:100px;" TABLE="SocialHistories" FIELD="SocHxAlcohol"    ID="SocHxAlcohol"    RecordID="1"  Runat="server" LookupCode="AlcoholUsage,Disease,@DiseaseView"  /></td>
            ...
            <!-- ********************** Row Four ********************** -->
                  <tr> 
                    <td colspan="4" class="controlBoxDataGridHeaderFirstCol" style="text-align: left; white-space:nowrap;" >Notes</td>                              
                  </tr>
                   <asp:Repeater ID="rowHasHx4" runat="server"  OnItemDataBound="EFormRepeaterOnDataBound" > 
                    <ItemTemplate>
	                    <tr class="ClinicalEformPopulatedRow" onmouseover="this.className='ClinicalEformHighlightedRow';" onmouseout="this.className='ClinicalEformPopulatedRow';"   onclick="LoadDataEntryForm('SocialHistories',  <%# DataBinder.Eval(Container.DataItem, "PatientId") %>, 'SocHxOccupation,SocHxMaritalStatus,SocHxChildren,SocHxTobaccoType,SocHxTobaccoPacksPerDay,SocHxTobaccoYears,SocHxTobaccoQuitYear,SocHxAlcohol,SocHxAlcoholDrinksPerDay,SocHxAlcoholYears,SocHxAlcoholQuitYear,SocHxOther,SocHxCarcinogen,SocHxNotes', 'SocialHistories');"> 
	                       <td colspan="3" class="ClinicalEformPopulatedColumn">&nbsp;<%# DataBinder.Eval(Container.DataItem, "SocHxNotes")%></td>
	                       <td class="ClinicalEformPopulatedColumn"><img alt="" align="right" src="../../../Images/EformPopulatedRowLOCK.gif" width="9" height="11" id="Img2" runat="server" title="This record has been locked."/>&nbsp;</td>
	                    </tr>  
                    </ItemTemplate>
                  </asp:Repeater>
                  <tr ID="rowNoHx4" runat="server"> 
                     <td colspan="4" height="28" ><euc:EformTextBox Width="95%"  TABLE="SocialHistories" FIELD="SocHxNotes" ID="SocHxNotes" RecordID="1"  Runat="server" ShowTextEditor="true" /></td>    
                 </tr>
...
<script type="text/javascript">
    ...
    function SocialHxRadioClick(SocialHxoption_value,SocialHxhideDiv,SocialHxhideAbsentDiv)
    {
      ...
      else if (SocialHxoption_value == "No" || SocialHxoption_value == "Unknown")
      {
        ...
        document.getElementById('<%= AbsentEventPrefix.ClientID %>').innerHTML = document.getElementById('<%= AbsentReason_10.ClientID %>').value + ' as of ';
