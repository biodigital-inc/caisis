<%@ Control Language="c#" Inherits="Caisis.UI.Modules.All.Eforms.PancreasSurgeryStatusRestaging" CodeFile="PancreasSurgeryStatusRestaging.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="PancreasSurgeryStatusRestaging" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Restaging"></asp:Label><br/>
