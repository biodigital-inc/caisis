namespace Caisis.UI.Modules.Bone.Eforms
{
	...
	/// <summary>
    ///		Summary description for PancreasProblemsAndPlans.
	/// </summary>
    public partial class PancreasProblemsAndPlans : BaseEFormControl
	{
		...
		protected void setPastProblemsVisibility()
		{
            ...
            if (ProblemName_1.Text.Length > 0 )
            {
		...
		protected void BuildCommonProblems()
		{
            ...
            DataTable lDt = lDa.GetLookupCodes("Problem,Disease,Pancreas");
		...
		{
			LookupCodeDa lDa = new LookupCodeDa();
            DataTable lDt = lDa.GetLookupCodes("ProblemPlan,Disease,Pancreas");
