<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Pancreas.Eforms.PancreatitisSocialHistories" CodeFile="PancreatitisSocialHistories.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>


<link href="../../../StyleSheets/EformStyles.css" rel="stylesheet" type="text/css"/>

<a name="PancreatitisSocialHistories" /><br/>
    ...
    <tr>
        <td>
           ...
           <!-- ********************** Row One ********************** -->
            ...
            <!-- ********************** Row Two ********************** -->                 
                  ...
                  <tr ID="rowNoHx2" runat="server"> 
                    <td height="28" ><euc:EformComboBox DropDownWidth="300px" style="width:100px;" TABLE="SocialHistories" FIELD="SocHxTobaccoType"        ID="SocHxTobaccoType"        RecordID="1"  Runat="server" LookupCode="SocHxTobaccoType" /></td>
           ...
           <!-- ********************** Row Three ********************** -->
            ...
            <!-- ********************** Row Four ********************** -->
                  <tr> 
                    <td class="controlBoxDataGridHeaderFirstCol" style="text-align: left; white-space:nowrap;" >&nbsp;Other Usage</td> 
                    <td class="controlBoxDataGridHeaderFirstCol" style="text-align: left;">Carcinogen Exposure</td>
                  ...
                  <tr ID="rowNoHx4" runat="server"> 
                    <td height="28" ><euc:EformComboBox DropDownWidth="300px" style="width:100px;"  TABLE="SocialHistories" FIELD="SocHxOther" ID="SocHxOther" RecordID="1"  Runat="server" LookupCode="SocHxOther,Disease,@DiseaseView" /></td>    
                    <td height="28" ><euc:EformTextBox style="width:100px;"  TABLE="SocialHistories" FIELD="SocHxCarcinogen" ID="SocHxCarcinogen" RecordID="1"  Runat="server"  /></td>    
                     <td height="28" ><euc:EformTextBox style="width:100px;"  TABLE="SocialHistories" FIELD="SocHxNotes" ID="SocHxNotes" RecordID="1"  Runat="server" ShowTextEditor="true" /></td>    
                 </tr>
