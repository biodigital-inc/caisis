<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Bone.Eforms.PancreasProblemsAndPlans" CodeFile="PancreasProblemsAndPlans.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="PancreasProblemsAndPlans" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Problems and Plans"></asp:Label><br/>
...
<div style="position: relative" >
 <strong>Click the <img src="../../Images/OpenPicker_red.gif" width="14" height="20"  /> button below to select a Diagnosis and corresponding plan(s).</strong>
 <br /><br />
</div>
