<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Pancreas.Eforms.PancreasSurgeryRadiationTherapy" CodeFile="PancreasSurgeryRadiationTherapy.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="PancreasSurgeryRadiationTherapy" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Radiation Therapy"></asp:Label><br/>
<table width="700" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="RadiationTherapyHtmlTable">
  ...
  <tr >
    ...
    <td><euc:EformSelect RecordId="1" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_1"/></td>
    ...
    <td><euc:EformSelect RecordId="2" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_2"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="3" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_3"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="4" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_4"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="5" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_5"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="6" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_6"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="7" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_7"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="8" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_8"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="9" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_9"/></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td><euc:EformSelect RecordId="10" LookupCode="RadTxType,Disease,@DiseaseView" TABLE="RadiationTherapy" FIELD="RadTxType" Runat="server" ID="RadTxType_10"/></td>
