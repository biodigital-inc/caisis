<%@ Control Language="c#" Inherits="Caisis.UI.Modules.GI.Eforms.EsophagusSurgeryHistoryofCancer" CodeFile="EsophagusSurgeryHistoryofCancer.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>

<link href="../../../StyleSheets/EformStyles.css" rel="stylesheet" type="text/css">


<a name="EsophagusSurgeryHistoryofCancer" /><br/>
    ...
    <table class="eformLargePopulatedTable">
        <tr>
           ...
           <td height="28" ><strong> Date </strong>
            <euc:EformTextBox RecordId="20" Table="AbsentEvents" Field="AbsentDateText" ID="AbsentDateText_20"
                runat="server" Width="100px" ShowCalendar="true" CalcDate="true" />
            <euc:EformTextBox RecordId="20" TABLE="AbsentEvents" FIELD="AbsentDate" ID="AbsentDate_20"
...
<div id="CancerHxDiv" runat="server" style="display: none;">
 <br /><br />  
<table cellpadding="3" cellspacing="0" class="eformLargePopulatedTableBlue" id="CancerHxHtmlTable">
...
<table >
    <tr id="ComorbAbsentRow">
        <td>
            <euc:EformTextBox RecordId="20" Table="AbsentEvents" Field="TableName" ID="TableName_20"
                runat="server" Width="1px" Style="display: none;" />
            <euc:EformTextBox RecordId="20" Table="AbsentEvents" Field="FieldName" ID="FieldName_20"
                runat="server" Width="1px" Style="display: none;" />
            <euc:EformTextBox RecordId="20" Table="AbsentEvents" Field="FieldValue" ID="FieldValue_20"
                runat="server" Width="1px" Style="display: none;" />
            <euc:EformTextBox RecordId="20" Table="AbsentEvents" Field="AbsentReason" ID="AbsentReason_20"
                runat="server" Width="1px" Style="display: none;" />
            <euc:EformTextBox RecordId="20" Table="AbsentEvents" Field="AbsentQuality" ID="AbsentQuality_20"
            runat="server" Width="1px" Style="display: none;" />
        </td>
    </tr>
</table>
...
<script type="text/javascript">
    ...
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_81.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_82.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_83.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_84.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_85.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_86.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_87.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_88.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_89.ClientID %>'));

    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_90.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_91.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_92.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_93.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_94.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_95.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_96.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_97.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_98.ClientID %>'));
    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_99.ClientID %>'));

    addEventPHC($('<%= CancerHxRecorded.ClientID %>'),$('<%= CancerHxDiv.ClientID %>'),$('<%= CancerHxAbsentDiv.ClientID %>'),$('<%= Comorbidity_100.ClientID %>'));

    function addEventPHC(CancerHxRecordedID,CancerHxDivID,CancerHxAbsentDivID,comorbidityID)
    {  
        $(CancerHxRecordedID).addEvent('click',curry(PHCYesNo,CancerHxRecordedID,CancerHxDivID,CancerHxAbsentDivID,comorbidityID));
        if (comorbidityID.type == 'checkbox') 
            $(comorbidityID).addEvent('click',curry(PHCYesNo,CancerHxRecordedID,CancerHxDivID,CancerHxAbsentDivID,comorbidityID));
        else if (comorbidityID.type == 'text') 
            $(comorbidityID).addEvent('blur',curry(PHCYesNo,CancerHxRecordedID,CancerHxDivID,CancerHxAbsentDivID,comorbidityID));

        // check on load as well
        PHCYesNo(CancerHxRecordedID,CancerHxDivID,CancerHxAbsentDivID,comorbidityID);
    }
   
    /* ]]> */
   
    function PHCYesNo(CancerHxRecordedID,CancerHxDivID,CancerHxAbsentDivID,comorbidityID)
    {
       ...
       for (var i = 0; i < CancerHxRecordedRef.length; i++) 
        if (CancerHxRecordedRef[i].checked) {  
            PHCRadioClick(CancerHxRecordedRef[i].value,CancerHxDivID,CancerHxAbsentDivID,comorbidityID);
            }
    }
    
    function PHCRadioClick(PHCoption_value,PHChideDiv,PHChideAbsentDiv,comorbidityID)
    {
      if (PHCoption_value == "Yes")
      { 
        PHChideDiv.style.display='block';
        PHChideAbsentDiv.style.display='none';
       
        document.getElementById('<%= AbsentDateText_20.ClientID %>').value='';
        document.getElementById('<%= AbsentDate_20.ClientID %>').value='';
        document.getElementById('<%= TableName_20.ClientID %>').value = '';        
        document.getElementById('<%= FieldName_20.ClientID %>').value = '';        
        document.getElementById('<%= FieldValue_20.ClientID %>').value = '';        
        document.getElementById('<%= AbsentReason_20.ClientID %>').value = '';        
        document.getElementById('<%= AbsentQuality_20.ClientID %>').value = '';
        
      }
      else if (PHCoption_value == "No" || PHCoption_value == "Unknown" || PHCoption_value == "N/A")
      {
        PHChideAbsentDiv.style.display='block';
        PHChideDiv.style.display='none';
      
        document.getElementById('<%= TableName_20.ClientID %>').value = 'Comorbidities';        
        document.getElementById('<%= FieldName_20.ClientID %>').value = 'Comorbidity';        
        document.getElementById('<%= FieldValue_20.ClientID %>').value = 'Personal history of cancer'; 
        
        if (PHCoption_value == "No")       
            document.getElementById('<%= AbsentReason_20.ClientID %>').value = 'None Recorded';        
        else if (PHCoption_value == "Unknown")       
            document.getElementById('<%= AbsentReason_20.ClientID %>').value = 'Unknown';
        else if (PHCoption_value == "N/A")
            document.getElementById('<%= AbsentReason_20.ClientID %>').value = 'Not Applicable';

        document.getElementById('<%= AbsentEventPrefix.ClientID %>').innerHTML = document.getElementById('<%= AbsentReason_20.ClientID %>').value + ' as of ';

        document.getElementById('<%= AbsentQuality_20.ClientID %>').value = 'OUT';        
