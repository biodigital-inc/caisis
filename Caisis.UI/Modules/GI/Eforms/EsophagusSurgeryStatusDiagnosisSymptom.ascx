<%@ Control Language="c#" Inherits="Caisis.UI.Modules.GI.Eforms.EsophagusSurgeryStatusDiagnosisSymptom" CodeFile="EsophagusSurgeryStatusDiagnosisSymptom.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="EsophagusSurgeryStatusDiagnosisSymptom" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Diagnosis Date"></asp:Label><br/>
...
<script type="text/javascript">
    ...
    function SetHiddenFields(statusDateText, statusDate, statusDisease, status, statusValue) {
        ...
        if (statusDateText.value != '') {
            ...
            statusDisease.value = 'Esophageal Cancer';
        }
        else {
            status.value = '';
            statusDisease.value = '';
