<%@ Control Language="c#" Inherits="Caisis.UI.Modules.GI.Eforms.EsophagusSurgeryStatusSubsequentMetastases" CodeFile="EsophagusSurgeryStatusSubsequentMetastases.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="EsophagusSurgeryStatusSubsequentMetastases" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Subsequent Metastases"></asp:Label><br/>
