<%@ Control Language="c#" Inherits="Caisis.UI.Modules.GI.Eforms.EsophagusSurgeryStatusLastContact" CodeFile="EsophagusSurgeryStatusLastContact.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="EsophagusSurgeryStatusLastContact" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Contact Status"></asp:Label><br/>
