<%@ Control Language="c#" Inherits="Caisis.UI.Modules.GI.Eforms.EsophagusSurgerySurgicalHistory" CodeFile="EsophagusSurgerySurgicalHistory.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="EsophagusSurgerySurgicalHistory" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text=""></asp:Label><br/>
...
<tr> 
    ...
    <td align="center"  style="white-space: nowrap;">
                                      &nbsp;<euc:EformComboBox DropDownWidth="auto" Runat="server"   RecordId="1"  ID="ProcName_1"     Table="Procedures" Field="ProcName"    LookupCode="ProcName,Disease,@DiseaseView"  style="width:150;"  MaxLength="50"    />	</td>
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="auto"   LookupCode="ProcName,Disease,@DiseaseView"  style="width:150;" Field="ProcName" RecordId="2" Table="Procedures" MaxLength="50"  Runat="server"   id="ProcName_2"  />	</td>
  ...
  <tr > 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox  DropDownWidth="auto"  LookupCode="ProcName,Disease,@DiseaseView"  style="width:150;" Field="ProcName" RecordId="3" Table="Procedures" MaxLength="50"  Runat="server"   id="ProcName_3"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="auto"   LookupCode="ProcName,Disease,@DiseaseView"  style="width:150;" Field="ProcName" RecordId="4" Table="Procedures" MaxLength="50"  Runat="server"   id="ProcName_4"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="auto"   LookupCode="ProcName,Disease,@DiseaseView"  style="width:150;" Field="ProcName" RecordId="5" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_5"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="auto"   LookupCode="ProcName,Disease,@DiseaseView"  style="width:150;" Field="ProcName" RecordId="6" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_6"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox  DropDownWidth="auto"  LookupCode="ProcName,Disease,@DiseaseView"  style="width:150;" Field="ProcName" RecordId="7" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_7"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="auto"   LookupCode="ProcName,Disease,@DiseaseView"  style="width:150;" Field="ProcName" RecordId="8" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_8"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="auto"   LookupCode="ProcName,Disease,@DiseaseView"  style="width:150;" Field="ProcName" RecordId="9" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_9"  />	</td>
  ...
  <tr style="DISPLAY: none"> 
    ...
    <td align="center"  style="white-space: nowrap;">&nbsp;
	<euc:EformComboBox DropDownWidth="auto"   LookupCode="ProcName,Disease,@DiseaseView"  style="width:150;" Field="ProcName" RecordId="10" Table="Procedures" MaxLength="50" Runat="server"   id="ProcName_10"  />	</td>
...
<script type="text/javascript">
    ...
    addEventSH($('<%= SurgicalHxRecorded.ClientID %>'),$('<%= SurgicalHxDiv.ClientID %>'),$('<%= SurgicalHxAbsentDiv.ClientID %>'),$('<%= ProcDateText_1.ClientID %>'),$('<%= ProcDate_1.ClientID %>'),$('<%= ProcName_1.ClientID %>'),$('<%= ProcNotes_1.ClientID %>'));
    addEventSH($('<%= SurgicalHxRecorded.ClientID %>'),$('<%= SurgicalHxDiv.ClientID %>'),$('<%= SurgicalHxAbsentDiv.ClientID %>'),$('<%= ProcDateText_2.ClientID %>'),$('<%= ProcDate_2.ClientID %>'),$('<%= ProcName_2.ClientID %>'),$('<%= ProcNotes_2.ClientID %>'));
    addEventSH($('<%= SurgicalHxRecorded.ClientID %>'),$('<%= SurgicalHxDiv.ClientID %>'),$('<%= SurgicalHxAbsentDiv.ClientID %>'),$('<%= ProcDateText_3.ClientID %>'),$('<%= ProcDate_3.ClientID %>'),$('<%= ProcName_3.ClientID %>'),$('<%= ProcNotes_3.ClientID %>'));
    addEventSH($('<%= SurgicalHxRecorded.ClientID %>'),$('<%= SurgicalHxDiv.ClientID %>'),$('<%= SurgicalHxAbsentDiv.ClientID %>'),$('<%= ProcDateText_4.ClientID %>'),$('<%= ProcDate_4.ClientID %>'),$('<%= ProcName_4.ClientID %>'),$('<%= ProcNotes_4.ClientID %>'));
    addEventSH($('<%= SurgicalHxRecorded.ClientID %>'),$('<%= SurgicalHxDiv.ClientID %>'),$('<%= SurgicalHxAbsentDiv.ClientID %>'),$('<%= ProcDateText_5.ClientID %>'),$('<%= ProcDate_5.ClientID %>'),$('<%= ProcName_5.ClientID %>'),$('<%= ProcNotes_5.ClientID %>'));
    addEventSH($('<%= SurgicalHxRecorded.ClientID %>'),$('<%= SurgicalHxDiv.ClientID %>'),$('<%= SurgicalHxAbsentDiv.ClientID %>'),$('<%= ProcDateText_6.ClientID %>'),$('<%= ProcDate_6.ClientID %>'),$('<%= ProcName_6.ClientID %>'),$('<%= ProcNotes_6.ClientID %>'));
    addEventSH($('<%= SurgicalHxRecorded.ClientID %>'),$('<%= SurgicalHxDiv.ClientID %>'),$('<%= SurgicalHxAbsentDiv.ClientID %>'),$('<%= ProcDateText_7.ClientID %>'),$('<%= ProcDate_7.ClientID %>'),$('<%= ProcName_7.ClientID %>'),$('<%= ProcNotes_7.ClientID %>'));
    addEventSH($('<%= SurgicalHxRecorded.ClientID %>'),$('<%= SurgicalHxDiv.ClientID %>'),$('<%= SurgicalHxAbsentDiv.ClientID %>'),$('<%= ProcDateText_8.ClientID %>'),$('<%= ProcDate_8.ClientID %>'),$('<%= ProcName_8.ClientID %>'),$('<%= ProcNotes_8.ClientID %>'));
    addEventSH($('<%= SurgicalHxRecorded.ClientID %>'),$('<%= SurgicalHxDiv.ClientID %>'),$('<%= SurgicalHxAbsentDiv.ClientID %>'),$('<%= ProcDateText_9.ClientID %>'),$('<%= ProcDate_9.ClientID %>'),$('<%= ProcName_9.ClientID %>'),$('<%= ProcNotes_9.ClientID %>'));
    addEventSH($('<%= SurgicalHxRecorded.ClientID %>'),$('<%= SurgicalHxDiv.ClientID %>'),$('<%= SurgicalHxAbsentDiv.ClientID %>'),$('<%= ProcDateText_10.ClientID %>'),$('<%= ProcDate_10.ClientID %>'),$('<%= ProcName_10.ClientID %>'),$('<%= ProcNotes_10.ClientID %>'));

    function addEventSH(surgicalHxRecordedID,surgicalHxDivID,surgicalHxAbsentDivID,procDateTextID,procDateID,procNameID,procNotesID)
    {  
