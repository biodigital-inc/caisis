<%@ Control Language="c#" Inherits="Caisis.UI.Modules.GI.Eforms.EsophagusSurgeryStatusRecurrenceDate" CodeFile="EsophagusSurgeryStatusRecurrenceDate.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="EsophagusSurgeryStatusRecurrenceDate" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Recurrence Date"></asp:Label><br/>
...
<table width="400" border="0" cellspacing="0" cellpadding="5" class="ClinicalEformTable" style="background-color:#FFFFFF" id="RecurrenceDateHtmlTable">
  <tr>
    ...
    <td width="100px" class="controlBoxDataGridHeaderFirstCol" >Sites of initial recurrence</td>
  </tr>
<tr id="Recurrence_Date_StatusRow_24" runat="server" >
    <td height="32" class="ClinicalEformPopulatedColumn" style="white-space: nowrap; " valign="top" >Recurrence Date</td>
    <td class="ClinicalEformPopulatedColumn" valign="top" >	
    ...
    <td align="center" class="ClinicalEformPopulatedColumn" valign="top" >
    ...
    <td align="left" style="white-space: nowrap;" valign="top" >
	      	 <euc:EformExtendedCheckBoxList RecordId="24" TABLE="Status" FIELD="StatusNotes" Runat="server" ID="StatusNotes_24" CellSpacing="2" CellPadding="2" RepeatColumns="2" RepeatDirection="Vertical" RepeatLayout="Table" ShowOther="true" >
...
<tr id="Recurrence_Date_StatusRow_25" runat="server" style="display: none; "  valign="top" >
    <td height="32" class="ClinicalEformPopulatedColumn" style="white-space: nowrap; " valign="top" >Recurrence Date</td>
    <td class="ClinicalEformPopulatedColumn" valign="top" >	
    ...
    <td align="left" style="white-space: nowrap;" valign="top" >
	      	 <euc:EformExtendedCheckBoxList RecordId="25" TABLE="Status" FIELD="StatusNotes" Runat="server" ID="StatusNotes_25" CellSpacing="2" CellPadding="2" RepeatColumns="2" RepeatDirection="Vertical" RepeatLayout="Table" ShowOther="true" >
                <asp:ListItem Value="Local" Text="Local"  />
                <asp:ListItem Value="Liver" Text="Liver"  />
                <asp:ListItem Value="Lung" Text="Lung"  />
                <asp:ListItem Value="Peritoneum" Text="Peritoneum"  />
...
<tr id="Recurrence_Date_StatusRow_26" runat="server" style="display: none; "  valign="top" >
    <td height="32" class="ClinicalEformPopulatedColumn" style="white-space: nowrap; " valign="top" >Recurrence Date</td>
    <td class="ClinicalEformPopulatedColumn" valign="top" >	
    ...
    <td align="left" style="white-space: nowrap;" valign="top" >
	      	 <euc:EformExtendedCheckBoxList RecordId="26" TABLE="Status" FIELD="StatusNotes" Runat="server" ID="StatusNotes_26" CellSpacing="2" CellPadding="2" RepeatColumns="2" RepeatDirection="Vertical" RepeatLayout="Table" ShowOther="true" >
                <asp:ListItem Value="Local" Text="Local"  />
                <asp:ListItem Value="Liver" Text="Liver"  />
                <asp:ListItem Value="Lung" Text="Lung"  />
                <asp:ListItem Value="Peritoneum" Text="Peritoneum"  />
...
<tr id="Recurrence_Date_StatusRow_27" runat="server" style="display: none; "  valign="top" >
    <td height="32" class="ClinicalEformPopulatedColumn" style="white-space: nowrap; " valign="top"  >Recurrence Date</td>
    <td class="ClinicalEformPopulatedColumn" valign="top" >	
    ...
    <td align="left" style="white-space: nowrap;" valign="top" >
	      	 <euc:EformExtendedCheckBoxList RecordId="27" TABLE="Status" FIELD="StatusNotes" Runat="server" ID="StatusNotes_27" CellSpacing="2" CellPadding="2" RepeatColumns="2" RepeatDirection="Vertical" RepeatLayout="Table" ShowOther="true" >
                <asp:ListItem Value="Local" Text="Local"  />
                <asp:ListItem Value="Liver" Text="Liver"  />
                <asp:ListItem Value="Lung" Text="Lung"  />
                <asp:ListItem Value="Peritoneum" Text="Peritoneum"  />
...
<tr id="Recurrence_Date_StatusRow_28" runat="server" style="display: none; "  valign="top" >
    <td height="32" class="ClinicalEformPopulatedColumn" style="white-space: nowrap; " valign="top" >Recurrence Date</td>
    <td class="ClinicalEformPopulatedColumn" valign="top" >	
    ...
    <td align="left" style="white-space: nowrap;" valign="top"  >
	      	 <euc:EformExtendedCheckBoxList RecordId="28" TABLE="Status" FIELD="StatusNotes" Runat="server" ID="StatusNotes_28" CellSpacing="2" CellPadding="2" RepeatColumns="2" RepeatDirection="Vertical" RepeatLayout="Table" ShowOther="true" >
                <asp:ListItem Value="Local" Text="Local"  />
                <asp:ListItem Value="Liver" Text="Liver"  />
                <asp:ListItem Value="Lung" Text="Lung"  />
                <asp:ListItem Value="Peritoneum" Text="Peritoneum"  />
...
<tr id="Recurrence_Date_StatusRow_29" runat="server" style="display: none; " valign="top"  >
    <td height="32" class="ClinicalEformPopulatedColumn" style="white-space: nowrap; " valign="top" >Recurrence Date</td>
    <td class="ClinicalEformPopulatedColumn" valign="top" >	
    ...
    <td align="left" style="white-space: nowrap;" valign="top" >
	      	 <euc:EformExtendedCheckBoxList RecordId="29" TABLE="Status" FIELD="StatusNotes" Runat="server" ID="StatusNotes_29" CellSpacing="2" CellPadding="2" RepeatColumns="2" RepeatDirection="Vertical" RepeatLayout="Table" ShowOther="true" >
                <asp:ListItem Value="Local" Text="Local"  />
                <asp:ListItem Value="Liver" Text="Liver"  />
                <asp:ListItem Value="Lung" Text="Lung"  />
                <asp:ListItem Value="Peritoneum" Text="Peritoneum"  />
...
<tr id="Recurrence_Date_StatusRow_30" runat="server" style="display: none; " valign="top" >
    <td height="32" class="ClinicalEformPopulatedColumn" style="white-space: nowrap; " valign="top" >Recurrence Date</td>
    <td class="ClinicalEformPopulatedColumn" valign="top" >	
    ...
    <td align="left" style="white-space: nowrap;" valign="top" >
	      	 <euc:EformExtendedCheckBoxList RecordId="230" TABLE="Status" FIELD="StatusNotes" Runat="server" ID="StatusNotes_30" CellSpacing="2" CellPadding="2" RepeatColumns="2" RepeatDirection="Vertical" RepeatLayout="Table" ShowOther="true" >
                <asp:ListItem Value="Local" Text="Local"  />
                <asp:ListItem Value="Liver" Text="Liver"  />
                <asp:ListItem Value="Lung" Text="Lung"  />
                <asp:ListItem Value="Peritoneum" Text="Peritoneum"  />
...
<script type="text/javascript">
    ...
    {  
        ...
        for (var j = 0; j < cbl.length; j++)
        {
            ...
            if (cblRef.type == 'checkbox')
                  $(cblRef).addEvent('click',curry(SetHiddenFields,status,disease,todaysDateCB,statusDateText,statusDate,statusNotes));
        } 
    ...
    {        
        var sitesOfrecurrenceValue = RetrieveCheckBoxListSelectedValues (statusNotes,"TABLE");
        
        if (todaysDateCB.checked || statusDateText.value != '' || sitesOfrecurrenceValue != '')
        {
            status.value = 'Recurrence Date';
            disease.value = 'Esophageal Cancer';
