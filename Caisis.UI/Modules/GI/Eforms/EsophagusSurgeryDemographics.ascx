<%@ Control Language="c#" Inherits="Caisis.UI.Modules.GI.Eforms.PancreasSurgeryDemographics" CodeFile="EsophagusSurgeryDemographics.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
