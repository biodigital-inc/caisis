namespace Caisis.UI.Modules.HeadNeck.Eforms
{
	...
	/// <summary>
    ///		Summary description for OropharynxPathStageGrade.
	/// </summary>
    public partial class OropharynxPathStageGrade : BaseEFormControl
    {
        ...
        {
            stageSystem.Attributes.Add("OnClick", "setPathStageHiddenFields(" + stageT.ClientID + "," + stageN.ClientID + ", " + stageM.ClientID +
                                                  "," + disease.ClientID + ", " + stageSystem.ClientID + ");");

            stageT.Attributes.Add("OnClick", "setPathStageHiddenFields(" + stageT.ClientID + "," + stageN.ClientID + ", " + stageM.ClientID +
                                                                          "," + disease.ClientID + ", " + stageSystem.ClientID + ");");

            stageN.Attributes.Add("OnClick", "setPathStageHiddenFields(" + stageT.ClientID + "," + stageN.ClientID + ", " + stageM.ClientID +
                                                                          "," + disease.ClientID + ", " + stageSystem.ClientID + ");");
            stageM.Attributes.Add("OnClick", "setPathStageHiddenFields(" + stageT.ClientID + "," + stageN.ClientID + ", " + stageM.ClientID +
                                                                          "," + disease.ClientID + ", " + stageSystem.ClientID + ");");
