<%@ Control Language="c#" Inherits="Caisis.UI.Modules.HeadNeck.Eforms.SalivaryGlandPathStageGrade" CodeFile="SalivaryGlandPathStageGrade.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="SalivaryGlandPathStageGrade" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Pathology Stages (Oropharynx)"></asp:Label><br/>
<table cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="PathStagesHtmlTable">
          ...
          <tr>
			...
			<td>	
				<euc:EformHidden RecordId="1" ParentRecordId="16" TABLE="PathologyStageGrade" FIELD="PathStageDisease" ID="PathStageDisease_1"    Runat="server" Value="Salivary Glands"  />			    
          ...
          <tr style="display: none;" >
			...
			<td>	
				<euc:EformHidden RecordId="2" ParentRecordId="16" TABLE="PathologyStageGrade" FIELD="PathStageDisease" ID="PathStageDisease_2" Runat="server" Value="Salivary Glands"/>			    
          ...
          <tr style="display: none;" >
			...
			<td>	
				<euc:EformHidden RecordId="3" ParentRecordId="16" TABLE="PathologyStageGrade" FIELD="PathStageDisease" ID="PathStageDisease_3" Runat="server" Value="Salivary Glands"/>			    
          ...
          <tr style="display: none;" >
			...
			<td>	
				<euc:EformHidden  RecordId="4" ParentRecordId="16" TABLE="PathologyStageGrade" FIELD="PathStageDisease" ID="PathStageDisease_4" Runat="server" Value="Salivary Glands"/>			    
          ...
          <tr style="display: none;" >
			...
			<td>	
				<euc:EformHidden  RecordId="5" ParentRecordId="16" TABLE="PathologyStageGrade" FIELD="PathStageDisease" ID="PathStageDisease_5" Runat="server" Value="Salivary Glands"/>			    
          ...
          <tr style="display: none;" >
			...
			<td>	
				<euc:EformHidden  RecordId="6" ParentRecordId="16" TABLE="PathologyStageGrade" FIELD="PathStageDisease" ID="PathStageDisease_6" Runat="server" Value="Salivary Glands"/>			    
          ...
          <tr style="display: none;" >
			...
			<td>	
				<euc:EformHidden  RecordId="7" ParentRecordId="16" TABLE="PathologyStageGrade" FIELD="PathStageDisease" ID="PathStageDisease_7" Runat="server" Value="Salivary Glands"/>			    
          ...
          <tr style="display: none;" >
			...
			<td>	
				<euc:EformHidden  RecordId="8" ParentRecordId="16" TABLE="PathologyStageGrade" FIELD="PathStageDisease" ID="PathStageDisease_8" Runat="server" Value="Salivary Glands"/>			    
          ...
          <tr style="display: none;" >
			...
			<td>	
				<euc:EformHidden  RecordId="9" ParentRecordId="16" TABLE="PathologyStageGrade" FIELD="PathStageDisease" ID="PathStageDisease_9" Runat="server" Value="Salivary Glands"/>			    
          ...
          <tr style="display: none;" >
			...
			<td>	
				<euc:EformHidden  RecordId="10" ParentRecordId="16" TABLE="PathologyStageGrade" FIELD="PathStageDisease" ID="PathStageDisease_10" Runat="server" Value="Salivary Glands"/>			    
