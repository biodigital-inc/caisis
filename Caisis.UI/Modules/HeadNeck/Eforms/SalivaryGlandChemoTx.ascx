<%@ Control Language="c#" Inherits="Caisis.UI.Modules.HeadNeck.Eforms.SalivaryGlandChemoTx" CodeFile="SalivaryGlandChemoTx.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>
<script language="javascript" type="text/javascript">
    tableArray.SalivaryGlandChemoTxHtmlTable = "SalivaryGlandChemoTxHtmlTable";
</script>
<link href="../../../StyleSheets/EformStyles.css" rel="stylesheet" type="text/css"/>

<a name="SalivaryGlandChemoTx" /><br/>
...
<table width="700" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="SalivaryGlandChemoTxHtmlTable">  
  ...
  <tr >
    ...
    <td style="white-space: nowrap;"align="center">
        <euc:EformDropDownList style="width:260px;" Field="MedTxAgent" RecordId="6"  Table="MedicalTherapy" Runat="server" id="MedTxAgent_6"  DropDownHeight="auto" TabIndex="2" /></td>
    <td style="white-space: nowrap;"align="center"><euc:EformDropDownList RecordId="6" Runat="server" ID="MedTxType_6" Table="MedicalTherapy" Field="MedTxType" LookupCode="MedTxType" Width="100px" TabIndex="3" /></td>
   <td style="white-space: nowrap;"align="center"><euc:EformTextBox  RecordId="6" Runat="server" ID="MedTxCycle_6" Table="MedicalTherapy" Field="MedTxCycle" Width="60px" LookupCode="Disease"  /></td>
    ...
    <td style="white-space: nowrap;"align="center"><euc:EformDropDownList style="width:260px;" Field="MedTxAgent" RecordId="7" Table="MedicalTherapy" Runat="server" id="MedTxAgent_7" LookupCode="MedTxAgent" DropDownHeight="auto" TabIndex="2" /></td>
    <td style="white-space: nowrap;"align="center"><euc:EformDropDownList RecordId="7" Runat="server" ID="MedTxType_7" Table="MedicalTherapy" Field="MedTxType" LookupCode="MedTxType" Width="100px" TabIndex="3" /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td style="white-space: nowrap;"align="center"><euc:EformDropDownList style="width:260px;" Field="MedTxAgent" RecordId="8" Table="MedicalTherapy" Runat="server" id="MedTxAgent_8" LookupCode="MedTxAgent" DropDownHeight="auto" TabIndex="2" /></td>
    <td style="white-space: nowrap;"align="center"><euc:EformDropDownList RecordId="8" Runat="server" ID="MedTxType_8" Table="MedicalTherapy" Field="MedTxType" LookupCode="MedTxType" Width="100px" TabIndex="3" /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td style="white-space: nowrap;"align="center"><euc:EformDropDownList style="width:260px;" Field="MedTxAgent" RecordId="9" Table="MedicalTherapy" Runat="server" id="MedTxAgent_9" LookupCode="MedTxAgent" DropDownHeight="auto" TabIndex="2" /></td>
    <td style="white-space: nowrap;"align="center"><euc:EformDropDownList RecordId="9" Runat="server" ID="MedTxType_9" Table="MedicalTherapy" Field="MedTxType" LookupCode="MedTxType" Width="100px" TabIndex="3" /></td>
  ...
  <tr style="DISPLAY: none">
    ...
    <td style="white-space: nowrap;"align="center"><euc:EformDropDownList style="width:260px;" Field="MedTxAgent" RecordId="10" Table="MedicalTherapy" Runat="server" id="MedTxAgent_10" LookupCode="MedTxAgent" DropDownHeight="auto" TabIndex="2" /></td>
    <td style="white-space: nowrap;"align="center"><euc:EformDropDownList RecordId="10" Runat="server" ID="MedTxType_10" Table="MedicalTherapy" Field="MedTxType" LookupCode="MedTxType" Width="100px" TabIndex="3" /></td>
...
<img alt="" src="../../Images/EFormAddARow.gif" hspace="0" width="117" height="16" border="0" class="ClickableImage" align="left"  onclick="return showFirstAdditionalRow(this,'SalivaryGlandChemoTxHtmlTable');" />
</div>
<br/><br /><br />
