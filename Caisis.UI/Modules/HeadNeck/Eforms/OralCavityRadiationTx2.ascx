<%@ Control Language="C#" Inherits="Caisis.UI.Modules.HeadNeck.EForms.OralCavityRadiationTx2" CodeFile="OralCavityRadiationTx2.ascx.cs"  CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>
<script language="javascript" type="text/javascript">
	tableArray.OralCavityRadiationTx2HtmlTable = "OralCavityRadiationTx2HtmlTable";
</script>
<link href="../../../StyleSheets/EformStyles.css" rel="stylesheet" type="text/css" />
<a name="OralCavityRadiationTx2" /><br/>

<table width="200" cellpadding="5" cellspacing="0" class="eformLargePopulatedTableBlue">
    <tr>
        <td style="white-space: nowrap;">
            <span class="controlBoxTitle"><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Radiation Therapy"></asp:Label> ?</span></td>
        <td height="28">
...
<table width="650" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="OralCavityRadiationTx2HtmlTable">
  <tr> 
...
<img src="../../Images/EFormAddARow.gif" hspace="0" width="117" height="16" border="0" class="ClickableImage" align="left"  onclick="return showFirstAdditionalRow(this,'OralCavityRadiationTx2HtmlTable');" />
</div>
<br/><br /><br />
...
//           
            disease.value  = "Oral Cancer";
            units.value = 'cGy';

            if (target.value == 'Primary')
            {
                if (procSubSiteValue == '')
                    alert('Radiation Therapy Warning 1:  The target field uses the subsite specified in the Primary Procedure.  Please specify the subsite of the Primary Procedure in the \'Surgical Treatment\' section, then re-enter the target here.');
