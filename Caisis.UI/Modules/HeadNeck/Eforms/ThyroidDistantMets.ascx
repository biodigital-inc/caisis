<%@ Control Language="c#" Inherits="Caisis.UI.Modules.HeadNeck.Eforms.ThyroidDistantMets" CodeFile="ThyroidDistantMets.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
<%@ Register TagPrefix="euc" Namespace="Caisis.UI.Core.Classes.CustomControls" %>
<script type="text/javascript" language="javascript">
	tableArray.DistantMetsTable = "DistantMetsTable";
	
	function updateStatusOnDate(statusId, diseaseId, qId)
	{
...
<a name="ThyroidDistantMets" /><span class="controlBoxTitle">Distant Metastasis</span> <br/>

<table width="650" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="DistantMetsTable">     
  <tr> 
  ...
  <tr>    
    ...
    <td align="center"><euc:EformComboBox style="width:80px;" Field="StatusNotes" RecordId="1" Table="Status" Runat="server" id="StatusLocation_1" LookupCode="DxTarget,Disease,Thyroid" DropDownHeight="auto" DropDownWidth="95px" />
    </td>
  ...
  <tr style="DISPLAY: none">    
    ...
    <td align="center"><euc:EformComboBox  style="width:80px;" Field="StatusNotes" RecordId="2" Table="Status" Runat="server" id="StatusLocation_2" LookupCode="DxTarget,Disease,Thyroid" DropDownHeight="auto" DropDownWidth="95px" />
    </td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
  ...
  <tr style="DISPLAY: none">    
    ...
    <td align="center"><euc:EformComboBox  style="width:80px;" Field="StatusNotes" RecordId="3" Table="Status" Runat="server" id="StatusLocation_3" LookupCode="DxTarget,Disease,Thyroid" DropDownHeight="auto" DropDownWidth="95px" />
    </td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
  ...
  <tr style="DISPLAY: none">    
    ...
    <td align="center"><euc:EformComboBox  style="width:80px;" Field="StatusNotes" RecordId="4" Table="Status" Runat="server" id="StatusLocation_4" LookupCode="DxTarget,Disease,Thyroid" DropDownHeight="auto" DropDownWidth="95px" />
    </td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
  ...
  <tr style="DISPLAY: none">    
    ...
    <td align="center"><euc:EformComboBox  style="width:80px;" Field="StatusNotes" RecordId="5" Table="Status" Runat="server" id="StatusLocation_5" LookupCode="DxTarget,Disease,Thyroid" DropDownHeight="auto" DropDownWidth="95px" />
    </td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
</table>
<img src="../../Images/EFormAddARow.gif" hspace="0" width="117" height="16" border="0" class="ClickableImage" align="left"  onclick="return showFirstAdditionalRow(this,'DistantMetsTable');" /><br /><br /><br />