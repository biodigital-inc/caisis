namespace Caisis.UI.Modules.HeadNeck.Eforms
{
	...
	/// <summary>
    ///		Summary description for OropharynxClinicalStageHistory.
	/// </summary>
    public partial class OropharynxClinicalStageHistory : BaseEFormControl
	{
        ...
        protected void BuildClinicalStages(int PatientID)
        {
            ...
            dv.RowFilter = BOL.ClinicalStage.ClinStageDisease + "='Oropharynx'";
