<%@ Control Language="c#" Inherits="Caisis.UI.Modules.HeadNeck.Eforms.SalivaryGlandStatus" CodeFile="SalivaryGlandStatus.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<table width="300" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="DemographicsHtmlTable" >  
		...
		<tr>
		    <asp:Repeater ID="PtDemoGx" runat="server" >
                         <ItemTemplate>
                            <tr class="ClinicalEformPopulatedRow" onmouseover="this.className='ClinicalEformHighlightedRow';" onmouseout="this.className='ClinicalEformPopulatedRow';"   onclick="LoadDataEntryForm('Patients',  <%# DataBinder.Eval(Container.DataItem, "PatientId") %>, 'PtDeathDateText,PtDeathCause', 'Patients');"> 
