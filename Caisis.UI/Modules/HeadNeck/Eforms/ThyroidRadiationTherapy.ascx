<%@ Control Language="C#" Inherits="Caisis.UI.Modules.HeadNeck.EForms.ThyroidRadiationTherapy" CodeFile="ThyroidRadiationTherapy.ascx.cs"  CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="ThyroidRadiationTherapy" /><span class="controlBoxTitle">Previous Radiation Therapy </span><br />
<table width="650" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="RadiationTherapyHtmlTable">
  ...
  <tr >
    ...
    <td align="center"><euc:EformTextBox  style="width:80px;" Field="RadTxTarget" RecordId="1" Table="RadiationTherapy" Runat="server" id="RadTxTarget_1" TabIndex="57" />
    ...
    <td align="center"><euc:EformTextBox  style="width:80px;" Field="RadTxTarget" RecordId="2" Table="RadiationTherapy" Runat="server" id="RadTxTarget_2"  TabIndex="61"/>
  ...
  <tr style="DISPLAY: none">
    ...
    <td align="center"><euc:EformTextBox  style="width:80px;" Field="RadTxTarget" RecordId="3" Table="RadiationTherapy" Runat="server" id="RadTxTarget_3" TabIndex="65"/>
  ...
  <tr style="DISPLAY: none">
    ...
    <td align="center"><euc:EformTextBox  style="width:80px;" Field="RadTxTarget" RecordId="4" Table="RadiationTherapy" Runat="server" id="RadTxTarget_4" TabIndex="69"/>
  ...
  <tr style="DISPLAY: none">
    ...
    <td align="center"><euc:EformTextBox  style="width:80px;" Field="RadTxTarget" RecordId="5" Table="RadiationTherapy" Runat="server" id="RadTxTarget_5" TabIndex="73"/>
  ...
  <tr style="DISPLAY: none">
    ...
    <td align="center"><euc:EformTextBox  style="width:80px;" Field="RadTxTarget" RecordId="6" Table="RadiationTherapy" Runat="server" id="RadTxTarget_6" TabIndex="77"/>
    <euc:EformTextBox TABLE="RadiationTherapy" FIELD="RadTxQuality" RecordId="6" ID="RadTxQuality_6" Runat="server" Width="1px" style="display:none;" /></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
  <tr style="DISPLAY: none">
    ...
    <td align="center"><euc:EformTextBox  style="width:80px;" Field="RadTxTarget" RecordId="7" Table="RadiationTherapy" Runat="server" id="RadTxTarget_7" TabIndex="81"/>
    <euc:EformTextBox TABLE="RadiationTherapy" FIELD="RadTxQuality" RecordId="7" ID="RadTxQuality_7" Runat="server" Width="1px" style="display:none;" /></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
  <tr style="DISPLAY: none">
    ...
    <td align="center"><euc:EformTextBox  style="width:80px;" Field="RadTxTarget" RecordId="8" Table="RadiationTherapy" Runat="server" id="RadTxTarget_8" TabIndex="85"/>
    <euc:EformTextBox TABLE="RadiationTherapy" FIELD="RadTxQuality" RecordId="8" ID="RadTxQuality_8" Runat="server" Width="1px" style="display:none;" /></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
  <tr style="DISPLAY: none">
    ...
    <td align="center"><euc:EformTextBox  style="width:80px;" Field="RadTxTarget" RecordId="9" Table="RadiationTherapy" Runat="server" id="RadTxTarget_9" TabIndex="89"/>
    <euc:EformTextBox TABLE="RadiationTherapy" FIELD="RadTxQuality" RecordId="9" ID="RadTxQuality_9" Runat="server" Width="1px" style="display:none;" /></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
  <tr style="DISPLAY: none">
    ...
    <td align="center"><euc:EformTextBox  style="width:80px;" Field="RadTxTarget" RecordId="10" Table="RadiationTherapy" Runat="server" id="RadTxTarget_10" TabIndex="93"/>
    <euc:EformTextBox TABLE="RadiationTherapy" FIELD="RadTxQuality" RecordId="10" ID="RadTxQuality_10" Runat="server" Width="1px" style="display:none;" /></td>
    <td><euc:EformDeleteIcon runat="server"/></td>
  </tr>
</table>
...
<table width="50" cellpadding="5" cellspacing="0" class="ClinicalEformTable">
    <tr>
        <td class="controlBoxDataGridHeaderFirstCol" style="text-align: left; white-space:nowrap;" colspan="2" >&nbsp;Carcinogen Exposure</td>
    </tr>
        
        <asp:Repeater ID="SocialHx" runat="server"  OnItemDataBound="EFormRepeaterOnDataBound" > 
	        <ItemTemplate> 
		        <tr class="ClinicalEformPopulatedRow" onMouseOver="this.className='ClinicalEformHighlightedRow';" onMouseOut="this.className='ClinicalEformPopulatedRow';"   onclick="LoadDataEntryForm('SocialHistories', <%# DataBinder.Eval(Container.DataItem, "PatientId") %>, 'SocHxCarcinogen', 'SocialHistoryTable');">
    ...
    <tr id="emptyCarcinogenRow" runat="server" visible="false">
        <td height="28"><euc:EformCheckBox style="width:100px;"  TABLE="SocialHistories" FIELD="SocHxCarcinogen" ID="SocHxCarcinogen_1" Runat="server" Text="Environmental" Value="Environmental" TabIndex="58" /></td>
    </tr>
</table>
<br/><br/>