namespace Caisis.UI.Modules.HeadNeck.Eforms
{
    ...
    /// <summary>
    ///		Summary description for OralCavityRecurrence.
    /// </summary>

    public partial class OralCavityRecurrence : BaseEFormControl
    {
        ...
        protected void BuildStatusRptr(int PatientId, string EformName, string EformType)
        {
            ...
            DataSet statusDs = statusDa.GetStatus(PatientId, "Oral Cancer");
