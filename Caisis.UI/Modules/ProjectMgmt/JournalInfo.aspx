<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JournalInfo.aspx.cs" Inherits="Caisis.UI.Modules.ProjectMgmt.JournalInfo" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function getAllJournals(selectedId)
        {
            ...
            top.OpenObj.reloadJournalList(JournalIDs, JournalNames, selectedId);
            top.hideModal();
        }
    </script>
</head>
    ...
    <div>
        <asp:Panel ID="PanelJournalInfo" runat="server" Width="90%">
            ...
            <table id="TableJournalInfo" >
                ...
                <tr>
                    <td>
                        <cic:CaisisTextBox ID="JournalName" runat="server" FieldLabel="Journal Name" ShowLabel="true" Table="ProjectJournal" Field="JournalName"
                            MaxLength="255" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <cic:CaisisTextBox ID="ShortName" runat="server" FieldLabel="Short Name" ShowLabel="true" Table="ProjectJournal" Field="ShortName" 
                            MaxLength="50"/>
                    </td>
                </tr>
                <tr>
                    <td>
                        <cic:CaisisTextArea ID="JournalNotes" runat="server" FieldLabel="Notes" ShowLabel="true" Table="ProjectJournal" Field="Notes" 
                            MaxLength="1000"/>
                    </td>
                </tr>
                <tr>
