<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Testis.PaperForms.UroTestOR" CodeFile="UroTestOR.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BasePaperFormControl" %>
  ...
  <td style="text-align:center;"><font size="-1">CONTAINS PROTECTED HEALTH INFORMATION - HANDLE ACCORDING TO <%= institutionShortName%> POLICY</font></td>
    ...
    <tr> 
      <td class="FormOuterTableTopRow"><table align="center" border="0" width="100%" cellpadding="0" cellspacing="0">
          <tr> 
            <td width="50%" align="center" valign="middle" class="FormInnerRowRightBorder"><span class="blackBoldText"><img src="../../Images/FormImages/<%= institutionShortName%>_FormLogo.gif" width="90" alt="" border="0" align="left"><%= institutionName%><br/>Urology Testis Surgery Details<br/></span></td>
    ...
    <tr> 
      <td class="FormOuterTableRow"><img src="../../Images/shim.gif" border="0" width="4" height="15"><span class="blackBoldText">Date:</span><img src="../../Images/shim.gif" border="0" width="305" height="1"><span class="blackBoldText">Case 
        Surgeon :</span></td>
    </tr>
    <tr> 
      <td valign="top"> <table class="pageWidth" border="0" cellspacing="0" cellpadding="0">
          <tr valign="top"> 
            <td  style="background-color: #ffffff;"><img src="../../Images/FormImages/TestisOR_Pg1_20060501_NH.gif"  class="pageWidth" border="0"></td>
          </tr>
        </table></td>
    </tr>
  </table>
...
<div align="left"   style="page-break-after:always;">
  ...
  <td style="text-align:center;"><font size="-1">CONTAINS PROTECTED HEALTH INFORMATION - HANDLE ACCORDING TO <%= institutionShortName%> POLICY</font></td>
    ...
    <tr> 
      <td valign="top"> <table class="pageWidth" border="0" cellspacing="0" cellpadding="0">
          <tr valign="top"> 
            <td  style="background-color: #ffffff;"><img src="../../Images/FormImages/TestisOR_Pg2_20060501_NH.gif" class="pageWidth" border="0"></td>
          </tr>
        </table></td>
    </tr>
  </table>
