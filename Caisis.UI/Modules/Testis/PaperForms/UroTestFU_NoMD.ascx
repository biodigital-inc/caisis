<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Testis.PaperForms.UroTestFU_NoMD" CodeFile="UroTestFU_NoMD.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BasePaperFormControl" %>
...
var showPhysicianFormDispayOptions = true;
var clinicPhysicianName = '<% =apptPhysicianName %>';
</script>
--%>
  ...
  <td style="text-align:center;"><font size="-1">CONTAINS PROTECTED HEALTH INFORMATION - HANDLE ACCORDING TO <%= institutionShortName%> POLICY</font></td>
    ...
    <tr> 
      <td height="20" class="FormOuterTableRow"><img src="../../Images/shim.gif" border="0" width="4" height="11"><span class="blackBoldText">Date: <% =apptClinicDate %><img src="../../Images/shim.gif" border="0" width="220" height="1">Physician: </span><%-- <span class="PhysicianDisplayName"><% =apptPhysicianName %></span> --%></td>
    </tr>
    <tr> 
