namespace Caisis.UI.Modules.Testis.PaperForms
{
	...
	/// </summary>
    public partial class UroSurveyPostTxTestis : BasePaperFormControl
	{
		...
		{
			this._formName = "UroSurveyPostTxTestis";
			this._formTitle = "Urology Testis Post-Treatment Questionnaire";
