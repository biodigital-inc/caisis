<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminSplash.aspx.cs" Inherits="Caisis.UI.Modules.ProtocolMgmt.AdminSplash" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <span class="SectionTitle">Admin Splash</span>
        </div>>
    </form>
</body>
</html>
