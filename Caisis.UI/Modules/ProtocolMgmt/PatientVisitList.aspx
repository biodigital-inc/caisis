<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PatientVisitList.aspx.cs"
    Inherits="Caisis.UI.Modules.ProtocolMgmt.PatientVisitList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>PatientVisitList</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <span class="SectionTitle">Patient Visit List</span>
        </div>
    </form>
</body>
</html>
