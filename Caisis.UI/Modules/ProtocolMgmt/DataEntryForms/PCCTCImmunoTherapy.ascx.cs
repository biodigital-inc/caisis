...
{
    public partial class PCCTCImmunoTherapy : BaseDataEntryControl
    {
        ...
        {
            int recordCount = MedTxControl.Populate(base.patientId, base.fromDate, base.toDate, new string[] { "Immuno"}, new string[0]);
