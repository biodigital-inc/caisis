<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Kidney.Eforms.Comorbidities_NephFU" CodeFile="Comorbidities_NephFU.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="Comorbidities_NephFU" /><asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Comorbidities"></asp:Label><br/>
<table cellpadding="3" cellspacing="0" class="ClinicalEformTable" id="ComorbiditiesHtmlTable" style="width: 700px;">
  ...
  <asp:Repeater ID="comorbidities" runat="server" OnItemDataBound="EFormRepeaterOnDataBound" > 
	<ItemTemplate> 
		<tr class="ClinicalEformPopulatedRow" onMouseOver="this.className='ClinicalEformHighlightedRow';" onMouseOut="this.className='ClinicalEformPopulatedRow';"  onclick="LoadDataEntryForm('Comorbidities', <%# DataBinder.Eval(Container.DataItem, "ComorbidityId") %>, 'ComorbDateText,ComorbDate,Comorbidity,ComorbNotes','Comorbidities');"> 
			...
			<td class="ClinicalEformPopulatedColumn"><%# DataBinder.Eval(Container.DataItem, "Comorbidity") %>&nbsp;</td>
			<td class="ClinicalEformPopulatedColumn" style="max-width: 200px;"><%# DataBinder.Eval(Container.DataItem, "ComorbNotes") %>&nbsp;</td>
  ...
  <tr id="ComorbidityRow_Obesity" runat="server" > 
    <td height="28" class="ClinicalEformGridColumnOne">
    ...
    <td><euc:EformCheckbox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_Obesity" Value="Obesity" RecordId="9" />
      Obesity
    </td>
  ...
  <tr id="ComorbidityRow_Hypercholesterolemia" runat="server" > 
    ...
    <td><euc:EformCheckbox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_Hypercholesterolemia" Value="Hypercholesterolemia" RecordId="10" />
  ...
  <tr id="ComorbidityRow_Depression" runat="server" > 
    ...
    <td><euc:EformCheckbox TABLE="Comorbidities" FIELD="Comorbidity" Runat="server" ID="Comorbidity_Depression" Value="Depression" RecordId="11" />
      Depression</td>
