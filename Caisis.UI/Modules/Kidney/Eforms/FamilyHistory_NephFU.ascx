<%@ Control Language="c#" Inherits="Caisis.UI.Modules.Kidney.Eforms.FamilyHistory_NephFU"
    CodeFile="FamilyHistory_NephFU.ascx.cs" CodeFileBaseClass="Caisis.UI.Core.Classes.BaseEFormControl" %>
...
<a name="FamilyHistory_NephFU" />
<asp:Label ID="ComponentTitle" runat="server" CssClass="controlBoxTitle" Text="Family History"></asp:Label>

<euc:EformCheckBoxList RepeatLayout="Flow"  RepeatDirection="Horizontal" Table="NoTable" FIELD="FamilyMembers_Notes" id="FamilyMembers_Notes"  runat="server"  ShowOther="false">
			<asp:ListItem Value="No known family history of ca">No known family history of ca&nbsp;&nbsp;&nbsp;</asp:ListItem>
			<asp:ListItem Value="Balkan Heritage">Balkan Heritage</asp:ListItem>
...
<table width="700" cellpadding="5" cellspacing="0" class="ClinicalEformTable" id="FamilyHistoryTable">
    <tr>
        ...
        <td width="16%" class="controlBoxDataGridHeaderFirstCol" style="text-align: left;">
            &nbsp;Diagnosis
        </td>
        <td width="8%" class="controlBoxDataGridHeaderFirstCol" style="text-align: left;
            font-size: 10px;">
            &nbsp;Age of Diagnosis
        </td>
        <td width="22%" class="controlBoxDataGridHeaderFirstCol" style="text-align: left;">
            Notes
        </td>
        <td width="8%" class="controlBoxDataGridHeaderFirstCol" style="text-align: left;">
            &nbsp;
    ...
    <tr>
        ...
        <td height="28" class="" colspan="3" style="border-right: solid 1px #cccccc;border-bottom: solid 1px #666666;">
            <table id="famMemDiag_1" cellspacing="0">
                <tr>
                    <td height="28" width="40%" valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_1a" RecordId="1" runat="server"  LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;
                        ...
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_1a" RecordId="1" runat="server" />
                    </td>
                ...
                <tr id="famMemDiag_1b" style="display: none">
                    <td height="28" width="40%" valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_1b" RecordId="2" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_1b" RecordId="2" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_1c" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_1c" RecordId="3" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_1c" RecordId="3" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
    ...
    <tr style="display: none">
        ...
        <td height="28"  colspan="3" style="border-right: solid 1px #cccccc;border-bottom: solid 1px #666666;">
            <table id="famMemDiag_2" cellspacing="0">
                <tr>
                    <td height="28" width="40%" valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_2a" RecordId="1" ParentRecordId="2" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%"  style="text-align: center;
                        padding-left: 5px; padding-right: 5px;" valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_2a" RecordId="1" ParentRecordId="2" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_2b" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_2b" RecordId="2" ParentRecordId="2" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_2b" RecordId="2" ParentRecordId="2" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_2c" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_2c" RecordId="3" ParentRecordId="2" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_2c" RecordId="3" ParentRecordId="2" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
        ...
        <td height="28"  colspan="3" style="border-right: solid 1px #cccccc;border-bottom: solid 1px #666666;">
            <table id="famMemDiag_3" cellspacing="0">
                <tr>
                    <td height="28" width="40%" valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_3a" RecordId="1" ParentRecordId="3" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%"  style="text-align: center;
                        padding-left: 5px; padding-right: 5px;" valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_3a" RecordId="1" ParentRecordId="3" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_3b" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_3b" RecordId="2" ParentRecordId="3" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_3b" RecordId="2" ParentRecordId="3" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_3c" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_3c" RecordId="3" ParentRecordId="3" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_3c" RecordId="3" ParentRecordId="3" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
        ...
        <td height="28"  colspan="3" style="border-right: solid 1px #cccccc;border-bottom: solid 1px #666666;">
            <table id="famMemDiag_4" cellspacing="0">
                <tr>
                    <td height="28" width="40%" valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_4a" RecordId="1" ParentRecordId="4" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%"  style="text-align: center;
                        padding-left: 5px; padding-right: 5px;" valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_4a" RecordId="1" ParentRecordId="4" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_4b" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_4b" RecordId="2" ParentRecordId="4" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_4b" RecordId="2" ParentRecordId="4" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_4c" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_4c" RecordId="3" ParentRecordId="4" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_4c" RecordId="3" ParentRecordId="4" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
        ...
        <td height="28"  colspan="3" style="border-right: solid 1px #cccccc;border-bottom: solid 1px #666666;">
            <table id="famMemDiag_5" cellspacing="0">
                <tr>
                    <td height="28" width="40%" valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_5a" RecordId="1" ParentRecordId="5" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%"  style="text-align: center;
                        padding-left: 5px; padding-right: 5px;" valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_5a" RecordId="1" ParentRecordId="5" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_5b" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_5b" RecordId="2" ParentRecordId="5" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_5b" RecordId="2" ParentRecordId="5" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_5c" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_5c" RecordId="3" ParentRecordId="5" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_5c" RecordId="3" ParentRecordId="5" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
        ...
        <td height="28"  colspan="3" style="border-right: solid 1px #cccccc;border-bottom: solid 1px #666666;">
            <table id="famMemDiag_6" cellspacing="0">
                <tr>
                    <td height="28" width="40%" valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_6a" RecordId="1" ParentRecordId="6" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%"  style="text-align: center;
                        padding-left: 5px; padding-right: 5px;" valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_6a" RecordId="1" ParentRecordId="6" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_6b" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_6b" RecordId="2" ParentRecordId="6" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_6b" RecordId="2" ParentRecordId="6" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_6c" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_6c" RecordId="3" ParentRecordId="6" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_6c" RecordId="3" ParentRecordId="6" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
        ...
        <td height="28"  colspan="3" style="border-right: solid 1px #cccccc;border-bottom: solid 1px #666666;">
            <table id="famMemDiag_7" cellspacing="0">
                <tr>
                    <td height="28" width="40%" valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_7a" RecordId="1" ParentRecordId="7" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%"  style="text-align: center;
                        padding-left: 5px; padding-right: 5px;" valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_7a" RecordId="1" ParentRecordId="7" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_7b" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_7b" RecordId="2" ParentRecordId="7" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_7b" RecordId="2" ParentRecordId="7" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_7c" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_7c" RecordId="3" ParentRecordId="7" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_7c" RecordId="3" ParentRecordId="7" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
        ...
        <td height="28"  colspan="3" style="border-right: solid 1px #cccccc;border-bottom: solid 1px #666666;">
            <table id="famMemDiag_8" cellspacing="0">
                <tr>
                    <td height="28" width="40%" valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_8a" RecordId="1" ParentRecordId="8" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%"  style="text-align: center;
                        padding-left: 5px; padding-right: 5px;" valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_8a" RecordId="1" ParentRecordId="8" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_8b" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_8b" RecordId="2" ParentRecordId="8" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_8b" RecordId="2" ParentRecordId="8" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_8c" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_8c" RecordId="3" ParentRecordId="8" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_8c" RecordId="3" ParentRecordId="8" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
        ...
        <td height="28"  colspan="3" style="border-right: solid 1px #cccccc;border-bottom: solid 1px #666666;">
            <table id="famMemDiag_9" cellspacing="0">
                <tr>
                    <td height="28" width="40%" valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_9a" RecordId="1" ParentRecordId="9" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%"  style="text-align: center;
                        padding-left: 5px; padding-right: 5px;" valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_9a" RecordId="1" ParentRecordId="9" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_9b" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_9b" RecordId="2" ParentRecordId="9" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_9b" RecordId="2" ParentRecordId="9" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_9c" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_9c" RecordId="3" ParentRecordId="9" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_9c" RecordId="3" ParentRecordId="9" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
        ...
        <td height="28"  colspan="3" style="border-right: solid 1px #cccccc;border-bottom: solid 1px #666666;">
            <table id="famMemDiag_10" cellspacing="0">
                <tr>
                    <td height="28" width="40%" valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_10a" RecordId="1" ParentRecordId="10" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%"  style="text-align: center;
                        padding-left: 5px; padding-right: 5px;" valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_10a" RecordId="1" ParentRecordId="10" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_10b" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_10b" RecordId="2" ParentRecordId="10" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_10b" RecordId="2" ParentRecordId="10" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
                ...
                <tr id="famMemDiag_10c" style="display: none">
                    <td height="28" width="40%"  valign="top">
                        <euc:EformComboBox Style="width: 90px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosis"
                            ID="FamMemDiagnosis_10c" RecordId="3" ParentRecordId="10" runat="server" LookupCode="FamMemDiagnosis,Disease,Kidney" />
                    </td>
                    <td height="28" width="9%" style="text-align: center;" 
                        valign="top">
                        <euc:EformTextBox Style="width: 40px;" Table="FamilyMemberDiagnosis" Field="FamMemDiagnosisAge"
                            ID="FamMemDiagnosisAge_10c" RecordId="3" ParentRecordId="10" runat="server" />
                    </td>
                    <td height="28" width="20%"  valign="top">
                        <euc:EformTextBox Style="width: 100px;" Table="FamilyMemberDiagnosis" Field="FamMemNotes"
